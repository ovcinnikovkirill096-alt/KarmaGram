...
public class TransitionSet extends Transition {
    ...
    public Transition mo812clone() {
        TransitionSet transitionSet = (TransitionSet) super.mo812clone();
        transitionSet.mTransitions = new ArrayList();
        int size = this.mTransitions.size();
        for (int i = 0; i < size; i++) {
            transitionSet.addTransitionInternal(((Transition) this.mTransitions.get(i)).mo812clone());
        }
