...
class SystemBarStateMonitor {
    ...
    SystemBarStateMonitor(final ViewGroup viewGroup) {
        ...
        ViewCompat.setOnApplyWindowInsetsListener(view, new OnApplyWindowInsetsListener() { // from class: androidx.core.view.insets.SystemBarStateMonitor$$ExternalSyntheticLambda0
            ...
            public final WindowInsetsCompat onApplyWindowInsets(View view2, WindowInsetsCompat windowInsetsCompat) {
                return SystemBarStateMonitor.m688$r8$lambda$nKGC9baBGIw6pzxW6_YrSZDe_Q(this.f$0, view2, windowInsetsCompat);
            }
        });
    ...
    public static /* synthetic */ WindowInsetsCompat m688$r8$lambda$nKGC9baBGIw6pzxW6_YrSZDe_Q(SystemBarStateMonitor systemBarStateMonitor, View view, WindowInsetsCompat windowInsetsCompat) {
