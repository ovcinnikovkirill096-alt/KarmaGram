...
public abstract class ChatListItemAnimator extends DefaultItemAnimator {
    ...
    private void runAlphaEnterTransition() {
        ...
        if (!zIsEmpty2) {
            ...
            Runnable runnable = new Runnable() { // from class: androidx.recyclerview.widget.ChatListItemAnimator.1
                ...
                public void run() {
                    ...
                    arrayList5.clear();
                    ChatListItemAnimator.this.mMovesList.remove(arrayList5);
                }
            };
        ...
        if (!zIsEmpty3) {
            ...
            Runnable runnable2 = new Runnable() { // from class: androidx.recyclerview.widget.ChatListItemAnimator.2
                ...
                public void run() {
                    ...
                    arrayList6.clear();
                    ChatListItemAnimator.this.mChangesList.remove(arrayList6);
                }
            };
            if (this.delayAnimations && !zIsEmpty) {
        ...
        Collections.sort(arrayList7, new Comparator() { // from class: androidx.recyclerview.widget.ChatListItemAnimator$$ExternalSyntheticLambda7
            @Override // java.util.Comparator
            public final int compare(Object obj2, Object obj3) {
                return ChatListItemAnimator.m771$r8$lambda$ZhmpZsu8pZI6IPqdJ0RRLbxS2o((RecyclerView.ViewHolder) obj2, (RecyclerView.ViewHolder) obj3);
            }
        });
        int size2 = arrayList7.size();
        while (i < size2) {
    ...
    public static /* synthetic */ int m771$r8$lambda$ZhmpZsu8pZI6IPqdJ0RRLbxS2o(RecyclerView.ViewHolder viewHolder, RecyclerView.ViewHolder viewHolder2) {
    ...
    /* JADX WARN: Code duplicated, block: B:145:0x0339  */
    @Override // androidx.recyclerview.widget.DefaultItemAnimator, androidx.recyclerview.widget.SimpleItemAnimator
    ...
    /* JADX WARN: Code duplicated, block: B:11:0x0061 A[DONT_INVERT] */
    ...
    /* JADX WARN: Code duplicated, block: B:21:0x00c4  */
    ...
    /* JADX WARN: Code duplicated, block: B:36:0x00f8 A[LOOP:0: B:35:0x00f6->B:36:0x00f8, LOOP_END] */
    ...
    /* JADX WARN: Code duplicated, block: B:75:0x020a  */
    ...
    protected void animateMoveImpl(final RecyclerView.ViewHolder viewHolder, DefaultItemAnimator.MoveInfo moveInfo, boolean z) {
        ...
        boolean z2;
        MessageObject.GroupedMessages currentMessagesGroup;
        ChatMessageCell.TransitionParams transitionParams4;
        final ChatMessageCell.TransitionParams transitionParams5;
        float f2;
        final float f3;
        final float f4;
        final boolean z3;
        ...
        final MoveInfoExtended moveInfoExtended = (MoveInfoExtended) moveInfo;
        ChatActivity chatActivity = this.activity;
        if (chatActivity != null) {
                ...
                if (view instanceof ChatMessageCell) {
                    ...
                    if (moveInfoExtended.animateImage) {
                        ...
                        if (chatMessageCell.getCurrentMessagesGroup() == null) {
                            f5 = transitionParams2.captionEnterProgress;
                        } else {
                            f5 = chatMessageCell.getCurrentMessagesGroup().transitionParams.captionEnterProgress;
                        }
                        if (chatMessageCell.getCurrentMessagesGroup() == null) {
                        ...
                        valueAnimatorOfFloat3.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: androidx.recyclerview.widget.ChatListItemAnimator$$ExternalSyntheticLambda1
                            @Override // android.animation.ValueAnimator.AnimatorUpdateListener
                            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                                ChatListItemAnimator.$r8$lambda$q2tWCM9_t3HWHSWL2BYl63l1nLY(moveInfoExtended, transitionParams3, z4, f5, f6, chatMessageCell, iArr2, viewHolder, valueAnimator);
                            }
                        });
                    ...
                    if (moveInfoExtended.deltaBottom == 0 || moveInfoExtended.deltaRight != 0 || moveInfoExtended.deltaTop != 0 || moveInfoExtended.deltaLeft != 0) {
                        f = 0.0f;
                        this.recyclerListView.setClipChildren(c);
                        this.recyclerListView.invalidate();
                        ...
                        if (moveInfoExtended.animateBackgroundOnly) {
                            ...
                            transitionParams3.toDeltaLeft = (-moveInfoExtended.deltaLeft) - chatMessageCell.getAnimationOffsetX();
                            transitionParams3.toDeltaRight = (-moveInfoExtended.deltaRight) - chatMessageCell.getAnimationOffsetX();
                        }
                        valueAnimatorOfFloat4.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: androidx.recyclerview.widget.ChatListItemAnimator$$ExternalSyntheticLambda2
                            @Override // android.animation.ValueAnimator.AnimatorUpdateListener
                            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                                ChatListItemAnimator.m774$r8$lambda$qA9X7ovu6MzHoXlAlzncqZZGW4(moveInfoExtended, transitionParams3, chatMessageCell, valueAnimator);
                            }
                        });
                        z2 = 0;
                    ...
                    if (moveInfoExtended.animateChangeGroupBackground) {
                        ...
                        fArr2[0] = 1.0f;
                        fArr2[1] = 0.0f;
                        ValueAnimator valueAnimatorOfFloat5 = ValueAnimator.ofFloat(fArr2);
                        f2 = f;
                        ...
                        f3 = currentMessagesGroup.transitionParams.captionEnterProgress;
                        ...
                        transitionParams4 = transitionParams3;
                        valueAnimatorOfFloat5.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: androidx.recyclerview.widget.ChatListItemAnimator$$ExternalSyntheticLambda3
                            @Override // android.animation.ValueAnimator.AnimatorUpdateListener
                            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                                ChatListItemAnimator.$r8$lambda$YYecdgGZNsi0ivRcwpVm6roqNgs(transitionParams6, moveInfoExtended, z3, f3, f4, recyclerListView, valueAnimator);
                            }
                        });
                    ...
                    if (moveInfoExtended.animatePinnedBottom) {
                        ...
                        fArr3[0] = 0.0f;
                        fArr3[1] = 1.0f;
                        ValueAnimator valueAnimatorOfFloat6 = ValueAnimator.ofFloat(fArr3);
                        transitionParams5 = transitionParams4;
                        valueAnimatorOfFloat6.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: androidx.recyclerview.widget.ChatListItemAnimator$$ExternalSyntheticLambda4
                            @Override // android.animation.ValueAnimator.AnimatorUpdateListener
                            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                                ChatListItemAnimator.m770$r8$lambda$FBXPwnxBwHzEwANDozv1cOm6AU(transitionParams5, chatMessageCell, valueAnimator);
                            }
                        });
                    ...
                    if (moveInfoExtended.animateChangeInternal) {
                        ...
                        fArr4[0] = 0.0f;
                        fArr4[1] = 1.0f;
                        ValueAnimator valueAnimatorOfFloat7 = ValueAnimator.ofFloat(fArr4);
                        transitionParams5.animateChange = true;
                        valueAnimatorOfFloat7.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: androidx.recyclerview.widget.ChatListItemAnimator$$ExternalSyntheticLambda5
                            @Override // android.animation.ValueAnimator.AnimatorUpdateListener
                            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                                ChatListItemAnimator.m773$r8$lambda$aRrFzpT1ocseHn5PxS5FEA7rNs(transitionParams5, chatMessageCell, valueAnimator);
                            }
                        });
                    ...
                    if (view instanceof ChatActionCell) {
                        ...
                        if (moveInfoExtended.animateChangeInternal) {
                            ...
                            valueAnimatorOfFloat8.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: androidx.recyclerview.widget.ChatListItemAnimator$$ExternalSyntheticLambda6
                                @Override // android.animation.ValueAnimator.AnimatorUpdateListener
                                public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                                    ChatListItemAnimator.m772$r8$lambda$_2wsYLNOJFHCLdCamOD89maqw(transitionParams, chatActionCell, valueAnimator);
                                }
                            });
            ...
            if (chatActivity != null) {
                ...
                if (view2 instanceof UserInfoCell) {
                    ...
                    valueAnimatorOfFloat9.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: androidx.recyclerview.widget.ChatListItemAnimator.5
                        @Override // android.animation.ValueAnimator.AnimatorUpdateListener
                        public void onAnimationUpdate(ValueAnimator valueAnimator) {
                            float fFloatValue = ((Float) valueAnimator.getAnimatedValue()).floatValue();
                    ...
                    animatorSet.playTogether(valueAnimatorOfFloat9);
                    viewHolder2 = viewHolder;
                }
            }
            view = viewHolder.itemView;
            if (view instanceof ChatMessageCell) {
                ...
                if (moveInfoExtended.animateImage) {
                    ...
                    i = 2;
                    valueAnimatorOfFloat10.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: androidx.recyclerview.widget.ChatListItemAnimator$$ExternalSyntheticLambda1
                        @Override // android.animation.ValueAnimator.AnimatorUpdateListener
                        public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                            ChatListItemAnimator.$r8$lambda$q2tWCM9_t3HWHSWL2BYl63l1nLY(moveInfoExtended, transitionParams3, z4, f5, f6, chatMessageCell, iArr3, viewHolder, valueAnimator);
                        }
                    });
                    Animator[] animatorArr2 = new Animator[1];
                    animatorArr2[c] = valueAnimatorOfFloat10;
                ...
                if (moveInfoExtended.deltaBottom == 0) {
                    ...
                    fArr5[0] = 1.0f;
                    fArr5[1] = 0.0f;
                    ValueAnimator valueAnimatorOfFloat11 = ValueAnimator.ofFloat(fArr5);
                    if (moveInfoExtended.animateBackgroundOnly) {
                        transitionParams3.toDeltaLeft = -moveInfoExtended.deltaLeft;
                        transitionParams3.toDeltaRight = -moveInfoExtended.deltaRight;
                    } else {
                    ...
                    valueAnimatorOfFloat11.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: androidx.recyclerview.widget.ChatListItemAnimator$$ExternalSyntheticLambda2
                        @Override // android.animation.ValueAnimator.AnimatorUpdateListener
                        public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                            ChatListItemAnimator.m774$r8$lambda$qA9X7ovu6MzHoXlAlzncqZZGW4(moveInfoExtended, transitionParams3, chatMessageCell, valueAnimator);
                        }
                    ...
                    fArr6[0] = 1.0f;
                    fArr6[1] = 0.0f;
                    ValueAnimator valueAnimatorOfFloat12 = ValueAnimator.ofFloat(fArr6);
                    if (moveInfoExtended.animateBackgroundOnly) {
                        transitionParams3.toDeltaLeft = -moveInfoExtended.deltaLeft;
                        transitionParams3.toDeltaRight = -moveInfoExtended.deltaRight;
                    } else {
                    ...
                    valueAnimatorOfFloat12.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: androidx.recyclerview.widget.ChatListItemAnimator$$ExternalSyntheticLambda2
                        @Override // android.animation.ValueAnimator.AnimatorUpdateListener
                        public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                            ChatListItemAnimator.m774$r8$lambda$qA9X7ovu6MzHoXlAlzncqZZGW4(moveInfoExtended, transitionParams3, chatMessageCell, valueAnimator);
                        }
                ...
                if (moveInfoExtended.animateChangeGroupBackground) {
                    ...
                    fArr7[0] = 1.0f;
                    fArr7[1] = 0.0f;
                    ValueAnimator valueAnimatorOfFloat13 = ValueAnimator.ofFloat(fArr7);
                    f2 = f;
                    final MessageObject.GroupedMessages.TransitionParams transitionParams7 = currentMessagesGroup.transitionParams;
                    ...
                    transitionParams4 = transitionParams3;
                    valueAnimatorOfFloat13.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: androidx.recyclerview.widget.ChatListItemAnimator$$ExternalSyntheticLambda3
                        @Override // android.animation.ValueAnimator.AnimatorUpdateListener
                        public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                            ChatListItemAnimator.$r8$lambda$YYecdgGZNsi0ivRcwpVm6roqNgs(transitionParams7, moveInfoExtended, z3, f3, f4, recyclerListView2, valueAnimator);
                        }
                    });
                    valueAnimatorOfFloat13.addListener(new AnimatorListenerAdapter() { // from class: androidx.recyclerview.widget.ChatListItemAnimator.6
                        @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
                        public void onAnimationEnd(Animator animator) {
                            MessageObject.GroupedMessages.TransitionParams transitionParams8 = transitionParams7;
                            transitionParams8.backgroundChangeBounds = false;
                            transitionParams8.drawBackgroundForDeletedItems = false;
                        }
                    });
                ...
                if (moveInfoExtended.animatePinnedBottom) {
                    ...
                    fArr8[0] = 0.0f;
                    fArr8[1] = 1.0f;
                    ValueAnimator valueAnimatorOfFloat14 = ValueAnimator.ofFloat(fArr8);
                    transitionParams5 = transitionParams4;
                    valueAnimatorOfFloat14.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: androidx.recyclerview.widget.ChatListItemAnimator$$ExternalSyntheticLambda4
                        @Override // android.animation.ValueAnimator.AnimatorUpdateListener
                        public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                            ChatListItemAnimator.m770$r8$lambda$FBXPwnxBwHzEwANDozv1cOm6AU(transitionParams5, chatMessageCell, valueAnimator);
                        }
                ...
                if (moveInfoExtended.animateChangeInternal) {
                    ...
                    fArr9[0] = 0.0f;
                    fArr9[1] = 1.0f;
                    ValueAnimator valueAnimatorOfFloat15 = ValueAnimator.ofFloat(fArr9);
                    transitionParams5.animateChange = true;
                    valueAnimatorOfFloat15.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: androidx.recyclerview.widget.ChatListItemAnimator$$ExternalSyntheticLambda5
                        @Override // android.animation.ValueAnimator.AnimatorUpdateListener
                        public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                            ChatListItemAnimator.m773$r8$lambda$aRrFzpT1ocseHn5PxS5FEA7rNs(transitionParams5, chatMessageCell, valueAnimator);
                        }
                ...
                if (view instanceof ChatActionCell) {
                    ...
                    if (moveInfoExtended.animateChangeInternal) {
                        ...
                        transitionParams.animateChange = true;
                        valueAnimatorOfFloat16.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: androidx.recyclerview.widget.ChatListItemAnimator$$ExternalSyntheticLambda6
                            @Override // android.animation.ValueAnimator.AnimatorUpdateListener
                            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                                ChatListItemAnimator.m772$r8$lambda$_2wsYLNOJFHCLdCamOD89maqw(transitionParams, chatActionCell, valueAnimator);
                            }
    ...
    public static /* synthetic */ void m774$r8$lambda$qA9X7ovu6MzHoXlAlzncqZZGW4(MoveInfoExtended moveInfoExtended, ChatMessageCell.TransitionParams transitionParams, ChatMessageCell chatMessageCell, ValueAnimator valueAnimator) {
        float fFloatValue = ((Float) valueAnimator.getAnimatedValue()).floatValue();
        if (moveInfoExtended.animateBackgroundOnly) {
    ...
    public static /* synthetic */ void m770$r8$lambda$FBXPwnxBwHzEwANDozv1cOm6AU(ChatMessageCell.TransitionParams transitionParams, ChatMessageCell chatMessageCell, ValueAnimator valueAnimator) {
    ...
    public static /* synthetic */ void m773$r8$lambda$aRrFzpT1ocseHn5PxS5FEA7rNs(ChatMessageCell.TransitionParams transitionParams, ChatMessageCell chatMessageCell, ValueAnimator valueAnimator) {
    ...
    public static /* synthetic */ void m772$r8$lambda$_2wsYLNOJFHCLdCamOD89maqw(ChatActionCell.TransitionParams transitionParams, ChatActionCell chatActionCell, ValueAnimator valueAnimator) {
        transitionParams.animateChangeProgress = ((Float) valueAnimator.getAnimatedValue()).floatValue();
    ...
    /* JADX WARN: Code duplicated, block: B:38:0x01fe  */
    /* JADX WARN: Code duplicated, block: B:39:0x0236  */
    /* JADX WARN: Code duplicated, block: B:42:0x0240  */
    /* JADX WARN: Code duplicated, block: B:43:0x024e  */
        ...
        if (view instanceof ChatMessageCell) {
            if (viewHolder == this.greetingsSticker) {
                ...
                valueAnimatorOfFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: androidx.recyclerview.widget.ChatListItemAnimator$$ExternalSyntheticLambda8
                    @Override // android.animation.ValueAnimator.AnimatorUpdateListener
                    public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                        ChatListItemAnimator.$r8$lambda$KbxCrKnHJmMtgf00BJ3KTcoIZDE(chatMessageCell2, imageX2, f, imageY2, f2, width, imageWidth, height, imageHeight, valueAnimator);
                    }
                });
