...
public class MediaRouteControllerDialog extends AlertDialog {
    ...
    /* JADX WARN: Code duplicated, block: B:57:0x00b7 A[DONT_INVERT] */
            ...
            if (this.mRoute.getPresentationDisplayId() != -1) {
                ...
                if (playbackStateCompat2 == null || playbackStateCompat2.getState() == 0) {
                    ...
                    if (playbackStateCompat != null) {
                        ...
                        if (z4) {
                            this.mPlaybackControlButton.setImageResource(MediaRouterThemeHelper.getThemeResource(context, i3));
                            this.mPlaybackControlButton.setContentDescription(context.getResources().getText(i4));
                        }
                    }
                }
            }
