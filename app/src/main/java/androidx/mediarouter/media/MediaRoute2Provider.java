...
class MediaRoute2Provider extends MediaRouteProvider {
    ...
    protected void refreshRoutes() {
        ...
        while (it2.hasNext()) {
            MediaRoute2Info mediaRoute2InfoM2 = MediaRoute2Provider$$ExternalSyntheticApiModelOutline0.m(it2.next());
        ...
        while (it3.hasNext()) {
            MediaRoute2Info mediaRoute2InfoM3 = MediaRoute2Provider$$ExternalSyntheticApiModelOutline0.m(it3.next());
    ...
    void setDynamicRouteDescriptors(MediaRouter2.RoutingController routingController) {
        ...
        MediaRouteDescriptor mediaRouteDescriptor = MediaRouter2Utils.toMediaRouteDescriptor(MediaRoute2Provider$$ExternalSyntheticApiModelOutline0.m(selectedRoutes.get(0)));
    ...
    private class TransferCallback extends MediaRouter2$TransferCallback {
        ...
        public void onTransfer(MediaRouter2.RoutingController routingController, MediaRouter2.RoutingController routingController2) {
            ...
            String id = MediaRoute2Provider$$ExternalSyntheticApiModelOutline0.m(selectedRoutes.get(0)).getId();
