...
public abstract class SharedPreferencesMigrationKt {
    ...
    static final class C01201 extends SuspendLambda implements Function2 {
        final /* synthetic */ Set $keysToMigrate;
        /* synthetic */ Object L$0;
        int label;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C01201(Set set, Continuation continuation) {
        ...
        public final Continuation create(Object obj, Continuation continuation) {
            C01201 c01201 = new C01201(this.$keysToMigrate, continuation);
            c01201.L$0 = obj;
            return c01201;
        }
        ...
        public final Object invoke(Preferences preferences, Continuation continuation) {
            return ((C01201) create(preferences, continuation)).invokeSuspend(Unit.INSTANCE);
        }
