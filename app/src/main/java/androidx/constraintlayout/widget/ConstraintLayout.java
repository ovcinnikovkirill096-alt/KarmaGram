        ...
        if (i10 != -1) {
            ...
            if (i4 != -1) {
                ...
                if (constraintWidget8 != null) {
                    ...
                    constraintWidget.immediateConnect(type, constraintWidget8, type, ((ViewGroup.MarginLayoutParams) layoutParams).leftMargin, i8);
                }
 ...
 binds: [B:21:0x004a, B:17:0x003c] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    protected boolean dynamicUpdateConstraints(int i, int i2) {
        ...
        while (i3 < size) {
            ...
            i3++;
            WindowDecorActionBar$$ExternalSyntheticThrowCCEIfNotNull0.m(valueModifier);
