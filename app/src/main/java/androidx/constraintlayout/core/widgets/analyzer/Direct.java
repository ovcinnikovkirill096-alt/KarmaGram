    ...
    private static void horizontalSolvingPass(int i, ConstraintWidget constraintWidget, BasicMeasure.Measurer measurer, boolean z) {
        ...
        if (anchor2.getDependents() != null && anchor2.hasFinalValue()) {
            for (ConstraintAnchor constraintAnchor8 : anchor2.getDependents()) {
                ...
                boolean z5 = ((constraintAnchor8 == constraintWidget3.mLeft && (constraintAnchor2 = constraintWidget3.mRight.mTarget) != null && constraintAnchor2.hasFinalValue()) || (constraintAnchor8 == constraintWidget3.mRight && (constraintAnchor = constraintWidget3.mLeft.mTarget) != null && constraintAnchor.hasFinalValue())) ? z4 : false;
