    ...
    public AppCompatSpinner(Context context, AttributeSet attributeSet, int i, int i2, Resources.Theme theme) throws Throwable {
        ...
        try {
            ...
            if (i2 != 0) {
                ...
                dialogPopup2.setPromptText(tintTypedArrayObtainStyledAttributes.getString(R$styleable.Spinner_android_prompt));
            } else if (i2 == 1) {
                ...
                dropdownPopup2.setBackgroundDrawable(tintTypedArrayObtainStyledAttributes3.getDrawable(R$styleable.Spinner_android_popupBackground));
                dropdownPopup2.setPromptText(tintTypedArrayObtainStyledAttributes.getString(R$styleable.Spinner_android_prompt));
