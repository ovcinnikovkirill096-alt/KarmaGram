        ...
        if (mode != Integer.MIN_VALUE) {
            ...
            if (typedValue == null || (i7 = typedValue.type) == 0) {
                ...
                if (i8 > 0) {
                    ...
                    i = View.MeasureSpec.makeMeasureSpec(Math.min(i8 - (rect2.left + rect2.right), View.MeasureSpec.getSize(i)), TLObject.FLAG_30);
                    z = true;
                } else {
                    z = false;
                }
            ...
            if (typedValue2 != null && (i5 = typedValue2.type) != 0) {
                if (i5 == 5) {
                    ...
                    if (i6 > 0) {
                        ...
                        i2 = View.MeasureSpec.makeMeasureSpec(Math.min(i6 - (rect3.top + rect3.bottom), View.MeasureSpec.getSize(i2)), TLObject.FLAG_30);
                    }
                }
                i6 = (int) fraction2;
                if (i6 > 0) {
                    Rect rect4 = this.mDecorPadding;
                    i2 = View.MeasureSpec.makeMeasureSpec(Math.min(i6 - (rect4.top + rect4.bottom), View.MeasureSpec.getSize(i2)), TLObject.FLAG_30);
                }
            }
        }
        super.onMeasure(i, i2);
        int measuredWidth = getMeasuredWidth();
        int iMakeMeasureSpec = View.MeasureSpec.makeMeasureSpec(measuredWidth, TLObject.FLAG_30);
        if (z || mode != Integer.MIN_VALUE) {
            ...
            if (typedValue3 == null || (i3 = typedValue3.type) == 0) {
                ...
                if (i3 == 5) {
                    ...
                    if (measuredWidth < i4) {
                        iMakeMeasureSpec = View.MeasureSpec.makeMeasureSpec(i4, TLObject.FLAG_30);
                    } else {
                        z2 = false;
                    }
                }
