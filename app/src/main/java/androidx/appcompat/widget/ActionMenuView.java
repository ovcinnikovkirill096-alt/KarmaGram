...
public class ActionMenuView extends LinearLayoutCompat implements MenuBuilder.ItemInvoker, MenuView {
        ...
        if (z5) {
            for (int i27 = i3; i27 < childCount; i27++) {
                ...
                if (layoutParams5.expanded) {
                    childAt4.measure(View.MeasureSpec.makeMeasureSpec((layoutParams5.cellsUsed * i16) + layoutParams5.extraPixels, TLObject.FLAG_30), childMeasureSpec);
                }
            }
        }
    ...
    static int measureChildForCells(View view, int i, int i2, int i3, int i4) {
        ...
        view.measure(View.MeasureSpec.makeMeasureSpec(i * i5, TLObject.FLAG_30), iMakeMeasureSpec);
        return i5;
    }
