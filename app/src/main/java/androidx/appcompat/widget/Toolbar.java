    ...
    protected void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        if (shouldLayout(this.mNavButtonView)) {
            ...
            if (zShouldLayout) {
                ...
                measuredHeight = ((ViewGroup.MarginLayoutParams) layoutParams3).bottomMargin + ((ViewGroup.MarginLayoutParams) layoutParams3).topMargin + this.mTitleTextView.getMeasuredHeight();
            } else {
                measuredHeight = 0;
            }
            if (zShouldLayout2) {
            ...
            if (!zShouldLayout || zShouldLayout2) {
                ...
                if (i6 == 48) {
                    ...
                    if (iMax2 < i15 + i16) {
                        ...
                        if (i17 < i18 + i19) {
                            iMax2 = Math.max(0, iMax2 - ((((ViewGroup.MarginLayoutParams) layoutParams2).bottomMargin + i19) - i17));
                        }
                    }
        ...
        if (zShouldLayout) {
            ...
            measuredHeight = ((ViewGroup.MarginLayoutParams) layoutParams7).bottomMargin + ((ViewGroup.MarginLayoutParams) layoutParams7).topMargin + this.mTitleTextView.getMeasuredHeight();
        } else {
            measuredHeight = 0;
        }
        if (zShouldLayout2) {
