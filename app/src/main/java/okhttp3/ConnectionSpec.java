...
public final class ConnectionSpec {
    ...
    public final List<CipherSuite> m2598deprecated_cipherSuites() {
        return cipherSuites();
    }
    ...
    public final List<TlsVersion> m2600deprecated_tlsVersions() {
        return tlsVersions();
    }

    /* JADX INFO: renamed from: -deprecated_supportsTlsExtensions, reason: not valid java name */
    public final boolean m2599deprecated_supportsTlsExtensions() {
        return this.supportsTlsExtensions;
    }
