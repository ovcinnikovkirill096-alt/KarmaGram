...
public final class MultipartBody extends RequestBody {
    ...
    public final MediaType m2653deprecated_type() {
        return this.type;
    }

    /* JADX INFO: renamed from: -deprecated_boundary, reason: not valid java name */
    public final String m2650deprecated_boundary() {
        return boundary();
    }

    /* JADX INFO: renamed from: -deprecated_size, reason: not valid java name */
    public final int m2652deprecated_size() {
        return size();
    }

    /* JADX INFO: renamed from: -deprecated_parts, reason: not valid java name */
    public final List<Part> m2651deprecated_parts() {
        return this.parts;
    }
    ...
    public static final class Part {
        ...
        public final Headers m2655deprecated_headers() {
            return this.headers;
        }

        /* JADX INFO: renamed from: -deprecated_body, reason: not valid java name */
        public final RequestBody m2654deprecated_body() {
            return this.body;
        }
