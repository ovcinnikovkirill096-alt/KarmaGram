...
public abstract class HandlerDispatcherKt {
    ...
    static {
        ...
        try {
            ...
            objM2437constructorimpl = Result.m2437constructorimpl(new HandlerContext(asHandler(Looper.getMainLooper(), true), null, 2, null));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.Companion;
            objM2437constructorimpl = Result.m2437constructorimpl(ResultKt.createFailure(th));
        }
        Main = (HandlerDispatcher) (Result.m2441isFailureimpl(objM2437constructorimpl) ? null : objM2437constructorimpl);
    }
}
