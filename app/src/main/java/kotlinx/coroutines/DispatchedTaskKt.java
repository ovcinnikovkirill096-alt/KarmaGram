...
public abstract class DispatchedTaskKt {
    ...
    public static final void resume(DispatchedTask dispatchedTask, Continuation continuation, boolean z) {
        ...
        Object objM2437constructorimpl = Result.m2437constructorimpl(successfulResult$kotlinx_coroutines_core);
        if (z) {
            ...
            try {
                dispatchedContinuation.continuation.resumeWith(objM2437constructorimpl);
        ...
        continuation.resumeWith(objM2437constructorimpl);
    }
