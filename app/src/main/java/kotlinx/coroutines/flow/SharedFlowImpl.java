...
public class SharedFlowImpl extends AbstractSharedFlow implements MutableSharedFlow, Flow, FusibleFlow {
    ...
    /* JADX WARN: Code duplicated, block: B:34:0x009a A[Catch: all -> 0x0042, TryCatch #1 {all -> 0x0042, blocks: (B:15:0x003b, B:32:0x0092, B:34:0x009a, B:38:0x00ad, B:39:0x00b0, B:22:0x005d), top: B:48:0x0022 }] */
    /* JADX WARN: Code duplicated, block: B:38:0x00ad A[Catch: all -> 0x0042, TryCatch #1 {all -> 0x0042, blocks: (B:15:0x003b, B:32:0x0092, B:34:0x009a, B:38:0x00ad, B:39:0x00b0, B:22:0x005d), top: B:48:0x0022 }] */
    ...
    static /* synthetic */ Object collect$suspendImpl(SharedFlowImpl sharedFlowImpl, FlowCollector flowCollector, Continuation continuation) throws Throwable {
        ...
        try {
            try {
                if (i2 != 0) {
                    if (i2 == 1) {
                        ...
                        if (i2 == 2) {
                            ...
                            SharedFlowSlot sharedFlowSlot = (SharedFlowSlot) anonymousClass1.L$2;
                            FlowCollector flowCollector3 = (FlowCollector) anonymousClass1.L$1;
                            SharedFlowImpl sharedFlowImpl4 = (SharedFlowImpl) anonymousClass1.L$0;
                            ResultKt.throwOnFailure(obj);
                            r2 = flowCollector3;
                            r5 = sharedFlowImpl4;
                            flowCollector = sharedFlowSlot;
                            do {
                                objTryTakeValue = r5.tryTakeValue(flowCollector);
                                if (objTryTakeValue == SharedFlowKt.NO_VALUE) {
                                    anonymousClass1.L$0 = r5;
                                    ...
                                    Object objEmit = r2.emit(objTryTakeValue, anonymousClass1);
                                    r3 = r2;
                                    r6 = r5;
                                    r12 = flowCollector;
                                }
                            } while (r5.awaitValue(flowCollector, anonymousClass1) != coroutine_suspended);
                        ...
                        SharedFlowImpl sharedFlowImpl5 = (SharedFlowImpl) anonymousClass1.L$0;
                        ResultKt.throwOnFailure(obj);
                        r3 = flowCollector4;
                        r6 = sharedFlowImpl5;
                        r12 = sharedFlowSlot2;
                    ...
                    do {
                        ...
                        if (objTryTakeValue == SharedFlowKt.NO_VALUE) {
                            ...
                            anonymousClass1.L$3 = job2;
                            anonymousClass1.label = 3;
                            Object objEmit2 = r2.emit(objTryTakeValue, anonymousClass1);
                            r3 = r2;
                            r6 = r5;
                            r12 = flowCollector;
                        }
                ...
                ResultKt.throwOnFailure(obj);
                r10 = flowCollector;
                flowCollector = (SharedFlowSlot) sharedFlowImpl.allocateSlot();
                ...
                do {
                    ...
                    if (objTryTakeValue == SharedFlowKt.NO_VALUE) {
                        ...
                        anonymousClass1.L$3 = job2;
                        anonymousClass1.label = 3;
                        Object objEmit3 = r2.emit(objTryTakeValue, anonymousClass1);
                        r3 = r2;
                        r6 = r5;
                        r12 = flowCollector;
                    }
        ...
        synchronized (this) {
            try {
                if (tryPeekLocked(sharedFlowSlot) >= 0) {
                    Result.Companion companion = Result.Companion;
                    cancellableContinuationImpl.resumeWith(Result.m2437constructorimpl(Unit.INSTANCE));
                } else {
            ...
            try {
                ...
                for (Continuation continuation2 : continuationArrFindSlotsToResumeLocked) {
                    if (continuation2 != null) {
                        ...
                        continuation2.resumeWith(Result.m2437constructorimpl(Unit.INSTANCE));
                    }
                }
                Object result = cancellableContinuationImpl.getResult();
                if (result == IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
