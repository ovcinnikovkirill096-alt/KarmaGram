    ...
    public final void resumeImpl$kotlinx_coroutines_core(Object obj, int i, Function3 function3) {
        ...
        while (true) {
            ...
            if (obj2 instanceof NotCompleted) {
                ...
                if (AbstractResolvableFuture$SafeAtomicHelper$$ExternalSyntheticBackportWithForwarding0.m(_state$volatile$FU, this, obj2, resumedState((NotCompleted) obj2, obj3, i2, function4, null))) {
                    detachChildIfNonReusable();
                    dispatchResume(i2);
                    return;
                } else {
                ...
                if (obj2 instanceof CancelledContinuation) {
                    ...
                    if (cancelledContinuation.makeResumed()) {
                        if (function5 != null) {
                            callOnCancellation(function5, cancelledContinuation.cause, obj4);
                            return;
                        }
                        return;
                    }
    ...
    private final Symbol tryResumeImpl(Object obj, Object obj2, Function3 function3) {
        ...
        while (true) {
            ...
            if (obj3 instanceof NotCompleted) {
                ...
                Object obj5 = obj2;
                Function3 function4 = function3;
                if (AbstractResolvableFuture$SafeAtomicHelper$$ExternalSyntheticBackportWithForwarding0.m(_state$volatile$FU, this, obj3, resumedState((NotCompleted) obj3, obj4, this.resumeMode, function4, obj5))) {
                    detachChildIfNonReusable();
