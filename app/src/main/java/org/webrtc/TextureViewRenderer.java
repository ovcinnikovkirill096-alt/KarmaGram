...
public class TextureViewRenderer extends TextureView implements TextureView.SurfaceTextureListener, VideoSink, RendererCommon.RendererEvents {
    ...
    /* JADX WARN: Code duplicated, block: B:17:0x0025 A[PHI: r0
  0x0025: PHI (r0v15 int) = (r0v5 int), (r0v17 int), (r0v20 int) binds: [B:43:0x005b, B:29:0x003b, B:16:0x0023] A[DONT_GENERATE, DONT_INLINE]] */
    /* JADX WARN: Code duplicated, block: B:18:0x0027 A[PHI: r0
  0x0027: PHI (r0v8 int) = (r0v5 int), (r0v5 int), (r0v5 int), (r0v17 int), (r0v17 int), (r0v17 int), (r0v20 int) binds: [B:41:0x0057, B:42:0x0059, B:43:0x005b, B:27:0x0037, B:28:0x0039, B:29:0x003b, B:16:0x0023] A[DONT_GENERATE, DONT_INLINE]] */
            ...
            try {
                try {
                    ...
                    Runnable runnable2 = new Runnable() { // from class: org.webrtc.TextureViewRenderer$$ExternalSyntheticLambda0
                        @Override // java.lang.Runnable
                        public final void run() {
                            this.f$0.lambda$onFrameResolutionChanged$0(i, i2, i10, i9);
                        }
                    };
