        ...
        if (this.captureType == 1) {
            if (Build.VERSION.SDK_INT >= 29) {
                try {
                    ...
                    WebRtcAudioRecord$$ExternalSyntheticApiModelOutline1.m();
                    AudioPlaybackCaptureConfiguration.Builder builderM = WebRtcAudioRecord$$ExternalSyntheticApiModelOutline0.m(mediaProjection);
                    builderM.addMatchingUsage(1);
                    builderM.addMatchingUsage(14);
                    builderM.addMatchingUsage(0);
                    AudioRecord.Builder builder = new AudioRecord.Builder();
                    builder.setAudioPlaybackCaptureConfig(builderM.build());
