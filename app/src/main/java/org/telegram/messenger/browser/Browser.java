...
public abstract class Browser {
    ...
    /*  JADX ERROR: Types fix failed
        ...
        */
    public static void openUrl(android.content.Context r16, android.net.Uri r17, boolean r18, boolean r19, boolean r20, org.telegram.messenger.browser.Browser.Progress r21, java.lang.String r22, boolean r23, boolean r24, boolean r25) {
        /*
    ...
    public static /* synthetic */ void m3829$r8$lambda$r0CCMiFnrGCwmVQpGqtZgRrTxo(Progress progress, AlertDialog[] alertDialogArr, TLObject tLObject, int i, Uri uri, Context context, boolean z) {
        if (progress != null) {
            progress.end();
        } else {
            try {
