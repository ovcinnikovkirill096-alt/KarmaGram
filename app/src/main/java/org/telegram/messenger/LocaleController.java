...
public class LocaleController {
            ...
            synchronized (this) {
                try {
                    if (this.formatterDay == null) {
                        ...
                        if (is24HourFormat) {
                            str2 = ExteraConfig.formatTimeWithSeconds ? "HH:mm:ss" : "HH:mm";
                        } else {
                            str2 = ExteraConfig.formatTimeWithSeconds ? "h:mm:ss a" : "h:mm a";
                        }
        ...
        try {
            ...
            if (strArrSplit.length == 1) {
                try {
                    ...
                    e = e;
                    i2 = iApplyRemoteLanguage;
                    FileLog.e(e);
                    z6 = false;
                    this.changingConfiguration = false;
                    recreateFormatters();
                    if (z4) {
                        MediaDataController.getInstance(i).loadAttachMenuBots(z6, true);
                    }
                    return i2;
                }
            } else {
            ...
            if (this.currentPluralRules == null) {
                this.currentPluralRules = this.allRules.get(strArrSplit[c]);
            }
            if (this.currentPluralRules == null) {
            ...
            if (this.reloadLastFile || (!z5 && !z4 && shouldReinstallLangpack(localeInfo.shortName))) {
                if (BuildVars.LOGS_ENABLED) {
                    FileLog.d("reload locale because one of file is corrupted " + pathToFile + " " + pathToBaseFile + " reloadLastFile=" + this.reloadLastFile + " isLoadingRemote=" + z5 + " force=" + z4);
                }
                if (z2) {
    ...
    /* JADX WARN: Code duplicated, block: B:23:0x0060 A[Catch: Exception -> 0x0011, TryCatch #2 {Exception -> 0x0011, blocks: (B:2:0x0000, B:4:0x0004, B:9:0x0016, B:12:0x001c, B:21:0x0058, B:23:0x0060, B:25:0x006b), top: B:35:0x0000 }] */
    /* JADX WARN: Code duplicated, block: B:25:0x006b A[Catch: Exception -> 0x0011, TRY_LEAVE, TryCatch #2 {Exception -> 0x0011, blocks: (B:2:0x0000, B:4:0x0004, B:9:0x0016, B:12:0x001c, B:21:0x0058, B:23:0x0060, B:25:0x006b), top: B:35:0x0000 }] */
    ...
    /* JADX WARN: Code duplicated, block: B:25:0x0064 A[Catch: Exception -> 0x0013, TryCatch #2 {Exception -> 0x0013, blocks: (B:3:0x0002, B:5:0x0006, B:10:0x0019, B:13:0x001f, B:22:0x005b, B:23:0x0061, B:25:0x0064, B:27:0x006d, B:39:0x00ac, B:41:0x00d0, B:42:0x00d9, B:44:0x00f2, B:28:0x0070, B:31:0x0078, B:33:0x008d, B:35:0x0091), top: B:55:0x0002 }] */
    /* JADX WARN: Code duplicated, block: B:27:0x006d A[Catch: Exception -> 0x0013, TryCatch #2 {Exception -> 0x0013, blocks: (B:3:0x0002, B:5:0x0006, B:10:0x0019, B:13:0x001f, B:22:0x005b, B:23:0x0061, B:25:0x0064, B:27:0x006d, B:39:0x00ac, B:41:0x00d0, B:42:0x00d9, B:44:0x00f2, B:28:0x0070, B:31:0x0078, B:33:0x008d, B:35:0x0091), top: B:55:0x0002 }] */
    /* JADX WARN: Code duplicated, block: B:28:0x0070 A[Catch: Exception -> 0x0013, TRY_LEAVE, TryCatch #2 {Exception -> 0x0013, blocks: (B:3:0x0002, B:5:0x0006, B:10:0x0019, B:13:0x001f, B:22:0x005b, B:23:0x0061, B:25:0x0064, B:27:0x006d, B:39:0x00ac, B:41:0x00d0, B:42:0x00d9, B:44:0x00f2, B:28:0x0070, B:31:0x0078, B:33:0x008d, B:35:0x0091), top: B:55:0x0002 }] */
    /* JADX WARN: Code duplicated, block: B:31:0x0078 A[Catch: Exception -> 0x0013, TRY_ENTER, TryCatch #2 {Exception -> 0x0013, blocks: (B:3:0x0002, B:5:0x0006, B:10:0x0019, B:13:0x001f, B:22:0x005b, B:23:0x0061, B:25:0x0064, B:27:0x006d, B:39:0x00ac, B:41:0x00d0, B:42:0x00d9, B:44:0x00f2, B:28:0x0070, B:31:0x0078, B:33:0x008d, B:35:0x0091), top: B:55:0x0002 }] */
    /* JADX WARN: Code duplicated, block: B:33:0x008d A[Catch: Exception -> 0x0013, TryCatch #2 {Exception -> 0x0013, blocks: (B:3:0x0002, B:5:0x0006, B:10:0x0019, B:13:0x001f, B:22:0x005b, B:23:0x0061, B:25:0x0064, B:27:0x006d, B:39:0x00ac, B:41:0x00d0, B:42:0x00d9, B:44:0x00f2, B:28:0x0070, B:31:0x0078, B:33:0x008d, B:35:0x0091), top: B:55:0x0002 }] */
    /* JADX WARN: Code duplicated, block: B:35:0x0091 A[Catch: Exception -> 0x0013, TryCatch #2 {Exception -> 0x0013, blocks: (B:3:0x0002, B:5:0x0006, B:10:0x0019, B:13:0x001f, B:22:0x005b, B:23:0x0061, B:25:0x0064, B:27:0x006d, B:39:0x00ac, B:41:0x00d0, B:42:0x00d9, B:44:0x00f2, B:28:0x0070, B:31:0x0078, B:33:0x008d, B:35:0x0091), top: B:55:0x0002 }] */
    ...
    /* JADX WARN: Code duplicated, block: B:57:0x00d9 A[SYNTHETIC] */
    /* JADX WARN: Code duplicated, block: B:59:0x00d0 A[SYNTHETIC] */
    /* JADX WARN: Code duplicated, block: B:60:0x00f2 A[SYNTHETIC] */
    /* JADX WARN: Code duplicated, block: B:62:0x0061 A[SYNTHETIC] */
    /* JADX WARN: Instruction removed from duplicated block: B:31:0x0078, please report this as an issue */
    /* JADX WARN: Instruction removed from duplicated block: B:35:0x0091, please report this as an issue */
            ...
            if (string2 == null) {
                ...
                if (string2 == null) {
                    try {
                        if (i != 0) {
                            try {
                                string2 = getInstance().getLocalizedContext().getString(i);
                            } catch (Exception unused) {
                                if (i2 != 0) {
                                    string2 = getInstance().getLocalizedContext().getString(i2);
                                }
                                ...
                                while (i3 < objArr.length) {
                                    ...
                                    if (obj instanceof CharSequence) {
                                        ...
                                        if (obj instanceof Integer) {
                                            charSequence = _UrlKt.FRAGMENT_ENCODE_SET + ((Integer) objArr[i3]);
                                        } else if (obj instanceof Long) {
                                            charSequence = _UrlKt.FRAGMENT_ENCODE_SET + ((Long) objArr[i3]);
                                        } else if (obj == null) {
                                            charSequence = "null";
                                        } else {
    ...
    public static String formatDateOnline(long j, boolean[] zArr) {
        return formatDateOnline(j, zArr, null, false);
    }

    public static String formatDateOnline(long j, boolean[] zArr, boolean[] zArr2, boolean z) {
        String str = z ? "~" : _UrlKt.FRAGMENT_ENCODE_SET;
        if (zArr2 != null) {
            try {
                if (ExteraConfig.relativeLastSeen) {
                    ...
                    if (jCurrentTimeMillis < 86400) {
                        String relativeDate = formatRelativeDate(jCurrentTimeMillis);
                        return formatString(R.string.LastSeenDateFormatted, str + relativeDate);
                    }
                }
            } catch (Exception e) {
                FileLog.e(e);
        ...
        if (i4 == i && i2 == i5) {
            return formatString(R.string.LastSeenFormatted, formatString("TodayAtFormatted", R.string.TodayAtFormatted, str + getInstance().getFormatterDay().format(new Date(j2))));
        }
        if (i4 + 1 != i || i2 != i5) {
            if (Math.abs(System.currentTimeMillis() - j2) < 31536000000L) {
                return formatString("LastSeenDateFormatted", R.string.LastSeenDateFormatted, formatString("formatDateAtTime", R.string.formatDateAtTime, getInstance().getFormatterDayMonth().format(new Date(j2)), str + getInstance().getFormatterDay().format(new Date(j2))));
            }
            return formatString("LastSeenDateFormatted", R.string.LastSeenDateFormatted, formatString("formatDateAtTime", R.string.formatDateAtTime, getInstance().getFormatterYear().format(new Date(j2)), str + getInstance().getFormatterDay().format(new Date(j2))));
        }
        if (zArr != null) {
            zArr[0] = true;
            if (i3 <= 6 && i6 > 18 && is24HourFormat) {
                return formatString(R.string.LastSeenFormatted, str + getInstance().getFormatterDay().format(new Date(j2)));
            }
            return formatString(R.string.YesterdayAtFormatted, str + getInstance().getFormatterDay().format(new Date(j2)));
        }
        return formatString(R.string.LastSeenFormatted, str + formatString("YesterdayAtFormatted", R.string.YesterdayAtFormatted, getInstance().getFormatterDay().format(new Date(j2))));
    }
    ...
    public static String formatShortNumber(int i, int[] iArr) {
        ...
        if (i2 == 0 || sb2.length() <= 0) {
            return sb2.length() == 2 ? String.format(Locale.US, "%dM", Integer.valueOf(i)) : String.format(Locale.US, "%d%s", Integer.valueOf(i), sb2.toString());
        }
        return sb2.length() == 2 ? String.format(Locale.US, "%d.%dM", Integer.valueOf(i), Integer.valueOf(i2)) : String.format(Locale.US, "%d.%d%s", Integer.valueOf(i), Integer.valueOf(i2), sb2.toString());
    }
    ...
    public static String formatGroupMemberJoined(long j) {
        ...
        try {
            ...
            return formatString(R.string.GroupMemberJoined, string);
        } catch (Exception e) {
            FileLog.e(e);
            return "LOC_ERR";
        }
    ...
    public static String formatUserStatus(int i, TLRPC.User user, boolean[] zArr, boolean[] zArr2, boolean[] zArr3) {
        ...
        if (user != null && AyuGhostController.getInstance(i).showLastOnline() && user.id == UserConfig.getInstance(i).getClientUserId()) {
            return getString(R.string.LikelyOfflineStatus);
        }
        ...
        if (AyuSpyController.isBadStatus(userStatus4) && (lastSeenCached = AyuSpyController.getInstance(i).getLastSeenCached(user.id)) != null) {
            return formatDateOnline(lastSeenCached.intValue(), zArr2, zArr3, true);
        }
        ...
        return formatDateOnline(i2, zArr2, zArr3, false);
    }
    ...
    private int applyRemoteLanguage(final LocaleInfo localeInfo, String str, boolean z, final int i, final Runnable runnable) {
        ...
        final Runnable runnable2 = new Runnable() { // from class: org.telegram.messenger.LocaleController$$ExternalSyntheticLambda0
            @Override // java.lang.Runnable
            public final void run() {
                LocaleController.m3100$r8$lambda$M8xnqQcNw5oaI4ZxKjhICarw5Y(iArr, iArr2, runnable);
            }
        };
        if (z) {
    ...
    /* JADX INFO: renamed from: $r8$lambda$M8xnqQcNw5oaI4ZxKjhICarw5-Y, reason: not valid java name */
    public static /* synthetic */ void m3100$r8$lambda$M8xnqQcNw5oaI4ZxKjhICarw5Y(int[] iArr, int[] iArr2, Runnable runnable) {
        int i = iArr[0] + 1;
        iArr[0] = i;
    ...
    public static String formatDistance(float f, int i, Boolean bool) {
        ...
        if ((bool == null || !bool.booleanValue()) && !(bool == null && useImperialSystemType.booleanValue())) {
            if (f < 1000.0f) {
                if (i != 0) {
                    return i != 1 ? formatString("MetersShort", R.string.MetersShort, String.format(TimeModel.NUMBER_FORMAT, Integer.valueOf((int) Math.max(1.0f, f)))) : formatString("MetersFromYou2", R.string.MetersFromYou2, String.format(TimeModel.NUMBER_FORMAT, Integer.valueOf((int) Math.max(1.0f, f))));
                }
        ...
        if (f2 < 1000.0f) {
            if (i != 0) {
                return i != 1 ? formatString("FootsShort", R.string.FootsShort, String.format(TimeModel.NUMBER_FORMAT, Integer.valueOf((int) Math.max(1.0f, f2)))) : formatString("FootsFromYou", R.string.FootsFromYou, String.format(TimeModel.NUMBER_FORMAT, Integer.valueOf((int) Math.max(1.0f, f2))));
            }
