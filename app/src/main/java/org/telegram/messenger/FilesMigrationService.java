...
public class FilesMigrationService extends Service {
    ...
    public int onStartCommand(Intent intent, int i, int i2) {
        ...
        Notification notificationBuild = FilesMigrationService$$ExternalSyntheticApiModelOutline1.m(this, NotificationsController.OTHER_NOTIFICATIONS_CHANNEL).setContentTitle(getText(R.string.MigratingFiles)).setAutoCancel(false).setSmallIcon(R.drawable.notification).build();
        isRunning = true;
    ...
    /* JADX INFO: renamed from: org.telegram.messenger.FilesMigrationService$1, reason: invalid class name */
