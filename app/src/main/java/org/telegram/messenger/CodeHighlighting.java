...
public class CodeHighlighting {
    ...
    public static /* synthetic */ void $r8$lambda$XTnjLp_BVmwXi3aPqiNejzIqyz8(final Spannable spannable, int i, int i2, String str) throws Throwable {
        ...
        AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.messenger.CodeHighlighting$$ExternalSyntheticLambda2
            @Override // java.lang.Runnable
            public final void run() {
                CodeHighlighting.m2799$r8$lambda$UiXL2Y0hc7PijByg2qsFXIT_c(arrayList, spannable);
            }
        });
    }
    ...
    public static /* synthetic */ void m2799$r8$lambda$UiXL2Y0hc7PijByg2qsFXIT_c(ArrayList arrayList, Spannable spannable) {
        long jCurrentTimeMillis = System.currentTimeMillis();
    ...
    /* JADX WARN: Code duplicated, block: B:71:0x013a A[Catch: Exception -> 0x0136, TryCatch #6 {Exception -> 0x0136, blocks: (B:67:0x0132, B:71:0x013a, B:73:0x013f), top: B:78:0x0132 }] */
    /* JADX WARN: Code duplicated, block: B:73:0x013f A[Catch: Exception -> 0x0136, TRY_LEAVE, TryCatch #6 {Exception -> 0x0136, blocks: (B:67:0x0132, B:71:0x013a, B:73:0x013f), top: B:78:0x0132 }] */
    /* JADX WARN: Code duplicated, block: B:78:0x0132 A[EXC_TOP_SPLITTER, SYNTHETIC] */
