...
public class UserObject {
    ...
    public static Long getEmojiStatusDocumentId(TLRPC.User user) {
        ...
        if (user.self && AyuConfig.localPremium && (fakePremiumEmojiStatus = LocalPremiumUtils.getFakePremiumEmojiStatus(user.id)) != null) {
    ...
    public static int getColorId(TLRPC.User user) {
        ...
        if (user.self && AyuConfig.localPremium && (localQuoteColor = LocalPremiumUtils.getLocalQuoteColor(user.id)) != -1) {
    ...
    public static long getEmojiId(TLRPC.User user) {
        if (user != null && user.self && AyuConfig.localPremium) {
            long localQuoteEmoji = LocalPremiumUtils.getLocalQuoteEmoji(user.id);
    ...
    public static int getProfileColorId(TLRPC.User user) {
        ...
        if (user.self && AyuConfig.localPremium && (localProfileColor = LocalPremiumUtils.getLocalProfileColor(user.id)) != -1) {
    ...
    public static long getProfileEmojiId(TLRPC.User user) {
        ...
        if (user != null && user.self && AyuConfig.localPremium) {
            long localProfileEmoji = LocalPremiumUtils.getLocalProfileEmoji(user.id);
