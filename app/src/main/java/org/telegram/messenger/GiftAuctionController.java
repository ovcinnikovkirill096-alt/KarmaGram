...
public class GiftAuctionController extends BaseController {
    ...
    private void updateActiveAuctions() {
        ...
        j$.util.List.EL.sort(this.activeAuctions, Comparator.CC.comparingInt(new ToIntFunction() { // from class: org.telegram.messenger.GiftAuctionController$$ExternalSyntheticLambda4
