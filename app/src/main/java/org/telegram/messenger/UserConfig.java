...
public class UserConfig extends BaseController {
    ...
    public void setShowContactsTab(final BaseFragment baseFragment, final boolean z) {
        ...
        (baseFragment != null ? BulletinFactory.of(baseFragment) : BulletinFactory.global()).createSimpleBulletin(R.raw.contact_check, LocaleController.getString(z ? R.string.ContactsTabWasShownTitle : R.string.ContactsTabWasHiddenTitle), LocaleController.getString(R.string.UndoNoCaps), 5000, true, new Runnable() { // from class: org.telegram.messenger.UserConfig$$ExternalSyntheticLambda3
            @Override // java.lang.Runnable
            public final void run() {
