...
public class PipSource {
    ...
    private PipSource(PipActivityController pipActivityController, Builder builder) {
        ...
        Builder.m3924$$Nest$fgetactionListener(builder);
    ...
    public static class Builder {
        ...
        /* JADX INFO: renamed from: -$$Nest$fgetactionListener, reason: not valid java name */
        static /* bridge */ /* synthetic */ IPipActivityActionListener m3924$$Nest$fgetactionListener(Builder builder) {
            builder.getClass();
            return null;
        }
