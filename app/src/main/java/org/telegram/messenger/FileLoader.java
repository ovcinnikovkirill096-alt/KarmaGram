...
public class FileLoader extends BaseController {
    ...
    /* JADX INFO: renamed from: org.telegram.messenger.FileLoader$1, reason: invalid class name */
    ...
    /* JADX WARN: Code duplicated, block: B:113:0x020b  */
    /* JADX WARN: Code duplicated, block: B:119:0x021f A[PHI: r4
  0x021f: PHI (r4v28 java.io.File) = (r4v14 java.io.File), (r4v31 java.io.File) binds: [B:129:0x023d, B:118:0x021d] A[DONT_GENERATE, DONT_INLINE]] */
    /* JADX WARN: Code duplicated, block: B:79:0x0175 A[PHI: r5
  0x0175: PHI (r5v4 org.telegram.messenger.FileLoadOperation) = (r5v28 org.telegram.messenger.FileLoadOperation), (r5v29 org.telegram.messenger.FileLoadOperation) binds: [B:76:0x0168, B:78:0x0173] A[DONT_GENERATE, DONT_INLINE]] */
        ...
        if (tL_fileLocationToBeDeprecated != null) {
            ...
            if (secureDocument != null) {
                ...
                if (i2 != 10 && !TextUtils.isEmpty(str3) && !str3.contains("-2147483648")) {
                    this.loadOperationPathsUI.put(str3, new LoadOperationUIObject());
                }
                ...
                FileLoadOperation fileLoadOperation5 = this.loadOperationPaths.get(str3);
                int priorityValue = getPriorityValue(i);
                if (fileLoadOperation5 != null) {
                    if (i2 == 10 || !fileLoadOperation5.isPreloadVideoOperation()) {
                        z2 = false;
                    } else {
                        z2 = false;
                        fileLoadOperation5.setIsPreloadVideoOperation(false);
                    }
                    fileLoadOperation5.setForceRequest(priorityValue > 0 ? true : z2);
                    fileLoadOperation5.setStream(fileLoadOperationStream, z, j2);
                    if (fileLoadOperation5.getPriority() != priorityValue) {
                        fileLoadOperation5.setPriority(priorityValue);
                        z3 = true;
                    } else {
                        z3 = z2;
                    }
                    fileLoadOperation5.getQueue().add(fileLoadOperation5);
                    fileLoadOperation5.updateProgress();
                    if (z3) {
                        fileLoadOperation5.getQueue().checkLoadingOperations();
                    }
                ...
                if (secureDocument != null) {
                    ...
                    j3 = 0;
                    r0 = 1;
                    fileLoadOperation4 = new FileLoadOperation(secureDocument);
                } else if (tL_fileLocationToBeDeprecated != null) {
                    long j6 = tL_fileLocationToBeDeprecated.volume_id;
                    i3 = priorityValue;
                    i4 = 0;
                    r0 = 1;
                    i5 = tL_fileLocationToBeDeprecated.dc_id + (tL_fileLocationToBeDeprecated.local_id << 16);
                    fileLoadOperation4 = new FileLoadOperation(imageLocation, obj, str2, j);
                    j3 = j6;
                    i6 = 0;
                } else {
                    i3 = priorityValue;
                    ...
                    if (document != null) {
                        ...
                        if (webFile.location != null) {
                            ...
                            j3 = 0;
                            i6 = 2;
                            fileLoadOperation4 = fileLoadOperation7;
                        } else {
                ...
                int iClamp = Utilities.clamp((int) (fileLoadOperation4.getDatacenterId() - r0), 4, i4);
                boolean z4 = obj instanceof TL_stories.StoryItem;
                if (fileLoadOperation4.totalBytesCount > 20971520 || z4) {
                    fileLoaderPriorityQueue = this.largeFilesQueue[iClamp];
                } else {
                    fileLoaderPriorityQueue = this.smallFilesQueue[iClamp];
                }
                ?? r18 = fileLoaderPriorityQueue;
                if (i2 != 0 && i2 != 10 && !z4) {
                    if (i2 == 2) {
                        fileLoadOperation4.setEncryptFile(r0);
                    }
                    str4 = str3;
                    ...
                    String path = getFileDatabase().getPath(j3, i5, i6, true);
                    j5 = j3;
                    int i10 = i5;
                    i9 = i6;
                    if (path != null) {
                    ...
                    if (r16 == 0) {
                        ...
                        if (z4) {
                            ...
                            if ((i9 == 0 || i9 == 2) && canSaveToPublicStorage(obj)) {
                                if (i9 == 0) {
                        ...
                        if (r4 != 0) {
                            fileLoadOperation4.pathSaveData = new FilePathDatabase.PathData(j5, i10, i9);
                        }
                    }
                    ...
                    j5 = j3;
                    i9 = i6;
                    directory = getDirectory(i9);
                    str4 = str3;
                }
                String str5 = str3;
                ?? r15 = fileLoadOperation4;
                r15.setPaths(this.currentAccount, str5, r18, directory, directory4, str4);
                if (i2 == 10) {
                    r15.setIsPreloadVideoOperation(r0);
                }
                ?? r2 = r0;
                r15.setDelegate(new AnonymousClass2(obj, document, str5, i9));
                this.loadOperationPaths.put(str5, r15);
                int i11 = i3;
                r15.setPriority(i11);
                FileStreamLoadOperation fileStreamLoadOperation = fileLoadOperationStream == null ? FileStreamLoadOperation.allStreams.get(Long.valueOf(j5)) : fileLoadOperationStream;
                if (fileStreamLoadOperation != null) {
                    r15.setStream(fileStreamLoadOperation, z, j2);
                }
                r18.add(r15);
                r18.checkLoadingOperations((!r15.isStory || i11 < 1048576) ? i4 : r2 == true ? 1 : 0);
                if (BuildVars.LOGS_ENABLED) {
                    FileLog.d("create load operation fileName=" + str5 + " documentName=" + getDocumentFileName(document) + " size=" + AndroidUtilities.formatFileSize(r15.totalBytesCount) + " position in queue " + r15.getPositionInQueue() + " account=" + this.currentAccount + " cacheType=" + i2 + " priority=" + r15.getPriority() + " stream=" + fileStreamLoadOperation);
                }
                return r15;
            }
        }
    ...
    /* JADX INFO: renamed from: org.telegram.messenger.FileLoader$2, reason: invalid class name */
    class AnonymousClass2 implements FileLoadOperation.FileLoadOperationDelegate {
        ...
        public void didPreFinishLoading(final FileLoadOperation fileLoadOperation, File file) {
            ...
            FileLoader.fileLoaderQueue.postRunnable(new Runnable() { // from class: org.telegram.messenger.FileLoader$2$$ExternalSyntheticLambda0
                @Override // java.lang.Runnable
                public final void run() {
                    FileLoader.AnonymousClass2.m2911$r8$lambda$mxbBfeFTETIsHMKtk_6I_mmOw(fileLoadOperation, queue);
                }
            });
        }

        /* JADX INFO: renamed from: $r8$lambda$mxbBfe-FTETIsHMKtk_6I_m-mOw, reason: not valid java name */
        public static /* synthetic */ void m2911$r8$lambda$mxbBfeFTETIsHMKtk_6I_mmOw(FileLoadOperation fileLoadOperation, FileLoaderPriorityQueue fileLoaderPriorityQueue) {
    ...
    /* JADX WARN: Code duplicated, block: B:131:0x01c1  */
            ...
            if (tLObject instanceof TLRPC.Document) {
                ...
                if (tLObject instanceof TLRPC.PhotoSize) {
                    ...
                    if ((photoSize instanceof TLRPC.TL_photoStrippedSize) || (photoSize instanceof TLRPC.TL_photoPathSize)) {
                        ...
                        if (fileLocation3 == null || fileLocation3.key != null || ((fileLocation3.volume_id == -2147483648L && fileLocation3.local_id < 0) || photoSize.size < 0)) {
                    ...
                    TLRPC.FileLocation fileLocation4 = photoSize.location;
                    j2 = fileLocation4.volume_id;
                    i4 = fileLocation4.dc_id;
                    i5 = fileLocation4.local_id;
                } else {
                    if (tLObject instanceof TLRPC.TL_videoSize) {
                        ...
                        if (fileLocation5 == null || fileLocation5.key != null || ((fileLocation5.volume_id == -2147483648L && fileLocation5.local_id < 0) || tL_videoSize.size < 0)) {
                            directory2 = getDirectory(4);
                        } else {
                            directory2 = getDirectory(0);
                            i7 = 0;
                        }
                        TLRPC.FileLocation fileLocation6 = tL_videoSize.location;
                        j2 = fileLocation6.volume_id;
                        i4 = fileLocation6.dc_id;
                        i5 = fileLocation6.local_id;
                    } else if (tLObject instanceof TLRPC.FileLocation) {
                        TLRPC.FileLocation fileLocation7 = (TLRPC.FileLocation) tLObject;
                        if (fileLocation7.key == null) {
                            j = fileLocation7.volume_id;
                            if (j == -2147483648L && fileLocation7.local_id < 0) {
                                directory = getDirectory(4);
                                j = 0;
                                i3 = 0;
                            } else {
                                i3 = fileLocation7.dc_id + (fileLocation7.local_id << 16);
                    ...
                    if (tLObject instanceof TLRPC.PhotoSize) {
                        fileLocation2 = ((TLRPC.PhotoSize) tLObject).location;
                        if (fileLocation2 instanceof AyuFileLocation) {
                            return new File(((AyuFileLocation) fileLocation2).path);
                        }
                    } else if (tLObject instanceof TLRPC.TL_videoSize) {
                        fileLocation = ((TLRPC.TL_videoSize) tLObject).location;
                        if (fileLocation instanceof AyuFileLocation) {
                            return new File(((AyuFileLocation) fileLocation).path);
                        }
                    } else if (tLObject instanceof AyuFileLocation) {
                        return new File(((AyuFileLocation) tLObject).path);
                    }
                    if (directory == null) {
                        return new File(_UrlKt.FRAGMENT_ENCODE_SET);
                    }
    ...
    /* JADX WARN: Code duplicated, block: B:46:0x006b A[PHI: r6
  0x006b: PHI (r6v2 int) = (r6v1 int), (r6v1 int), (r6v1 int), (r6v1 int), (r6v4 int), (r6v4 int), (r6v4 int), (r6v4 int) binds: [B:36:0x0057, B:43:0x0065, B:45:0x0069, B:41:0x0061, B:24:0x003a, B:31:0x0048, B:33:0x004c, B:29:0x0044] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    /* JADX WARN: Code duplicated, block: B:38:0x005a A[PHI: r5
  0x005a: PHI (r5v2 int) = (r5v1 int), (r5v1 int), (r5v1 int), (r5v4 int), (r5v4 int), (r5v4 int) binds: [B:30:0x004a, B:37:0x0058, B:35:0x0054, B:20:0x0031, B:27:0x003f, B:25:0x003b] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    public static String getAttachFileName(TLObject tLObject, String str, String str2) {
        ...
        if (z) {
            ...
            if (extensionByMimeType.length() > 1) {
                return document.dc_id + "_" + document.id + extensionByMimeType;
            }
    ...
    public void uploadFile(final String str, final Utilities.Callback<TLRPC.InputFile> callback) {
        ...
        final NotificationCenter.NotificationCenterDelegate[] notificationCenterDelegateArr = {new NotificationCenter.NotificationCenterDelegate() { // from class: org.telegram.messenger.FileLoader$$ExternalSyntheticLambda19
            ...
            public final void didReceivedNotification(int i, int i2, Object[] objArr) {
                FileLoader.m2894$r8$lambda$gKJsZClCE1qk51wAobZ3vhvknU(str, callback, runnable, i, i2, objArr);
            }
        }};
    ...
    /* JADX INFO: renamed from: $r8$lambda$gKJsZClCE1qk51wAobZ3v-hvknU, reason: not valid java name */
    public static /* synthetic */ void m2894$r8$lambda$gKJsZClCE1qk51wAobZ3vhvknU(String str, Utilities.Callback callback, Runnable runnable, int i, int i2, Object[] objArr) {
