...
public class ChannelBoostsController {
    ...
    public void userCanBoostChannel(long j, final TL_stories.TL_premium_boostsStatus tL_premium_boostsStatus, final Consumer consumer) {
        ...
        BoostRepository.getMyBoosts(new Utilities.Callback() { // from class: org.telegram.messenger.ChannelBoostsController$$ExternalSyntheticLambda2
            ...
            public final void run(Object obj) {
                ChannelBoostsController.m2772$r8$lambda$QUjpU3jxTyAfx8XRNTCZyEH0Y(canApplyBoost, tL_premium_boostsStatus, consumer, (TL_stories.TL_premium_myBoosts) obj);
            }
    ...
    public static /* synthetic */ void m2772$r8$lambda$QUjpU3jxTyAfx8XRNTCZyEH0Y(CanApplyBoost canApplyBoost, TL_stories.TL_premium_boostsStatus tL_premium_boostsStatus, Consumer consumer, TL_stories.TL_premium_myBoosts tL_premium_myBoosts) {
        ...
        public void setMyBoosts(TL_stories.TL_premium_myBoosts tL_premium_myBoosts) {
            ...
            if (this.slot == 0) {
                ...
                while (i3 < size3) {
                    ...
                    if (peer != null && this.currentChat != null && DialogObject.getPeerDialogId(peer) != (-this.currentChat.id)) {
