...
public class PasskeysController {
        ...
        if (BuildVars.SUPPORTS_PASSKEYS) {
            ...
            ConnectionsManager.getInstance(i).sendRequestTyped(new TL_account.initPasskeyRegistration(), new BotForumHelper$$ExternalSyntheticLambda2(), new Utilities.Callback2() { // from class: org.telegram.messenger.PasskeysController$$ExternalSyntheticLambda12
                ...
                public final void run(Object obj, Object obj2) {
                    PasskeysController.m3662$r8$lambda$uzlz7C9RirnBVnV8ty3z_v7jkQ(alertDialog, callback2, credentialManagerCreate, context, i, (TL_account.passkeyRegistrationOptions) obj, (TLRPC.TL_error) obj2);
                }
            });
        }
    }
    ...
    public static /* synthetic */ void m3662$r8$lambda$uzlz7C9RirnBVnV8ty3z_v7jkQ(AlertDialog alertDialog, final Utilities.Callback2 callback2, CredentialManager credentialManager, final Context context, final int i, TL_account.passkeyRegistrationOptions passkeyregistrationoptions, TLRPC.TL_error tL_error) {
        alertDialog.dismiss();
        if (tL_error != null) {
        ...
        try {
            ...
            try {
                credentialManager.createCredential(context, new CreatePublicKeyCredentialRequest(string, PasskeysUtil.computeClientDataHash(strGenerateClientDataJSONRaw), false, str), ktxCallback(new Utilities.Callback2() { // from class: org.telegram.messenger.PasskeysController$$ExternalSyntheticLambda8
                    @Override // org.telegram.messenger.Utilities.Callback2
                    public final void run(Object obj, Object obj2) {
                        PasskeysController.m3659$r8$lambda$1MjSTZs9CI0K3y07f5XdZkv0jE(callback2, strGenerateClientDataJSONRaw, context, i, (CreateCredentialResponse) obj, (Throwable) obj2);
                    }
                }));
            } catch (Exception e) {
                FileLog.e(e);
    ...
    public static /* synthetic */ void m3659$r8$lambda$1MjSTZs9CI0K3y07f5XdZkv0jE(final Utilities.Callback2 callback2, String str, final Context context, final int i, CreateCredentialResponse createCredentialResponse, final Throwable th) {
    ...
    public static Runnable login(final Context context, final int i, final boolean z, final Utilities.Callback3<Long, TLRPC.auth_Authorization, String> callback3) {
        ...
        return new Runnable() { // from class: org.telegram.messenger.PasskeysController$$ExternalSyntheticLambda2
            @Override // java.lang.Runnable
            public final void run() {
                PasskeysController.m3661$r8$lambda$r0BjSG3ZEIMsdcfxhA6pR0B2FM(zArr, runnableArr);
            }
        };
    }
    ...
    public static /* synthetic */ void $r8$lambda$3L4sUw_47wNxWVaSQ6GIWRaiOEQ(boolean[] zArr, Utilities.Callback3 callback3, boolean z, CredentialManager credentialManager, Context context, int i, Runnable[] runnableArr, TL_account.passkeyLoginOptions passkeyloginoptions, TLRPC.TL_error tL_error) {
        ...
        try {
            ...
            try {
                ...
                credentialManager.getCredentialAsync(context, getCredentialRequestBuild, cancellationSignal, context.getMainExecutor(), new AnonymousClass1(strGenerateClientDataJSONRaw, callback3, context, i));
    ...
    /* JADX INFO: renamed from: org.telegram.messenger.PasskeysController$1, reason: invalid class name */
    class AnonymousClass1 implements CredentialManagerCallback {
        ...
        AnonymousClass1(String str, Utilities.Callback3 callback3, Context context, int i) {
    ...
    public static /* synthetic */ void m3661$r8$lambda$r0BjSG3ZEIMsdcfxhA6pR0B2FM(boolean[] zArr, Runnable[] runnableArr) {
        zArr[0] = true;
