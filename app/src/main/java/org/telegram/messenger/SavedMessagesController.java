...
public class SavedMessagesController {
    ...
    private void updateAllDialogs(boolean z) {
        ...
        Collections.sort(arrayList, new Comparator() { // from class: org.telegram.messenger.SavedMessagesController$$ExternalSyntheticLambda6
            ...
            public final int compare(Object obj, Object obj2) {
                return SavedMessagesController.m3680$r8$lambda$xwdCB6KxU3Pc46Gnb89goEExbg((SavedMessagesController.SavedDialog) obj, (SavedMessagesController.SavedDialog) obj2);
            }
        });
    ...
    public static /* synthetic */ int m3680$r8$lambda$xwdCB6KxU3Pc46Gnb89goEExbg(SavedDialog savedDialog, SavedDialog savedDialog2) {
        ...
        if (!TextUtils.isEmpty(str)) {
            ...
            for (int i = 0; i < this.allDialogs.size(); i++) {
                ...
                if (j == UserObject.ANONYMOUS) {
                    ...
                    userName = chat != null ? chat.title : _UrlKt.FRAGMENT_ENCODE_SET;
                }
                if (userName != null) {
    ...
    public /* synthetic */ void lambda$loadDialogs$2(TLObject tLObject, ArrayList arrayList, TLRPC.TL_error tL_error) {
        ...
        if (tLObject instanceof TLRPC.TL_messages_savedDialogs) {
            ...
            for (int i = 0; i < tL_messages_savedDialogs.dialogs.size(); i++) {
                ...
                for (int i2 = 0; i2 < this.cachedDialogs.size(); i2++) {
                ...
                while (true) {
                    ...
                    if (this.loadedDialogs.get(i3).dialogId == savedDialogFromTL.dialogId) {
                        break;
                    } else {
                        i3++;
                    }
            ...
            for (int i4 = 0; i4 < tL_messages_savedDialogsSlice.dialogs.size(); i4++) {
                ...
                for (int i5 = 0; i5 < this.cachedDialogs.size(); i5++) {
                ...
                while (true) {
                    ...
                    if (this.loadedDialogs.get(i6).dialogId == savedDialogFromTL2.dialogId) {
                        break;
                    } else {
                        i6++;
                    }
    ...
    private boolean updatePinnedOrder(ArrayList<SavedDialog> arrayList, ArrayList<Long> arrayList2) {
        ...
        Collections.sort(arrayList, new Comparator() { // from class: org.telegram.messenger.SavedMessagesController$$ExternalSyntheticLambda13
            @Override // java.util.Comparator
            public final int compare(Object obj, Object obj2) {
                return SavedMessagesController.m3676$r8$lambda$GSvuyxOt3q15EK34jiI6LY10MA((SavedMessagesController.SavedDialog) obj, (SavedMessagesController.SavedDialog) obj2);
            }
        });
    ...
    public static /* synthetic */ int m3676$r8$lambda$GSvuyxOt3q15EK34jiI6LY10MA(SavedDialog savedDialog, SavedDialog savedDialog2) {
        return savedDialog2.getDate() - savedDialog.getDate();
    }
    ...
    /*  JADX ERROR: Type inference failed
        jadx.core.utils.exceptions.JadxOverflowException: Type inference error: updates count limit reached with updateSeq = 4681. Try increasing type updates limit count.
        	at jadx.core.utils.ErrorsCounter.addError(ErrorsCounter.java:59)
        	at jadx.core.utils.ErrorsCounter.error(ErrorsCounter.java:31)
        	at jadx.core.dex.attributes.nodes.NotificationAttrNode.addError(NotificationAttrNode.java:19)
        	at jadx.core.dex.visitors.typeinference.TypeInferenceVisitor.visit(TypeInferenceVisitor.java:79)
        */
    public /* synthetic */ void lambda$loadCache$7(org.telegram.messenger.MessagesStorage r36, long r37, java.lang.Runnable r39) {
        /*
    ...
    public static class SavedDialog {
        ...
        /* JADX INFO: renamed from: -$$Nest$fgetpinnedOrder, reason: not valid java name */
        static /* bridge */ /* synthetic */ int m3681$$Nest$fgetpinnedOrder(SavedDialog savedDialog) {
            return savedDialog.pinnedOrder;
        }

        /* JADX INFO: renamed from: -$$Nest$fputlocalDate, reason: not valid java name */
        static /* bridge */ /* synthetic */ void m3682$$Nest$fputlocalDate(SavedDialog savedDialog, int i) {
            savedDialog.localDate = i;
        }

        /* JADX INFO: renamed from: -$$Nest$fputpinnedOrder, reason: not valid java name */
        static /* bridge */ /* synthetic */ void m3683$$Nest$fputpinnedOrder(SavedDialog savedDialog, int i) {
            savedDialog.pinnedOrder = i;
        }
