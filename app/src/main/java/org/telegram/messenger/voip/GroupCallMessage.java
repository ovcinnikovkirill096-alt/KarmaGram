...
public class GroupCallMessage {
    ...
    public GroupCallMessage(int i, long j, long j2, TLRPC.TL_textWithEntities tL_textWithEntities) {
        ...
        ArrayList arrayList = tL_textWithEntities.entities;
        if (arrayList == null || arrayList.size() != 1) {
            j3 = 0;
        } else {
            TLRPC.MessageEntity messageEntity = (TLRPC.MessageEntity) tL_textWithEntities.entities.get(0);
        ...
        if (j3 != 0) {
            ...
            ArrayList arrayList2 = tL_textWithEntities.entities;
