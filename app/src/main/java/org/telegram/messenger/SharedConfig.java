...
public class SharedConfig {
    ...
    /* JADX INFO: renamed from: $r8$lambda$AgzM-nIFjDK3Boj0GV34UBf8Qd8, reason: not valid java name */
    public static /* synthetic */ void m3757$r8$lambda$AgzMnIFjDK3Boj0GV34UBf8Qd8(AlertDialog alertDialog, int i) {
    }

    /* JADX INFO: renamed from: $r8$lambda$c1nolnMM8hkF5gEowxjTAWjtK-M, reason: not valid java name */
    public static /* synthetic */ void m3758$r8$lambda$c1nolnMM8hkF5gEowxjTAWjtKM() {
    }
    ...
    public static /* synthetic */ void $r8$lambda$5WZZbls8uHKhzrNqXgCrVdV5Lyk() {
        ...
        ImageLoader.getInstance().checkMediaPaths(new Runnable() { // from class: org.telegram.messenger.SharedConfig$$ExternalSyntheticLambda3
            @Override // java.lang.Runnable
            public final void run() {
                SharedConfig.m3758$r8$lambda$c1nolnMM8hkF5gEowxjTAWjtKM();
            }
        });
        ...
        builder.setPositiveButton(LocaleController.getString(R.string.DoNotUseSDCard), new AlertDialog.OnButtonClickListener() { // from class: org.telegram.messenger.SharedConfig$$ExternalSyntheticLambda4
            @Override // org.telegram.ui.ActionBar.AlertDialog.OnButtonClickListener
            public final void onClick(AlertDialog alertDialog, int i) {
                SharedConfig.m3757$r8$lambda$AgzMnIFjDK3Boj0GV34UBf8Qd8(alertDialog, i);
            }
        });
            ...
            try {
                if (!configLoaded && ApplicationLoader.applicationContext != null) {
                    ...
                    try {
                        ...
                        TLRPC.TL_help_appUpdate tL_help_appUpdate = pendingAppUpdate;
                        if (tL_help_appUpdate != null && (pendingAppUpdateBuildVersion != 6580 || (str = tL_help_appUpdate.version) == null || BuildConfig.AYU_VERSION.compareTo(str) >= 0 || BuildVars.DEBUG_PRIVATE_VERSION)) {
    ...
    public static boolean isAppUpdateAvailable() {
        TLRPC.TL_help_appUpdate tL_help_appUpdate = pendingAppUpdate;
        return (tL_help_appUpdate == null || tL_help_appUpdate.document == null || pendingAppUpdateBuildVersion != 6580) ? false : true;
    }
    ...
    public static void saveProxyList() {
        ...
        Collections.sort(arrayList, new Comparator() { // from class: org.telegram.messenger.SharedConfig$$ExternalSyntheticLambda2
            ...
            public final int compare(Object obj, Object obj2) {
                return SharedConfig.m3756$r8$lambda$3gtbUfC6wnjRm8ZleoIGK_ytoQ((SharedConfig.ProxyInfo) obj, (SharedConfig.ProxyInfo) obj2);
            }
        });
    ...
    /* JADX INFO: renamed from: $r8$lambda$3gtbUfC6wnjRm8-ZleoIGK_ytoQ, reason: not valid java name */
    public static /* synthetic */ int m3756$r8$lambda$3gtbUfC6wnjRm8ZleoIGK_ytoQ(ProxyInfo proxyInfo, ProxyInfo proxyInfo2) {
    ...
    public static int measureDevicePerformanceClass() {
        ...
        if (i3 <= 2 || memoryClass <= 100 || ((i3 <= 4 && iCeil != -1 && iCeil <= 1250) || ((i3 <= 4 && iCeil <= 1300 && memoryClass <= 128 && i2 <= 24) || (j != -1 && j < 2147483648L)))) {
            i = 0;
