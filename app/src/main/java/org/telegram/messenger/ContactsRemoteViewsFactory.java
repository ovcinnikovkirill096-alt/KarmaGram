        ...
        while (i3 < 2) {
            ...
            if (i4 >= this.dids.size()) {
                ...
                if (dialog != null && (i2 = dialog.unread_count) > 0) {
                    remoteViews3.setTextViewText(i3 == 0 ? R.id.contacts_widget_item_badge1 : R.id.contacts_widget_item_badge2, i2 > 99 ? String.format("%d+", 99) : String.format(TimeModel.NUMBER_FORMAT, Integer.valueOf(i2)));
