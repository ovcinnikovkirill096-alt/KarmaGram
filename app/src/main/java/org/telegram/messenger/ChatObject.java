    ...
    public static class Call {
        ...
        public void processVoiceLevelsUpdate(int[] iArr, float[] fArr, boolean[] zArr) {
            ...
            while (i < iArr.length) {
                ...
                if (groupCallParticipant != null) {
                    boolean z6 = zArr[i];
                    groupCallParticipant.hasVoice = z6;
                    z = z5;
                    if (z6 || jElapsedRealtime - groupCallParticipant.lastVoiceUpdateTime > 500) {
                        groupCallParticipant.hasVoiceDelayed = z6;
            ...
            if (z8) {
                ...
                int i3 = NotificationCenter.groupCallUpdated;
                Long lValueOf = Long.valueOf(this.chatId);
                Long lValueOf2 = Long.valueOf(this.call.id);
                Object[] objArr = new Object[3];
                objArr[0] = lValueOf;
                objArr[z7 ? 1 : 0] = lValueOf2;
            ...
            if (z9) {
                ...
                int i4 = NotificationCenter.groupCallSpeakingUsersUpdated;
                Long lValueOf3 = Long.valueOf(this.chatId);
                Long lValueOf4 = Long.valueOf(this.call.id);
                Object[] objArr2 = new Object[3];
                objArr2[0] = lValueOf3;
                objArr2[z7 ? 1 : 0] = lValueOf4;
                objArr2[2] = Boolean.FALSE;
                notificationCenter2.lambda$postNotificationNameOnUIThread$1(i4, objArr2);
            }
        }
        ...
        public void processParticipantsUpdate(TLRPC.TL_updateGroupCallParticipants tL_updateGroupCallParticipants, boolean z) {
            ...
            while (i3 < size2) {
                ...
                if (groupCallParticipant.left) {
                    ...
                    if (groupCallParticipant2 != null) {
                        ...
                        if (groupCallParticipant2.raise_hand_rating == j4 && groupCallParticipant.raise_hand_rating != j4) {
                        ...
                        if (groupCallParticipant2.source != groupCallParticipant.source || !isSameVideo(groupCallParticipant2.video, groupCallParticipant.video) || !isSameVideo(groupCallParticipant2.presentation, groupCallParticipant.presentation)) {
                            ...
                            processAllSources(groupCallParticipant2, z3);
                        ...
                        if (groupCallParticipant.raise_hand_rating != j4) {
            ...
            if (z5) {
                ...
                this.currentAccount.getNotificationCenter().lambda$postNotificationNameOnUIThread$1(NotificationCenter.groupCallUpdated, Long.valueOf(this.chatId), Long.valueOf(this.call.id), Boolean.valueOf(z8), Long.valueOf(j3));
            }
            if (z7) {
