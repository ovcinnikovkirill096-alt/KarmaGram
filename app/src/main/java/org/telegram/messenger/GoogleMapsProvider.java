...
public class GoogleMapsProvider implements IMapsProvider {
    ...
    public static final class GoogleMapImpl implements IMapsProvider.IMap {
        ...
        public void setOnCameraMoveStartedListener(final IMapsProvider.OnCameraMoveStartedListener onCameraMoveStartedListener) {
            this.googleMap.setOnCameraMoveStartedListener(new GoogleMap.OnCameraMoveStartedListener() { // from class: org.telegram.messenger.GoogleMapsProvider$GoogleMapImpl$$ExternalSyntheticLambda5
                ...
                public final void onCameraMoveStarted(int i) {
                    GoogleMapsProvider.GoogleMapImpl.m2980$r8$lambda$r9kkoqpW97OxjoEF5_g6CEGB9s(onCameraMoveStartedListener, i);
                }
            });
        }

        /* JADX INFO: renamed from: $r8$lambda$r9-kkoqpW97OxjoEF5_g6CEGB9s, reason: not valid java name */
        public static /* synthetic */ void m2980$r8$lambda$r9kkoqpW97OxjoEF5_g6CEGB9s(IMapsProvider.OnCameraMoveStartedListener onCameraMoveStartedListener, int i) {
            int i2 = 2;
            if (i != 2) {
                i2 = 3;
                if (i != 3) {
        ...
        public IMapsProvider.IMap.Padding getFragmentPadding(int i) {
            return new IMapsProvider.IMap.Padding(AndroidUtilities.dp(70.0f), 0, AndroidUtilities.dp(70.0f), i);
        }
    ...
    public static final class GoogleMapView implements IMapsProvider.IMapView {
        ...
        /* JADX INFO: renamed from: org.telegram.messenger.GoogleMapsProvider$GoogleMapView$1, reason: invalid class name */
