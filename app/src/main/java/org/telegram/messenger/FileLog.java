...
public class FileLog {
            ...
            try {
                ...
                getInstance().logQueue.postRunnable(new Runnable() { // from class: org.telegram.messenger.FileLog$$ExternalSyntheticLambda7
                    ...
                    public final void run() {
                        FileLog.m2913$r8$lambda$TbpBHKbdIrkiw9Ph1QNW6DiAvI(j, j2, i2, i, jCurrentTimeMillis, str, str3, tL_error);
                    }
                });
            } catch (Throwable th) {
                e(th);
    ...
    /* JADX INFO: renamed from: $r8$lambda$TbpBHKbdIrkiw9Ph1QNW-6DiAvI, reason: not valid java name */
    public static /* synthetic */ void m2913$r8$lambda$TbpBHKbdIrkiw9Ph1QNW6DiAvI(long j, long j2, int i, int i2, long j3, String str, String str2, TLRPC.TL_error tL_error) {
        try {
        ...
        if (BuildVars.DEBUG_PRIVATE_VERSION && BuildVars.LOGS_ENABLED && tLObject != null) {
            try {
                ...
                getInstance().logQueue.postRunnable(new Runnable() { // from class: org.telegram.messenger.FileLog$$ExternalSyntheticLambda1
                    @Override // java.lang.Runnable
                    public final void run() {
                        FileLog.m2916$r8$lambda$zqRYPgC_YdSVtSz1dAmPwy_uUw(jCurrentTimeMillis, j, i, string);
                    }
                });
    ...
    /* JADX INFO: renamed from: $r8$lambda$zqRYPgC_YdSVtSz1dAm-Pwy_uUw, reason: not valid java name */
    public static /* synthetic */ void m2916$r8$lambda$zqRYPgC_YdSVtSz1dAmPwy_uUw(long j, long j2, int i, String str) {
        try {
    ...
    private static class TLObjectDeserializer implements JsonSerializer {
        ...
        /* JADX WARN: Code duplicated, block: B:29:0x0076 A[Catch: Exception -> 0x0043, IllegalAccessException -> 0x0074, TRY_LEAVE, TryCatch #0 {IllegalAccessException -> 0x0074, blocks: (B:16:0x0049, B:18:0x004f, B:20:0x005b, B:22:0x0063, B:24:0x006b, B:29:0x0076), top: B:35:0x0049, outer: #1 }] */
        ...
        if (BuildVars.LOGS_ENABLED) {
            ...
            if (getInstance().streamWriter != null) {
                getInstance().logQueue.postRunnable(new Runnable() { // from class: org.telegram.messenger.FileLog$$ExternalSyntheticLambda6
                    @Override // java.lang.Runnable
                    public final void run() {
                        FileLog.m2912$r8$lambda$Cka7Jn8J8_XFnXWLJvFPiIg4A4(th);
                    }
                });
                return;
            }
    ...
    /* JADX INFO: renamed from: $r8$lambda$Cka7Jn8J8_XF-nXWLJvFPiIg4A4, reason: not valid java name */
    public static /* synthetic */ void m2912$r8$lambda$Cka7Jn8J8_XFnXWLJvFPiIg4A4(Throwable th) {
        try {
        ...
        if (BuildVars.LOGS_ENABLED) {
            ...
            if (getInstance().streamWriter != null) {
                getInstance().logQueue.postRunnable(new Runnable() { // from class: org.telegram.messenger.FileLog$$ExternalSyntheticLambda8
                    @Override // java.lang.Runnable
                    public final void run() {
                        FileLog.m2915$r8$lambda$bYZ1YvZDkuzSWHS46PDhtH0hTE(str);
                    }
                });
            }
        }
    ...
    /* JADX INFO: renamed from: $r8$lambda$bY-Z1YvZDkuzSWHS46PDhtH0hTE, reason: not valid java name */
    public static /* synthetic */ void m2915$r8$lambda$bYZ1YvZDkuzSWHS46PDhtH0hTE(String str) {
        try {
        ...
        if (BuildVars.LOGS_ENABLED) {
            ...
            if (getInstance().streamWriter != null) {
                getInstance().logQueue.postRunnable(new Runnable() { // from class: org.telegram.messenger.FileLog$$ExternalSyntheticLambda2
                    @Override // java.lang.Runnable
                    public final void run() {
                        FileLog.m2914$r8$lambda$W1fml6687f73UJ9cxSD3wMPIB4(str);
                    }
                });
            }
        }
    ...
    /* JADX INFO: renamed from: $r8$lambda$W1fml6687f73UJ9c-xSD3wMPIB4, reason: not valid java name */
    public static /* synthetic */ void m2914$r8$lambda$W1fml6687f73UJ9cxSD3wMPIB4(String str) {
        try {
