...
public class PushListenerController {
    ...
    public static void sendRegistrationToServer(final int i, final String str) {
        Utilities.stageQueue.postRunnable(new Runnable() { // from class: org.telegram.messenger.PushListenerController$$ExternalSyntheticLambda0
            ...
            public final void run() {
                PushListenerController.m3664$r8$lambda$gWkEZv3oxmETvqnhw1v3CFWl4(str, i);
            }
        });
    }

    /* JADX INFO: renamed from: $r8$lambda$gWkEZv3oxmETvqnhw1v-3CF-Wl4, reason: not valid java name */
    public static /* synthetic */ void m3664$r8$lambda$gWkEZv3oxmETvqnhw1v3CFWl4(final String str, final int i) {
        boolean z;
    ...
    /*  JADX ERROR: Type inference failed
        jadx.core.utils.exceptions.JadxOverflowException: Type inference error: updates count limit reached with updateSeq = 103041. Try increasing type updates limit count.
    ...
    public static /* synthetic */ void lambda$processRemoteMessage$6(java.lang.String r70, java.lang.String r71, long r72) {
        /*
            Method dump skipped, instruction units count: 10304
