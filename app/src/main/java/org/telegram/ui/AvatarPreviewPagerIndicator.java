...
public abstract class AvatarPreviewPagerIndicator extends View implements ProfileGalleryView.Callback {
    ...
    /* JADX WARN: Code duplicated, block: B:111:0x02d4 A[DONT_INVERT] */
    /* JADX WARN: Code duplicated, block: B:112:0x02d6  */
    /* JADX WARN: Code duplicated, block: B:114:0x02de  */
    /* JADX WARN: Code duplicated, block: B:157:0x025f A[SYNTHETIC] */
    /* JADX WARN: Code duplicated, block: B:60:0x01c0  */
    /* JADX WARN: Code duplicated, block: B:62:0x01c5  */
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (realCount <= 1 || realCount > 20) {
            ...
            while (i5 < realCount) {
                ...
                if (i5 == this.previousSelectedPotision && Math.abs(this.previousSelectedProgress - 1.0f) > 1.0E-4f) {
                    ...
                    float f8 = iDp2;
                    float f9 = iDp;
                    float f10 = iDp2 + measuredWidth;
                    canvas.clipRect((measuredWidth * currentItemProgress) + f8, f9, f10, iDp + AndroidUtilities.dp(2.0f));
                    ...
                    if (i5 == this.selectedPosition) {
                        if (this.profileGalleryView.isCurrentItemVideo()) {
                            ...
                            if ((currentItemProgress <= f11 && this.profileGalleryView.isLoadingCurrentVideo()) || this.currentLoadingAnimationProgress > f11) {
                                float f12 = this.currentLoadingAnimationProgress;
                                int i6 = this.currentLoadingAnimationDirection;
                                float f13 = f12 + ((((long) i6) * j) / 500.0f);
                                this.currentLoadingAnimationProgress = f13;
                                if (f13 > 1.0f) {
                                    this.currentLoadingAnimationProgress = 1.0f;
                                    this.currentLoadingAnimationDirection = i6 * (-1);
                                } else if (f13 <= f11) {
                                    this.currentLoadingAnimationProgress = f11;
                                    this.currentLoadingAnimationDirection = i6 * (-1);
                                }
                            }
                    ...
                    float f14 = iDp2;
                    this.rect.set(f14, iDp, (measuredWidth * currentItemProgress) + f14, AndroidUtilities.dp(2.0f) + iDp);
                    if (i5 != this.selectedPosition) {
                ...
                z = true;
                float f15 = iDp2;
                this.rect.set(f15, iDp, (measuredWidth * currentItemProgress) + f15, AndroidUtilities.dp(2.0f) + iDp);
                if (i5 != this.selectedPosition) {
                    if (this.overlayCountVisible == 3) {
                        this.barPaint.setAlpha((int) (AndroidUtilities.lerp(i2, 255, CubicBezierInterpolator.EASE_BOTH.getInterpolation(this.alphas[i5])) * this.alpha));
                    }
        ...
        if (realCount > i || this.progressToCounter != 0.0f) {
            ...
            this.indicatorRect.right = getMeasuredWidth() - AndroidUtilities.dp(f2);
            RectF rectF3 = this.indicatorRect;
            rectF3.left = rectF3.right - (fMeasureText + AndroidUtilities.dpf2(16.0f));
            this.indicatorRect.top = AndroidUtilities.dp(f2);
            ...
            if (z2) {
                ...
                if (f20 != 1.0f) {
                    this.progressToCounter = f20 + (j / 150.0f);
                } else if (!z2) {
                    f4 = this.progressToCounter;
                    if (f4 != 0.0f) {
                        this.progressToCounter = f4 - (j / 150.0f);
                    }
                }
            } else if (!z2) {
                f4 = this.progressToCounter;
            ...
            float f21 = this.progressToCounter;
            if (f21 >= 1.0f) {
            ...
            float f22 = this.progressToCounter;
            canvas.scale(f22, f22, this.indicatorRect.centerX(), this.indicatorRect.centerY());
