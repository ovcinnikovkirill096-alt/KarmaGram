...
public class ResaleGiftsFragment extends BaseFragment {
    ...
    public /* synthetic */ void lambda$createView$18(Context context, View view) {
        if (this.filtersShown && !this.list.backdropAttributes.isEmpty()) {
            ...
            itemOptionsNeedsFocus.setOnDismiss(new Runnable() { // from class: org.telegram.ui.Gifts.ResaleGiftsFragment$$ExternalSyntheticLambda21
                @Override // java.lang.Runnable
                public final void run() {
                    ResaleGiftsFragment.m13266$r8$lambda$D93_wbZHqkNCsXvE1ZB9VZJVY(itemOptionsNeedsFocus);
                }
            });
            final String[] strArr = {_UrlKt.FRAGMENT_ENCODE_SET};
    ...
    public static /* synthetic */ void m13266$r8$lambda$D93_wbZHqkNCsXvE1ZB9VZJVY(ItemOptions itemOptions) {
        ActionBarPopupWindow actionBarPopupWindow = itemOptions.actionBarPopupWindow;
        if (actionBarPopupWindow != null) {
            AndroidUtilities.hideKeyboard(actionBarPopupWindow.getContentView());
        }
    ...
    public static class SelectGiftSheet extends BottomSheetWithRecyclerListView {
        ...
        public /* synthetic */ void lambda$new$9(final State state, Context context, View view) {
            ...
            itemOptionsNeedsFocus.setOnDismiss(new Runnable() { // from class: org.telegram.ui.Gifts.ResaleGiftsFragment$SelectGiftSheet$$ExternalSyntheticLambda9
                @Override // java.lang.Runnable
                public final void run() {
                    ResaleGiftsFragment.SelectGiftSheet.m13294$r8$lambda$vvs1yz87O9ZsTYBNb8sIhiSnlk(itemOptionsNeedsFocus);
                }
            });
            final String[] strArr = {_UrlKt.FRAGMENT_ENCODE_SET};
            ...
            Collections.sort(arrayList, new Comparator() { // from class: org.telegram.ui.Gifts.ResaleGiftsFragment$SelectGiftSheet$$ExternalSyntheticLambda10
                @Override // java.util.Comparator
                public final int compare(Object obj, Object obj2) {
                    return ResaleGiftsFragment.SelectGiftSheet.m13293$r8$lambda$sn7TqtNUbVqBdAJIr3uNpOA5Lc(state, (TL_stars.starGiftAttributeModel) obj, (TL_stars.starGiftAttributeModel) obj2);
                }
            });
            final UniversalRecyclerView universalRecyclerView = new UniversalRecyclerView(context, this.currentAccount, 0, new Utilities.Callback2() { // from class: org.telegram.ui.Gifts.ResaleGiftsFragment$SelectGiftSheet$$ExternalSyntheticLambda11
                @Override // org.telegram.messenger.Utilities.Callback2
                public final void run(Object obj, Object obj2) {
                    ResaleGiftsFragment.SelectGiftSheet.m13289$r8$lambda$NuNOn8c9I0mZIx6PGm5NVujes(strArr, state, arrayList, (ArrayList) obj, (UniversalAdapter) obj2);
                }
            ...
            if (!state.resaleList.notSelectedModelAttributes.isEmpty()) {
                itemOptionsNeedsFocus.add(R.drawable.msg_select, LocaleController.getString(R.string.SelectAll), new Runnable() { // from class: org.telegram.ui.Gifts.ResaleGiftsFragment$SelectGiftSheet$$ExternalSyntheticLambda13
                    @Override // java.lang.Runnable
                    public final void run() {
                        ResaleGiftsFragment.SelectGiftSheet.m13291$r8$lambda$qn1VK4C6vWIgv_OkTc9loxTwE8(state);
                    }
                });
            }
            itemOptionsNeedsFocus.addView(universalRecyclerView);
        ...
        public static /* synthetic */ void m13294$r8$lambda$vvs1yz87O9ZsTYBNb8sIhiSnlk(ItemOptions itemOptions) {
            ActionBarPopupWindow actionBarPopupWindow = itemOptions.actionBarPopupWindow;
            if (actionBarPopupWindow != null) {
                AndroidUtilities.hideKeyboard(actionBarPopupWindow.getContentView());
            }
        ...
        public static /* synthetic */ int m13293$r8$lambda$sn7TqtNUbVqBdAJIr3uNpOA5Lc(State state, TL_stars.starGiftAttributeModel stargiftattributemodel, TL_stars.starGiftAttributeModel stargiftattributemodel2) {
        ...
        public static /* synthetic */ void m13289$r8$lambda$NuNOn8c9I0mZIx6PGm5NVujes(String[] strArr, State state, ArrayList arrayList, ArrayList arrayList2, UniversalAdapter universalAdapter) {
            String lowerCase = strArr[0].toLowerCase();
            String strTranslitSafe = AndroidUtilities.translitSafe(lowerCase);
        ...
        public static /* synthetic */ void m13291$r8$lambda$qn1VK4C6vWIgv_OkTc9loxTwE8(State state) {
            if (state.resaleList.notSelectedModelAttributes.isEmpty()) {
                return;
            }
        ...
        public /* synthetic */ void lambda$new$21(final State state, Context context, View view) {
            ...
            Collections.sort(arrayList, new Comparator() { // from class: org.telegram.ui.Gifts.ResaleGiftsFragment$SelectGiftSheet$$ExternalSyntheticLambda21
                @Override // java.util.Comparator
                public final int compare(Object obj, Object obj2) {
                    return ResaleGiftsFragment.SelectGiftSheet.m13288$r8$lambda$LLe_j3FNzfJQk9PFnQJUW5zUc(state, (TL_stars.starGiftAttributePattern) obj, (TL_stars.starGiftAttributePattern) obj2);
                }
            });
        ...
        public static /* synthetic */ int m13288$r8$lambda$LLe_j3FNzfJQk9PFnQJUW5zUc(State state, TL_stars.starGiftAttributePattern stargiftattributepattern, TL_stars.starGiftAttributePattern stargiftattributepattern2) {
