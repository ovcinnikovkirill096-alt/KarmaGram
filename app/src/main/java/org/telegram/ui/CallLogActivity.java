...
public class CallLogActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate, MainTabsActivity.TabFragmentDelegate {
    ...
    class EmptyTextProgressView extends FrameLayout {
        ...
        public EmptyTextProgressView(Context context, View view) {
            ...
            setOnTouchListener(new View.OnTouchListener() { // from class: org.telegram.ui.CallLogActivity$EmptyTextProgressView$$ExternalSyntheticLambda1
                ...
                public final boolean onTouch(View view2, MotionEvent motionEvent) {
                    return CallLogActivity.EmptyTextProgressView.m5358$r8$lambda$r2yXPcVr5CyXIjl7raCNSCXp8(view2, motionEvent);
                }
            });
        }
        ...
        public static /* synthetic */ boolean m5358$r8$lambda$r2yXPcVr5CyXIjl7raCNSCXp8(View view, MotionEvent motionEvent) {
            return true;
        }
    ...
    public void didReceivedNotification(int i, int i2, Object... objArr) {
            ...
            if (callLogActivity.firstLoaded && !((Boolean) objArr[2]).booleanValue()) {
                ...
                while (i4 < size) {
                    ...
                    if (messageAction instanceof TLRPC.TL_messageActionPhoneCall) {
                        ...
                        boolean z2 = fromChatId == callLogActivity.getUserConfig().getClientUserId() ? false : z;
                        TLRPC.PhoneCallDiscardReason phoneCallDiscardReason = messageObject.messageOwner.action.reason;
                        ?? r9 = z2;
                        if (z2 == z && ((phoneCallDiscardReason instanceof TLRPC.TL_phoneCallDiscardReasonMissed) || (phoneCallDiscardReason instanceof TLRPC.TL_phoneCallDiscardReasonBusy))) {
                            r9 = z2;
                            r9 = 2;
                        }
                        if (r9 != 0 || (!(phoneCallDiscardReason instanceof TLRPC.TL_phoneCallDiscardReasonMissed) && !(phoneCallDiscardReason instanceof TLRPC.TL_phoneCallDiscardReasonBusy))) {
                            r11 = r9;
                        }
                        if (!callLogActivity.calls.isEmpty()) {
                            CallLogRow callLogRow2 = (CallLogRow) callLogActivity.calls.get(0);
                            if (eq(j, callLogRow2.users) && callLogRow2.type == r11) {
                        ...
                        TLRPC.User user = callLogActivity.getMessagesController().getUser(Long.valueOf(j));
                        if (user != null) {
                            callLogRow3.users.add(user);
                        }
                        callLogRow3.type = r11;
                        ...
                        if (messageAction instanceof TLRPC.TL_messageActionConferenceCall) {
                            ...
                            Set<Long> set = (Set) Collection.EL.stream(tL_messageActionConferenceCall.other_participants).map(new CallLogActivity$$ExternalSyntheticLambda13()).collect(Collectors.toSet());
                            ...
                            ?? r12 = fromChatId2 == callLogActivity.getUserConfig().getClientUserId() ? 0 : z;
                            if (r12 == z && tL_messageActionConferenceCall.missed) {
                                r12 = 2;
                            }
                            ?? r13 = (r12 == 0 && tL_messageActionConferenceCall.missed) ? 3 : r12;
                            if (!callLogActivity.calls.isEmpty()) {
                                int i5 = 0;
                                while (true) {
                                    if (i5 >= callLogActivity.calls.size()) {
                                        callLogRow = null;
                                        break;
                                    }
                                    callLogRow = (CallLogRow) callLogActivity.calls.get(i5);
                            ...
                            for (Long l3 : set) {
                                l3.longValue();
                                TLRPC.User user3 = callLogActivity.getMessagesController().getUser(l3);
                                if (user3 != null) {
                                    callLogRow4.users.add(user3);
                                }
                            }
                            callLogRow4.type = r13;
                            callLogRow4.video = messageObject.isVideoCall();
                            callLogActivity.calls.add(0, callLogRow4);
                            callLogActivity.listView.adapter.update(true);
                        }
                        z = true;
                    }
                ...
                if (actionBarMenuItem != null) {
                    if (callLogActivity.calls.isEmpty() && !callLogActivity.getUserConfig().showCallsTab) {
                        i3 = 8;
                    }
        ...
        if (i == NotificationCenter.chatInfoDidLoad) {
            ...
            VoIPHelper.startCall(callLogActivity.lastCallChat, (TLRPC.InputPeer) null, (String) null, false, callLogActivity.getParentActivity(), (BaseFragment) callLogActivity, callLogActivity.getAccountInstance());
    ...
    public View createView(Context context) {
        ...
        Bulletin.addDelegate(this, new Bulletin.Delegate() { // from class: org.telegram.ui.CallLogActivity.5
            ...
            public void onBottomOffsetChange(float f) {
                ...
                callLogActivity.additionalFloatingTranslation = Math.max(0.0f, (f - callLogActivity.navigationBarHeight) - CallLogActivity.this.additionFloatingButtonOffset);
                CallLogActivity.this.checkUi_floatingButton();
            }
    ...
    /* JADX INFO: renamed from: org.telegram.ui.CallLogActivity$3, reason: invalid class name */
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* JADX WARN: Code duplicated, block: B:150:0x012f A[SYNTHETIC] */
    /* JADX WARN: Code duplicated, block: B:151:0x0139 A[SYNTHETIC] */
    /* JADX WARN: Code duplicated, block: B:154:0x0107 A[EDGE_INSN: B:154:0x0107->B:152:0x0107 BREAK  A[LOOP:2: B:54:0x011e->B:156:?], SYNTHETIC] */
    ...
    public /* synthetic */ void lambda$getCalls$20(TLRPC.TL_error tL_error, TLObject tLObject) {
        boolean z;
        CallLogRow callLogRow;
        ...
        if (tL_error == null) {
            ...
            if (this.calls.isEmpty()) {
                ...
                ArrayList arrayList2 = this.calls;
                callLogRow = (CallLogRow) arrayList2.get(arrayList2.size() - 1);
            }
            int i6 = 0;
            while (i6 < messages_messages2.messages.size()) {
                ...
                if (messageAction2 == null || (messageAction2 instanceof TLRPC.TL_messageActionHistoryClear)) {
                    ...
                    int i7 = MessageObject.getFromChatId(message) == getUserConfig().getClientUserId() ? 0 : i5;
                    ...
                    if (messageAction3 instanceof TLRPC.TL_messageActionConferenceCall) {
                        ...
                        hashSet.addAll((java.util.Collection) Collection.EL.stream(tL_messageActionConferenceCall.other_participants).map(new CallLogActivity$$ExternalSyntheticLambda13()).collect(Collectors.toSet()));
                        if (i7 == i5 && tL_messageActionConferenceCall.missed) {
                            i7 = 2;
                        }
                        int i8 = (i7 == 0 && tL_messageActionConferenceCall.missed) ? 3 : i7;
                        messages_messages = messages_messages2;
                        if (callLogRow != null) {
                            i2 = i8;
                            if (callLogRow.call_id == tL_messageActionConferenceCall.call_id) {
                            ...
                            if (callLogRow2 != null) {
                                ...
                                for (Long l2 : hashSet) {
                                    l2.longValue();
                                    if (!Collection.EL.stream(callLogRow.users).noneMatch(new Predicate() { // from class: org.telegram.ui.CallLogActivity$$ExternalSyntheticLambda27
                        ...
                        int i9 = 0;
                        while (true) {
                            if (i9 >= this.calls.size()) {
                                i = i6;
                                callLogRow2 = null;
                                break;
                            }
                            callLogRow2 = (CallLogRow) this.calls.get(i9);
                            i = i6;
                        ...
                        if (i7 == 1 && ((phoneCallDiscardReason instanceof TLRPC.TL_phoneCallDiscardReasonMissed) || (phoneCallDiscardReason instanceof TLRPC.TL_phoneCallDiscardReasonBusy))) {
                            i7 = 2;
                        }
                        int i10 = (i7 == 0 && ((phoneCallDiscardReason instanceof TLRPC.TL_phoneCallDiscardReasonMissed) || (phoneCallDiscardReason instanceof TLRPC.TL_phoneCallDiscardReasonBusy))) ? 3 : i7;
                        if (callLogRow == null || !eq(hashSet, callLogRow.users) || callLogRow.type != i10) {
                            if (callLogRow != null && !this.calls.contains(callLogRow)) {
                                this.calls.add(callLogRow);
                            }
                            callLogRow = new CallLogRow();
            ...
            if (callLogRow != null && !callLogRow.calls.isEmpty() && !this.calls.contains(callLogRow)) {
                this.calls.add(callLogRow);
            }
            z = true;
        } else {
        ...
        if (this.calls.isEmpty() && !getUserConfig().showCallsTab) {
            i4 = 8;
        }
    ...
    public static void showCallLinkSheet(final Context context, int i, final TLRPC.InputGroupCall inputGroupCall, final String str, final Theme.ResourcesProvider resourcesProvider, boolean z, final boolean z2) {
        ...
        buttonWithCounterView.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.CallLogActivity$$ExternalSyntheticLambda43
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                CallLogActivity.m5312$r8$lambda$1EFOwZ77UqkTcqErUyM45xhGTk(strArr, bottomSheetShow, resourcesProvider, view);
            }
        });
        final Runnable runnable2 = new Runnable() { // from class: org.telegram.ui.CallLogActivity$$ExternalSyntheticLambda44
            @Override // java.lang.Runnable
            public final void run() {
                CallLogActivity.m5314$r8$lambda$2prmdrrmAf0kUoNk0dOqcJaAs(inputGroupCall, i2, strArr, frameLayout3, linksTextViewMakeLinkTextView3, bottomSheetShow, resourcesProvider);
            }
        };
        imageView3.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.CallLogActivity$$ExternalSyntheticLambda45
            ...
            public final void onClick(View view) {
                ...
                ItemOptions.makeOptions(bottomSheet.container, resourcesProvider2, frameLayout4).add(R.drawable.msg_copy, LocaleController.getString(R.string.Copy), new Runnable() { // from class: org.telegram.ui.CallLogActivity$$ExternalSyntheticLambda49
                    ...
                    @Override // java.lang.Runnable
                    public final void run() {
                        CallLogActivity.m5324$r8$lambda$ofizaQ8fz8pIkZ0CmoIzuZ1WxU(context, strArr2);
                    }
        ...
        ConnectionsManager.getInstance(i).sendRequest(exportgroupcallinvite, new RequestDelegate() { // from class: org.telegram.ui.CallLogActivity$$ExternalSyntheticLambda51
            ...
            public final void run(TLObject tLObject2, TLRPC.TL_error tL_error2) {
                AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.CallLogActivity$$ExternalSyntheticLambda0
                    @Override // java.lang.Runnable
                    public final void run() {
                        CallLogActivity.m5318$r8$lambda$XP3zZ7XrhNj3c7Y0VBP453XMXs(tLObject2, strArr, frameLayout, linksTextView, bottomSheet, resourcesProvider);
                    }
                });
            }
        });
    ...
    public static /* synthetic */ void m5318$r8$lambda$XP3zZ7XrhNj3c7Y0VBP453XMXs(TLObject tLObject, String[] strArr, final FrameLayout frameLayout, final LinkSpanDrawable.LinksTextView linksTextView, BottomSheet bottomSheet, Theme.ResourcesProvider resourcesProvider) {
    ...
    public static /* synthetic */ void m5324$r8$lambda$ofizaQ8fz8pIkZ0CmoIzuZ1WxU(Context context, String[] strArr) {
    ...
    /* JADX INFO: renamed from: org.telegram.ui.CallLogActivity$9, reason: invalid class name */
        ...
        ConnectionsManager.getInstance(i).sendRequest(createconferencecall, new RequestDelegate() { // from class: org.telegram.ui.CallLogActivity$$ExternalSyntheticLambda30
            ...
            public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
                AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.CallLogActivity$$ExternalSyntheticLambda33
                    @Override // java.lang.Runnable
                    public final void run() {
                        CallLogActivity.m5322$r8$lambda$gyhVDjUE7ARRTUf1l96t6off0(tLObject, i, alertDialog, context, resourcesProvider, runnable);
                    }
                });
            }
        });
    ...
    public static /* synthetic */ void m5322$r8$lambda$gyhVDjUE7ARRTUf1l96t6off0(TLObject tLObject, final int i, final AlertDialog alertDialog, final Context context, final Theme.ResourcesProvider resourcesProvider, final Runnable runnable) {
        int i2 = 0;
        if (tLObject instanceof TLRPC.Updates) {
            TLRPC.Updates updates = (TLRPC.Updates) tLObject;
            ...
            ConnectionsManager.getInstance(i).sendRequest(exportgroupcallinvite, new RequestDelegate() { // from class: org.telegram.ui.CallLogActivity$$ExternalSyntheticLambda38
                ...
                public final void run(TLObject tLObject2, TLRPC.TL_error tL_error) {
                    AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.CallLogActivity$$ExternalSyntheticLambda39
                        @Override // java.lang.Runnable
                        public final void run() {
                            CallLogActivity.m5323$r8$lambda$k3EfdJ6Yoam0W237sh_2inFJEA(tLObject2, alertDialog, context, i, exportgroupcallinvite, resourcesProvider, runnable);
                        }
                    });
                }
            });
    ...
    public static /* synthetic */ void m5323$r8$lambda$k3EfdJ6Yoam0W237sh_2inFJEA(TLObject tLObject, AlertDialog alertDialog, Context context, int i, TL_phone.exportGroupCallInvite exportgroupcallinvite, Theme.ResourcesProvider resourcesProvider, Runnable runnable) {
        if (tLObject instanceof TL_phone.exportedGroupCallInvite) {
            alertDialog.dismiss();
    ...
    private void showItemOptions() {
        ...
        itemOptionsMakeOptions.addIf(getUserConfig().showCallsTab, R.drawable.msg_archive_hide, LocaleController.getString(R.string.HideCallTab), new Runnable() { // from class: org.telegram.ui.CallLogActivity$$ExternalSyntheticLambda15
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.lambda$showItemOptions$42();
            }
        });
        itemOptionsMakeOptions.addIf(!this.calls.isEmpty(), R.drawable.msg_delete, (CharSequence) LocaleController.getString(R.string.DeleteAllCalls), true, new Runnable() { // from class: org.telegram.ui.CallLogActivity$$ExternalSyntheticLambda16
            @Override // java.lang.Runnable
            public final void run() {
