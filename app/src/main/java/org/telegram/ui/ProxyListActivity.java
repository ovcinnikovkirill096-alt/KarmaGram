...
public class ProxyListActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate {
                    ...
                    public final void run(long j) {
                        AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.ProxyListActivity$$ExternalSyntheticLambda7
                            ...
                            public final void run() {
                                ProxyListActivity.m16528$r8$lambda$5pbN7GOeBsh_eBQYt4oGxgPw4(proxyInfo, j);
                            }
                        });
                    }
                });
    ...
    public static /* synthetic */ void m16528$r8$lambda$5pbN7GOeBsh_eBQYt4oGxgPw4(SharedConfig.ProxyInfo proxyInfo, long j) {
            ...
            switch (viewHolder.getItemViewType()) {
                ...
                case 3:
                    ...
                    if (i == ProxyListActivity.this.useProxyRow) {
                        textCheckCell.setTextAndCheck(LocaleController.getString(R.string.UseProxySettings), ProxyListActivity.this.useProxySettings, true);
                    } else if (i == ProxyListActivity.this.proxyReactToVpnRow) {
                        textCheckCell.setTextAndCheck(LocaleController.getString(R.string.ProxyDoNotUseWithVPN), ExteraConfig.doNotUseProxyWithVpn, ProxyListActivity.this.rotationRow != -1);
