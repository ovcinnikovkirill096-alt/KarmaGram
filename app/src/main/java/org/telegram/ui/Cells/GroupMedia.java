...
public class GroupMedia {
    ...
    public void updateHolders(MessageObject messageObject) {
        ...
        while (i3 < this.holders.size()) {
            ...
            if (position == null) {
                ...
                int i6 = (int) (f5 * f6);
                z2 = z3;
                int i7 = (int) ((position.pw / f2) * f * i4);
                ...
                int i11 = ((i10 & 4) == 0 || (i10 & 1) == 0 || z2) ? iDp2 : iDp3;
                int i12 = ((i10 & 4) == 0 || (i10 & 2) == 0 || z2) ? iDp2 : iDp3;
                int i13 = ((i10 & 8) == 0 || (i10 & 1) == 0 || z) ? iDp2 : iDp3;
                int i14 = ((i10 & 8) == 0 || (i10 & 2) == 0 || z) ? iDp2 : iDp3;
                if (!z) {
                ...
                this.hidden = (this.hidden || mediaHolder.hidden) ? 1 : c;
            }
            i3++;
            c3 = c;
            f3 = f2;
    ...
    public void checkBlurBitmap() {
        ...
        for (int i8 = 0; i8 < this.holders.size(); i8++) {
            ...
            int i10 = mediaHolder2.t;
            imageReceiver.setImageCoords(i9, i10, mediaHolder2.r - i9, mediaHolder2.b - i10);
    ...
    public void drawImages(Canvas canvas, boolean z) {
        ...
        while (i10 < this.holders.size()) {
            ...
            if (mediaHolder2.durationText != null) {
                ...
                rectF2.set(i11 + i12 + fDp3, i13 + i14 + fDp3, i11 + i12 + fDp3 + fDp, i13 + i14 + fDp3 + fDp2);
    ...
    public static class GroupedMessages {
        ...
        /* JADX WARN: Code duplicated, block: B:142:0x0635  */
        ...
        public void calculate() {
            ...
            while (i8 < size) {
                ...
                float f7 = groupedMessagePosition.photoWidth / groupedMessagePosition.photoHeight;
                groupedMessagePosition.aspectRatio = f7;
                if (f7 > 1.2f) {
                    sb.append("w");
                } else if (f7 < 0.8f) {
                    sb.append("n");
                ...
                float f8 = groupedMessagePosition.aspectRatio;
                f6 += f8;
                if (f8 > f5) {
                    z = true;
                }
            ...
            int i10 = (int) (fDp2 / (fMin / i9));
            float f9 = i9 / this.maxSizeHeight;
            float f10 = f6 / size;
            ...
            if (size == 1) {
                ...
                if (f11 >= 1.0f) {
                    ...
                    f3 = i11;
                    f4 = ((f3 / f11) / i11) * this.maxSizeHeight;
                } else {
                    float f12 = this.maxSizeHeight;
                    f3 = this.maxSizeWidth * ((f11 * f12) / f12);
                    f4 = f12;
                }
                groupedMessagePosition2.set(0, 0, 0, 0, (int) f3, f4 / this.maxSizeHeight, 15);
                i = 0;
            } else {
                int i12 = 4;
                int i13 = 3;
                if (z || !(size == 2 || size == 3 || size == 4)) {
                    ...
                    while (i14 < size) {
                        if (f10 > 1.1f) {
                            f2 = f13;
                            fArr[i14] = Math.max(f2, ((MessageObject.GroupedMessagePosition) this.posArray.get(i14)).aspectRatio);
                        } else {
                            f2 = f13;
                            fArr[i14] = Math.min(f2, ((MessageObject.GroupedMessagePosition) this.posArray.get(i14)).aspectRatio);
                        }
                        ...
                        while (true) {
                            ...
                            if (i19 < i20) {
                                ...
                                if (i18 > 3) {
                                    i6 = i18;
                                    i7 = i19;
                                } else if (i19 > (f10 < 0.85f ? i17 : 3) || i21 > 3) {
                                    i6 = i18;
                                    i7 = i19;
                                } else {
                                    int i22 = i18 + i19;
                                    i6 = i18;
                                    i7 = i19;
                                    arrayList.add(new MessageGroupedLayoutAttempt(i6, i7, i21, multiHeight(fArr, 0, i18), multiHeight(fArr, i18, i22), multiHeight(fArr, i22, size2)));
                                }
                                i19 = i7 + 1;
                                i18 = i6;
                            }
                        ...
                        while (true) {
                            ...
                            if (i24 < i25) {
                                ...
                                while (true) {
                                    ...
                                    if (i26 < i27) {
                                        int i28 = i27 - i26;
                                        if (i23 > i13 || i24 > i13 || i26 > i13 || i28 > i13) {
                                            i3 = i23;
                                            i4 = i24;
                                            i5 = i26;
                                        } else {
                                            ...
                                            i4 = i24;
                                            i5 = i26;
                                            arrayList.add(new MessageGroupedLayoutAttempt(i3, i4, i5, i28, multiHeight(fArr, 0, i23), multiHeight(fArr, i23, i29), multiHeight(fArr, i29, i30), multiHeight(fArr, i30, size2)));
                                        }
                                        i26 = i5 + 1;
                                        i13 = i13;
                                        i23 = i3;
                    ...
                    int i31 = i13;
                    float f14 = (this.maxSizeWidth / 3) * 4;
                    int i32 = 0;
                    ...
                    while (i32 < arrayList.size()) {
                        ...
                        if (iArr.length > 1) {
                            ...
                            if (i34 <= i35) {
                                ...
                                if (iArr.length <= 2 || i35 <= iArr[2]) {
                                    i2 = i31;
                                    if (iArr.length > i2 && iArr[2] > iArr[i2]) {
                                    }
                                }
                                fAbs *= 1.2f;
                            } else {
                        ...
                        if (messageGroupedLayoutAttempt == null || fAbs < f15) {
                    ...
                    while (true) {
                        ...
                        int i38 = iArr2[i37];
                        float f19 = messageGroupedLayoutAttempt.heights[i37];
                        int i39 = this.maxSizeWidth;
                        int i40 = i38 - 1;
                        this.maxX = Math.max(this.maxX, i40);
                        int i41 = i39;
                        int i42 = 0;
                        MessageObject.GroupedMessagePosition groupedMessagePosition3 = null;
                        while (i42 < i38) {
                            int i43 = (int) (fArr[i36] * f19);
                            i41 -= i43;
                            MessageObject.GroupedMessagePosition groupedMessagePosition4 = (MessageObject.GroupedMessagePosition) this.posArray.get(i36);
                            int i44 = i37 == 0 ? i17 : 0;
                            ...
                            int i45 = i42;
                            groupedMessagePosition4.set(i45, i42, i37, i37, i43, Math.max(fDp3, f19 / this.maxSizeHeight), i44);
                            i36++;
                            i42 = i45 + 1;
                        }
                    ...
                    if (size == 2) {
                        ...
                        if (string.equals("ww") && f10 > ((double) f9) * 1.4d) {
                            ...
                            if (f20 - f21 < 0.2d) {
                                ...
                                float fRound = Math.round(Math.min(i46 / f20, Math.min(i46 / f21, this.maxSizeHeight / 2.0f))) / this.maxSizeHeight;
                                ...
                                groupedMessagePosition5.set(0, 0, 0, 0, i47, fRound2, 13);
                                groupedMessagePosition6.set(1, 1, 0, 0, i47, fRound2, 14);
                                this.maxX = 1;
                            } else {
                                ...
                                groupedMessagePosition5.set(0, 0, 0, 0, i48, fRound3, 13);
                                groupedMessagePosition6.set(1, 1, 0, 0, i48, fRound3, 14);
                                this.maxX = 1;
                            }
                            ...
                            groupedMessagePosition5.set(0, 0, 0, 0, i49, fRound4, 13);
                            groupedMessagePosition6.set(1, 1, 0, 0, i49, fRound4, 14);
                            this.maxX = 1;
                        } else {
                            int i50 = this.maxSizeWidth;
                            float f25 = groupedMessagePosition5.aspectRatio;
                            int iMax = (int) Math.max(i50 * 0.4f, Math.round((i50 / f25) / ((1.0f / f25) + (1.0f / groupedMessagePosition6.aspectRatio))));
                            int i51 = this.maxSizeWidth - iMax;
                            if (i51 < iMin) {
                                iMax -= iMin - i51;
                            } else {
                                iMin = i51;
                        ...
                        if (sb.charAt(0) == 'n') {
                            ...
                            float fMin3 = Math.min(f26, Math.round((this.maxSizeWidth * f27) / (groupedMessagePosition9.aspectRatio + f27)));
                            float f28 = this.maxSizeHeight - fMin3;
                            int iMax2 = (int) Math.max(iMin, Math.min(this.maxSizeWidth * 0.5f, Math.round(Math.min(groupedMessagePosition9.aspectRatio * fMin3, groupedMessagePosition8.aspectRatio * f28))));
                            int iRound = Math.round(Math.min((this.maxSizeHeight * groupedMessagePosition7.aspectRatio) + i10, this.maxSizeWidth - iMax2));
                            groupedMessagePosition7.set(0, 0, 0, 1, iRound, 1.0f, 13);
                            groupedMessagePosition8.set(1, 1, 0, 0, iMax2, f28 / this.maxSizeHeight, 6);
                            groupedMessagePosition9.set(1, 1, 1, 1, iMax2, fMin3 / this.maxSizeHeight, 10);
                            int i52 = this.maxSizeWidth;
                            groupedMessagePosition9.spanSize = i52;
                            float f29 = this.maxSizeHeight;
                            groupedMessagePosition7.siblingHeights = new float[]{fMin3 / f29, f28 / f29};
                            groupedMessagePosition8.spanSize = i52 - iRound;
                            ...
                            float f30 = i53;
                            float fMin4 = Math.min(this.maxSizeHeight - fRound5, Math.round(Math.min(f30 / groupedMessagePosition8.aspectRatio, f30 / groupedMessagePosition9.aspectRatio))) / this.maxSizeHeight;
                            float f31 = fMin4 < fDp3 ? fDp3 : fMin4;
                            groupedMessagePosition8.set(0, 0, 1, 1, i53, f31, 9);
                            groupedMessagePosition9.set(1, 1, 1, 1, i53, f31, 10);
                            this.maxX = 1;
                        }
                    } else {
                        ...
                        if (sb.charAt(0) == 'w') {
                            ...
                            float f32 = iMin;
                            int iMax3 = (int) Math.max(f32, Math.min(this.maxSizeWidth * 0.4f, groupedMessagePosition11.aspectRatio * fRound7));
                            int iMax4 = (int) Math.max(Math.max(f32, this.maxSizeWidth * 0.33f), groupedMessagePosition13.aspectRatio * fRound7);
                            ...
                            float f33 = fMin5 < fDp3 ? fDp3 : fMin5;
                            groupedMessagePosition11.set(0, 0, 1, 1, i56, f33, 9);
                            groupedMessagePosition12.set(1, 1, 1, 1, iDp2, f33, 8);
                            groupedMessagePosition13.set(2, 2, 1, 1, i55, f33, 10);
                            this.maxX = 2;
                        } else {
                            ...
                            float f34 = iDp;
                            float f35 = iMax5;
                            float fMin6 = Math.min(0.33f, Math.max(f34, f35 / groupedMessagePosition11.aspectRatio) / this.maxSizeHeight);
                            float fMin7 = Math.min(0.33f, Math.max(f34, f35 / groupedMessagePosition12.aspectRatio) / this.maxSizeHeight);
                            float f36 = (1.0f - fMin6) - fMin7;
                            int iRound2 = Math.round(Math.min((this.maxSizeHeight * groupedMessagePosition10.aspectRatio) + i10, this.maxSizeWidth - iMax5));
                            groupedMessagePosition10.set(0, 0, 0, 2, iRound2, fMin6 + fMin7 + f36, 13);
                            ...
                            groupedMessagePosition13.set(1, 1, 2, 2, iMax5, f36, 10);
                            int i57 = this.maxSizeWidth;
                            groupedMessagePosition13.spanSize = i57;
                            groupedMessagePosition11.spanSize = i57 - iRound2;
                            groupedMessagePosition12.leftSpanOffset = iRound2;
                            groupedMessagePosition13.leftSpanOffset = iRound2;
                            groupedMessagePosition10.siblingHeights = new float[]{fMin6, fMin7, f36};
                            this.hasSibling = true;
                            this.maxX = 1;
                        }
                    }
            ...
            for (int i58 = i; i58 < size; i58++) {
                MessageObject.GroupedMessagePosition groupedMessagePosition14 = (MessageObject.GroupedMessagePosition) this.posArray.get(i58);
                ...
                if (groupedMessagePosition14.edge) {
                    int i59 = groupedMessagePosition14.spanSize;
                    if (i59 != 1000) {
                        groupedMessagePosition14.spanSize = i59 + 108;
                    }
                    groupedMessagePosition14.pw += 108;
                } else if ((groupedMessagePosition14.flags & 2) != 0) {
                    int i60 = groupedMessagePosition14.spanSize;
                    if (i60 != 1000) {
                        groupedMessagePosition14.spanSize = i60 - 108;
                    } else {
                        int i61 = groupedMessagePosition14.leftSpanOffset;
                        if (i61 != 0) {
                            groupedMessagePosition14.leftSpanOffset = i61 + 108;
                        }
                    }
                }
            }
            for (int i62 = i; i62 < size; i62++) {
                MessageObject.GroupedMessagePosition groupedMessagePosition15 = (MessageObject.GroupedMessagePosition) this.posArray.get(i62);
            ...
            for (int i63 = i; i63 < size; i63++) {
                MessageObject.GroupedMessagePosition groupedMessagePosition16 = (MessageObject.GroupedMessagePosition) this.posArray.get(i63);
