...
public class GroupCallUserCell extends FrameLayout {
  ...
  0x0017: PHI (r3v2 int) = (r3v0 int), (r3v1 int) binds: [B:6:0x0015, B:12:0x0026] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    /* JADX WARN: Code duplicated, block: B:216:0x03d5  */
    /* JADX WARN: Code duplicated, block: B:223:0x0404  */
    /* JADX WARN: Code duplicated, block: B:225:0x0408  */
    /* JADX WARN: Code duplicated, block: B:227:0x0412  */
    /* JADX WARN: Code duplicated, block: B:228:0x041c  */
    /* JADX WARN: Code duplicated, block: B:229:0x0422  */
    /* JADX WARN: Code duplicated, block: B:231:0x0430  */
    /* JADX WARN: Code duplicated, block: B:234:0x043b  */
    /* JADX WARN: Code duplicated, block: B:236:0x043f  */
    /* JADX WARN: Code duplicated, block: B:237:0x0442  */
    /* JADX WARN: Code duplicated, block: B:240:0x044a  */
    /* JADX WARN: Code duplicated, block: B:241:0x044c  */
    /* JADX WARN: Code duplicated, block: B:243:0x044f  */
    /* JADX WARN: Code duplicated, block: B:244:0x0457  */
    /* JADX WARN: Code duplicated, block: B:245:0x0459  */
    /* JADX WARN: Code duplicated, block: B:249:0x0465 A[DONT_INVERT] */
    /* JADX WARN: Code duplicated, block: B:250:0x0467  */
    /* JADX WARN: Code duplicated, block: B:251:0x046f  */
    /* JADX WARN: Code duplicated, block: B:253:0x047a  */
    /* JADX WARN: Code duplicated, block: B:257:0x0491  */
    private void applyParticipantChanges(boolean z, boolean z2) {
        ...
        if (isSelfUser()) {
            ...
            this.statusTextView[4].setText(_UrlKt.FRAGMENT_ENCODE_SET);
        ...
        boolean z12 = (animatorSet2 == null || (i2 == this.currentStatus && this.lastMuteColor == color)) ? false : true;
        ...
        if (i2 == 1) {
            ...
            if (i8 != 100) {
                ...
                simpleTextView.setText(LocaleController.formatString("SpeakingWithVolume", i9, Integer.valueOf(i8)));
            } else {
        ...
        if (isSelfUser()) {
            ...
            if (!z || i2 != this.currentStatus || z12) {
                if (z) {
                    if (arrayList == null) {
                        arrayList = new ArrayList();
                    }
                    ...
                    if (i2 != 0) {
                        ...
                        while (true) {
                            ...
                            SimpleTextView simpleTextView2 = simpleTextViewArr[i10];
                            if (i10 == i2) {
                                fDp = 0.0f;
                            } else {
                        ...
                        while (true) {
                            ...
                            if (i11 >= simpleTextViewArr2.length) {
                                break;
                            }
                            arrayList.add(ObjectAnimator.ofFloat(simpleTextViewArr2[i11], (Property<SimpleTextView, Float>) property2, i11 == i2 ? 0.0f : AndroidUtilities.dp(-2.0f)));
            ...
            if (z || this.lastMuted != z8 || this.lastRaisedHand != z4) {
                if (z4) {
                    ...
                    if (!z8 && this.lastRaisedHand) {
                        ...
                        customEndFrame = rLottieDrawable.setCustomEndFrame(i3);
                    }
                }
                if (z) {
                    if (customEndFrame) {
        ...
        if (z) {
            if (z4) {
                ...
                if (!z8) {
                    ...
                    customEndFrame = rLottieDrawable4.setCustomEndFrame(i3);
                }
            }
            if (z) {
                if (customEndFrame) {
            ...
            if (z4) {
                ...
                if (!z8) {
                    ...
                    customEndFrame = rLottieDrawable7.setCustomEndFrame(i3);
                }
            }
            if (z) {
                if (customEndFrame) {
