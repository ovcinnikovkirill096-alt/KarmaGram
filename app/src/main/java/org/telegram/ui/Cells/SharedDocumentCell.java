...
public class SharedDocumentCell extends FrameLayout implements DownloadController.FileDownloadProgressListener {
        ...
        if (document == null) {
            ...
            if (TextUtils.isEmpty(documentFileName) && (str = document.mime_type) != null) {
                if (str.startsWith(MediaStreamTrack.VIDEO_TRACK_KIND)) {
                    ...
                    documentFileName = document.mime_type.startsWith(MediaStreamTrack.AUDIO_TRACK_KIND) ? LocaleController.getString(R.string.AttachAudio) : LocaleController.getString(R.string.AttachDocument);
                }
            }
            if (str4 == null) {
    ...
    /* JADX WARN: Code duplicated, block: B:19:0x0080 A[DONT_INVERT] */
