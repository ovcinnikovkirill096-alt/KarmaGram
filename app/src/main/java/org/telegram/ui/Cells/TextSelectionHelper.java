...
public abstract class TextSelectionHelper {
    ...
    public class TextSelectionOverlay extends View {
        ...
        /* JADX WARN: Code duplicated, block: B:262:0x04c6  */
        /* JADX WARN: Code duplicated, block: B:264:0x04dc  */
        /* JADX WARN: Code duplicated, block: B:267:0x0502  */
        ...
        public boolean onTouchEvent(MotionEvent motionEvent) {
            ...
            if (action != 0) {
                if (action == 1) {
                    ...
                    textSelectionHelper.isOneTouch = false;
                    if (TextSelectionHelper.this.isInSelectionMode()) {
                    ...
                    if (textSelectionHelper2.movingHandle) {
                        ...
                        TextSelectionHelper textSelectionHelper4 = TextSelectionHelper.this;
                        int i = (int) (x2 + textSelectionHelper4.movingOffsetX);
                        boolean zSelectLayout = textSelectionHelper4.selectLayout(i, y);
                        TextSelectionHelper textSelectionHelper5 = TextSelectionHelper.this;
                        if (textSelectionHelper5.selectedView == null) {
                            return true;
                        }
                        if (textSelectionHelper5.movingHandleStart) {
                            textSelectionHelper5.fillLayoutForOffset(textSelectionHelper5.selectionStart, textSelectionHelper5.layoutBlock);
                        } else {
                            textSelectionHelper5.fillLayoutForOffset(textSelectionHelper5.selectionEnd, textSelectionHelper5.layoutBlock);
                        }
                        TextSelectionHelper textSelectionHelper6 = TextSelectionHelper.this;
                        ...
                        float f2 = layoutBlock.yOffset;
                        SelectableView selectableView = textSelectionHelper6.selectedView;
                        int[] coordsInParent = textSelectionHelper6.getCoordsInParent();
                        ...
                        if (motionEvent.getY() < ((View) TextSelectionHelper.this.parentView.getParent()).getTop() + TextSelectionHelper.this.getParentTopPadding()) {
                            TextSelectionHelper textSelectionHelper8 = TextSelectionHelper.this;
                            if (textSelectionHelper8.multiselect || textSelectionHelper8.selectedView.getTop() < TextSelectionHelper.this.getParentTopPadding()) {
                                z2 = true;
                            } else {
                                z2 = false;
                            }
                        ...
                        int i4 = i2;
                        TextSelectionHelper textSelectionHelper9 = TextSelectionHelper.this;
                        int charOffsetFromCord = textSelectionHelper9.getCharOffsetFromCord(i3, i4, textSelectionHelper9.textX, textSelectionHelper9.textY, textSelectionHelper9.selectedView, false);
                        if (charOffsetFromCord >= 0) {
                            TextSelectionHelper textSelectionHelper10 = TextSelectionHelper.this;
                            if (textSelectionHelper10.movingDirectionSettling) {
                                if (zSelectLayout) {
                                    return true;
                                }
                                if (charOffsetFromCord < textSelectionHelper10.selectionStart) {
                                    textSelectionHelper10.movingDirectionSettling = false;
                                    textSelectionHelper10.movingHandleStart = true;
                                    textSelectionHelper10.hideActions();
                                } else {
                                    if (charOffsetFromCord <= textSelectionHelper10.selectionEnd) {
                                        return true;
                                    }
                                    textSelectionHelper10.movingDirectionSettling = false;
                                    textSelectionHelper10.movingHandleStart = false;
                                    textSelectionHelper10.hideActions();
                                }
                            }
                            TextSelectionHelper textSelectionHelper11 = TextSelectionHelper.this;
                            if (textSelectionHelper11.movingHandleStart) {
                                if (textSelectionHelper11.selectionStart != charOffsetFromCord && textSelectionHelper11.canSelect(charOffsetFromCord)) {
                                    TextSelectionHelper textSelectionHelper12 = TextSelectionHelper.this;
                                    CharSequence text = textSelectionHelper12.getText(textSelectionHelper12.selectedView, false);
                                    TextSelectionHelper textSelectionHelper13 = TextSelectionHelper.this;
                                    textSelectionHelper13.fillLayoutForOffset(charOffsetFromCord, textSelectionHelper13.layoutBlock);
                                    TextSelectionHelper textSelectionHelper14 = TextSelectionHelper.this;
                                    LayoutBlock layoutBlock2 = textSelectionHelper14.layoutBlock;
                                    Layout layout = layoutBlock2.layout;
                                    textSelectionHelper14.fillLayoutForOffset(textSelectionHelper14.selectionStart, layoutBlock2);
                                    ...
                                    if (zSelectLayout || layout != layout2 || (lineForOffset3 != layout2.getLineForOffset(TextSelectionHelper.this.selectionStart) && lineForOffset3 == lineForOffset)) {
                                        ...
                                        textSelectionHelper15.jumpToLine(charOffsetFromCord, i7, zSelectLayout, textSelectionHelper15.layoutBlock.yOffset, f2, selectableView);
                                        ...
                                        textSelectionHelper16.selectionStart = charOffsetFromCord;
                                        int i8 = textSelectionHelper16.selectionEnd;
                                        if (charOffsetFromCord > i8) {
                                            textSelectionHelper16.selectionEnd = charOffsetFromCord;
                                            textSelectionHelper16.selectionStart = i8;
                                            textSelectionHelper16.movingHandleStart = false;
                                        }
                                        AndroidUtilities.vibrateCursor(textSelectionHelper16.textSelectionOverlay);
                                        TextSelectionHelper.this.invalidate();
                                    } else {
                                        ...
                                        int iAbs2 = Math.abs(charOffsetFromCord - i9);
                                        ...
                                        if ((charOffsetFromCord < i12 && iAbs < iAbs2) || ((charOffsetFromCord > i12 && x < 0) || !TextSelectionHelper.isInterruptedCharacter(cCharAt) || ((TextSelectionHelper.isInterruptedCharacter(cCharAt2) && !TextSelectionHelper.this.snap) || charOffsetFromCord == 0 || !z4 || cCharAt2 == '\n'))) {
                                            ...
                                            if (charOffsetFromCord < TextSelectionHelper.this.selectionStart && TextSelectionHelper.isInterruptedCharacter(cCharAt) && ((!TextSelectionHelper.isInterruptedCharacter(cCharAt2) || TextSelectionHelper.this.snap) && cCharAt2 != '\n')) {
                                                ...
                                                textSelectionHelper17.snap = true;
                                            } else {
                                            ...
                                            int i13 = textSelectionHelper18.selectionStart;
                                            int i14 = textSelectionHelper18.selectionEnd;
                                            if (i13 > i14) {
                                                textSelectionHelper18.selectionEnd = i13;
                                                textSelectionHelper18.selectionStart = i14;
                                                textSelectionHelper18.movingHandleStart = false;
                                            }
                                            AndroidUtilities.vibrateCursor(textSelectionHelper18.textSelectionOverlay);
                                            TextSelectionHelper.this.invalidate();
                                        }
                                    }
                                }
                            } else if (charOffsetFromCord != textSelectionHelper11.selectionEnd && textSelectionHelper11.canSelect(charOffsetFromCord)) {
                                TextSelectionHelper textSelectionHelper19 = TextSelectionHelper.this;
                                CharSequence text2 = textSelectionHelper19.getText(textSelectionHelper19.selectedView, false);
                                int i15 = charOffsetFromCord;
                                while (i15 < text2.length() && TextSelectionHelper.isInterruptedCharacter(text2.charAt(i15))) {
                                    i15++;
                                }
                                ...
                                LayoutBlock layoutBlock3 = textSelectionHelper21.layoutBlock;
                                Layout layout3 = layoutBlock3.layout;
                                textSelectionHelper21.fillLayoutForOffset(textSelectionHelper21.selectionEnd, layoutBlock3);
                                ...
                                int lineForOffset4 = layout4.getLineForOffset(i15);
                                ...
                                if (zSelectLayout || layout3 != layout4 || (lineForOffset6 != layout4.getLineForOffset(TextSelectionHelper.this.selectionEnd) && lineForOffset6 == lineForOffset4)) {
                                    ...
                                    textSelectionHelper22.jumpToLine(charOffsetFromCord, i15, zSelectLayout, textSelectionHelper22.layoutBlock.yOffset, f2, selectableView);
                                    AndroidUtilities.vibrateCursor(TextSelectionHelper.this.textSelectionOverlay);
                                    TextSelectionHelper.this.invalidate();
                                    ...
                                    textSelectionHelper23.selectionEnd = charOffsetFromCord;
                                    int i16 = textSelectionHelper23.selectionStart;
                                    if (i16 > charOffsetFromCord) {
                                        textSelectionHelper23.selectionEnd = i16;
                                        textSelectionHelper23.selectionStart = charOffsetFromCord;
                                        textSelectionHelper23.movingHandleStart = true;
                                    }
                                    AndroidUtilities.vibrateCursor(textSelectionHelper23.textSelectionOverlay);
                                    TextSelectionHelper.this.invalidate();
                                } else {
                                    int i17 = charOffsetFromCord;
                                    while (true) {
                                        int i18 = i17 - 1;
                                        if (i18 < 0 || !TextSelectionHelper.isInterruptedCharacter(text2.charAt(i18))) {
                                            break;
                                        }
                                        i17--;
                                    }
                                    int iAbs3 = Math.abs(charOffsetFromCord - i15);
                                    int iAbs4 = Math.abs(charOffsetFromCord - i17);
                                    int i19 = charOffsetFromCord - 1;
                                    boolean z5 = i19 > 0 && TextSelectionHelper.isInterruptedCharacter(text2.charAt(i19));
                                    if (TextSelectionHelper.this.snap) {
                                        TextSelectionHelper.this.snap = x <= 0;
                                    }
                                    int i20 = TextSelectionHelper.this.selectionEnd;
                                    if (i20 > 0 && TextSelectionHelper.isInterruptedCharacter(text2.charAt(i20 - 1))) {
                                        z3 = true;
                                    }
                                    TextSelectionHelper textSelectionHelper24 = TextSelectionHelper.this;
                                    int i21 = textSelectionHelper24.selectionEnd;
                                    if ((charOffsetFromCord > i21 && iAbs3 <= iAbs4) || ((charOffsetFromCord < i21 && x > 0) || !z5 || (z3 && !textSelectionHelper24.snap))) {
                                        TextSelectionHelper textSelectionHelper25 = TextSelectionHelper.this;
                                        if (charOffsetFromCord > textSelectionHelper25.selectionEnd && z5 && (!z3 || textSelectionHelper25.snap)) {
                                            TextSelectionHelper textSelectionHelper26 = TextSelectionHelper.this;
                                            textSelectionHelper26.selectionEnd = i15;
                                            textSelectionHelper26.snap = true;
                                        } else {
                                        ...
                                        int i22 = textSelectionHelper27.selectionStart;
                                        int i23 = textSelectionHelper27.selectionEnd;
                                        if (i22 > i23) {
                                            textSelectionHelper27.selectionEnd = i22;
                                            textSelectionHelper27.selectionStart = i23;
                                            textSelectionHelper27.movingHandleStart = true;
                                        }
                                        AndroidUtilities.vibrateCursor(textSelectionHelper27.textSelectionOverlay);
                                        TextSelectionHelper.this.invalidate();
                                    }
                                }
                            }
                        ...
                        textSelectionHelper28.showMagnifier(textSelectionHelper28.lastX);
                    }
                } else if (action == 3) {
                    TextSelectionHelper.this.hideMagnifier();
                    TextSelectionHelper textSelectionHelper29 = TextSelectionHelper.this;
                    textSelectionHelper29.movingHandle = false;
                    textSelectionHelper29.movingDirectionSettling = false;
                    textSelectionHelper29.isOneTouch = false;
                    if (TextSelectionHelper.this.isInSelectionMode()) {
                        TextSelectionHelper.this.textSelectionOverlay.invalidate();
                        AndroidUtilities.cancelRunOnUIThread(TextSelectionHelper.this.showActionsRunnable);
                        AndroidUtilities.runOnUIThread(TextSelectionHelper.this.showActionsRunnable);
                ...
                float f3 = x3;
                float f4 = y2;
                if (TextSelectionHelper.this.startArea.contains(f3, f4)) {
                    ...
                    textSelectionHelper30.movingHandleStart = true;
                    int[] iArrOffsetToCord = textSelectionHelper30.offsetToCord(textSelectionHelper30.selectionStart);
                    ...
                    if (textSelectionHelper31.useMovingOffset) {
                        textSelectionHelper31.movingOffsetX = ((iArrOffsetToCord[0] + textSelectionHelper31.textX) + coordsInParent2[0]) - x3;
                    } else {
                        textSelectionHelper31.movingOffsetX = 0.0f;
                    }
                    textSelectionHelper31.movingOffsetY = (((iArrOffsetToCord[1] + textSelectionHelper31.textY) + coordsInParent2[1]) - y2) - lineHeight;
                    textSelectionHelper31.hideActions();
                    TextSelectionHelper.this.textSelectionOverlay.invalidate();
                    return true;
                }
                if (TextSelectionHelper.this.endArea.contains(f3, f4)) {
                    ...
                    int[] iArrOffsetToCord2 = textSelectionHelper32.offsetToCord(textSelectionHelper32.selectionEnd);
                    ...
                    textSelectionHelper33.movingOffsetX = ((iArrOffsetToCord2[0] + textSelectionHelper33.textX) + coordsInParent3[0]) - x3;
                    textSelectionHelper33.movingOffsetY = (((iArrOffsetToCord2[1] + textSelectionHelper33.textY) + coordsInParent3[1]) - y2) - lineHeight2;
                    textSelectionHelper33.showMagnifier(textSelectionHelper33.lastX);
                    TextSelectionHelper.this.hideActions();
                    TextSelectionHelper.this.textSelectionOverlay.invalidate();
                    return true;
                }
                TextSelectionHelper textSelectionHelper34 = TextSelectionHelper.this;
                textSelectionHelper34.movingHandle = false;
                textSelectionHelper34.allowDiscard = true;
            }
            return TextSelectionHelper.this.movingHandle;
        }

        /* JADX WARN: Code duplicated, block: B:33:0x01ac  */
        @Override // android.view.View
        protected void onDraw(Canvas canvas) {
            ...
            if (TextSelectionHelper.this.isInSelectionMode()) {
                ...
                if (TextSelectionHelper.this.selectedView != null) {
                    ...
                    if (i4 < 0 || i4 > length) {
                        ...
                        if (layout == null) {
                            ...
                            float f4 = i6;
                            float f5 = f + f4;
                            if (f5 > textSelectionHelper5.keyboardSize + i2 && f5 < textSelectionHelper5.parentView.getMeasuredHeight()) {
                                if (!layout.isRtlCharAt(TextSelectionHelper.this.selectionEnd)) {
                                    canvas.save();
                ...
                if (TextSelectionHelper.this.selectedView != null) {
                    ...
                    TextSelectionHelper textSelectionHelper6 = TextSelectionHelper.this;
                    float f12 = i7 + textSelectionHelper6.textY;
                    ...
                    TextSelectionHelper textSelectionHelper8 = TextSelectionHelper.this;
                    int i8 = textSelectionHelper8.selectionStart;
                    if (i8 >= 0 && i8 <= length3) {
                        textSelectionHelper8.fillLayoutForOffset(i8, textSelectionHelper8.layoutBlock);
                        TextSelectionHelper textSelectionHelper9 = TextSelectionHelper.this;
                        LayoutBlock layoutBlock3 = textSelectionHelper9.layoutBlock;
                        Layout layout2 = layoutBlock3.layout;
                        if (layout2 != null) {
                            int i9 = textSelectionHelper9.selectionStart - layoutBlock3.charOffset;
                            ...
                            float f15 = i10;
                            float f16 = f12 + f15;
                            if (f16 > i2 + textSelectionHelper10.keyboardSize && f16 < textSelectionHelper10.parentView.getMeasuredHeight()) {
    ...
    class AnonymousClass4 implements ActionMode.Callback {
        ...
        public boolean onCreateActionMode(ActionMode actionMode, Menu menu) {
            ...
            if (AyuConfig.filtersEnabled) {
                menu.add(0, 10, 4, LocaleController.getString(org.telegram.messenger.R.string.RegexFilterQuickAdd));
            }
            return true;
        }
        ...
        public boolean onActionItemClicked(ActionMode actionMode, MenuItem menuItem) {
            ...
            if (itemId == 10) {
                ...
                if (lastFragment instanceof ChatActivity) {
                    ...
                    LaunchActivity.instance.lambda$runLinkRequest$106(new RegexFilterEditActivity(Long.valueOf(chatActivity.getDialogId()), selectedText.toString(), chatActivity));
                }
                TextSelectionHelper.this.hideActions();
                return true;
            }
    ...
    /* JADX WARN: Code duplicated, block: B:40:0x0106 A[LOOP:1: B:39:0x0104->B:40:0x0106, LOOP_END] */
    ...
    public static class SimpleTextSelectionHelper extends TextSelectionHelper {
        ...
        /* JADX INFO: Access modifiers changed from: protected */
        /* JADX WARN: Code duplicated, block: B:28:0x0051 A[EXC_TOP_SPLITTER, SYNTHETIC] */
        @Override // org.telegram.ui.Cells.TextSelectionHelper
    ...
    public static class ChatListTextSelectionHelper extends TextSelectionHelper {
        ...
        protected void fillLayoutForOffset(int i, LayoutBlock layoutBlock, boolean z) {
            ...
            if (chatMessageCell.hasCaptionLayout()) {
                ...
                if (captionLayout.textLayoutBlocks.size() == 1) {
                    ...
                    float f = -(textLayoutBlock2.isRtl() ? ((int) Math.ceil(captionLayout.textXOffset)) - (textLayoutBlock2.quote ? AndroidUtilities.dp(10.0f) : 0) : 0);
                    layoutBlock.xOffset = f;
                    if (textLayoutBlock2.code && !textLayoutBlock2.quote) {
                ...
                for (int i2 = 0; i2 < captionLayout.textLayoutBlocks.size(); i2++) {
                    MessageObject.TextLayoutBlock textLayoutBlock3 = captionLayout.textLayoutBlocks.get(i2);
                    int i3 = i - textLayoutBlock3.charactersOffset;
                    if (i3 >= 0 && i3 <= textLayoutBlock3.textLayout.getText().length()) {
            ...
            if (arrayList.size() == 1) {
                ...
                layoutBlock.yOffset = textLayoutBlock4.padTop;
        ...
        protected void onExitSelectionMode(boolean z) {
            ...
            valueAnimatorOfFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: org.telegram.ui.Cells.TextSelectionHelper$ChatListTextSelectionHelper$$ExternalSyntheticLambda0
                @Override // android.animation.ValueAnimator.AnimatorUpdateListener
                public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                    TextSelectionHelper.ChatListTextSelectionHelper.m5876$r8$lambda$Gcwvj2Ry5WM_FcJtCCC93mDpYk(chatMessageCell, id, valueAnimator);
                }
            });
        ...
        public static /* synthetic */ void m5876$r8$lambda$Gcwvj2Ry5WM_FcJtCCC93mDpYk(ChatMessageCell chatMessageCell, int i, ValueAnimator valueAnimator) {
