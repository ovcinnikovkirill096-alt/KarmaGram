...
public class ProfileSearchCell extends BaseCell implements NotificationCenter.NotificationCenterDelegate, Theme.Colorable {
    ...
    /* JADX WARN: Code duplicated, block: B:168:0x04fc  */
    /* JADX WARN: Code duplicated, block: B:170:0x0502  */
    /* JADX WARN: Code duplicated, block: B:171:0x0509  */
    /* JADX WARN: Code duplicated, block: B:173:0x050d  */
    /* JADX WARN: Code duplicated, block: B:174:0x0514  */
    /* JADX WARN: Code duplicated, block: B:176:0x051a  */
    /* JADX WARN: Code duplicated, block: B:177:0x0521  */
    /* JADX WARN: Code duplicated, block: B:179:0x0529  */
    /* JADX WARN: Code duplicated, block: B:180:0x0534  */
    public void buildLayout() {
        ...
        if (encryptedChat != null) {
            ...
            if (chat3 != null) {
                this.dialog_id = -chat3.id;
                this.drawCheck = chat3.verified;
                if (chat3.monoforum && (chat = MessagesController.getInstance(this.currentAccount).getChat(Long.valueOf(this.chat.linked_monoforum_id))) != null) {
                ...
                updateStatus(this.drawCheck, BadgesController.INSTANCE.getBadge(this.chat), null, this.chat, false);
            } else {
                ...
                if (user2 != null) {
                    ...
                    updateStatus(this.drawCheck, BadgesController.INSTANCE.getBadge(this.user), this.user, null, false);
        ...
        if (chat4 != null) {
            if (chat4.monoforum) {
                TLRPC.Chat chat5 = MessagesController.getInstance(this.currentAccount).getChat(Long.valueOf(this.chat.linked_monoforum_id));
                if (chat5 != null) {
                    charSequenceRemoveRTL = charSequence2;
                    charSequenceRemoveRTL = charSequence2;
                    SpannableStringBuilder spannableStringBuilder = new SpannableStringBuilder(AndroidUtilities.escape(chat5.title));
                    spannableStringBuilder.append((CharSequence) " ");
                    int length = spannableStringBuilder.length();
                    spannableStringBuilder.append((CharSequence) LocaleController.getString(R.string.MonoforumSpan));
                    spannableStringBuilder.setSpan(new FilterCreateActivity.TextSpan(LocaleController.getString(R.string.MonoforumSpan), 9.33f, Theme.key_windowBackgroundWhiteGrayText, this.resourcesProvider), length, spannableStringBuilder.length(), 33);
                ...
                charSequenceRemoveRTL = AndroidUtilities.removeRTL(AndroidUtilities.removeDiacritics(chat4.title));
            }
        ...
        if (TextUtils.isEmpty(charSequenceReplaceNewLines)) {
            if (ExteraConfig.hidePhoneNumber) {
                charSequenceReplaceNewLines = LocaleController.getString(R.string.MobileHidden);
            } else {
        ...
        if (this.contact != null) {
            int iMeasureText = (int) (Theme.dialogs_countTextPaint.measureText(LocaleController.getString(R.string.Invite)) + 1.0f);
            this.actionLayout = new StaticLayout(LocaleController.getString(R.string.Invite), Theme.dialogs_countTextPaint, iMeasureText, Layout.Alignment.ALIGN_NORMAL, 1.0f, 0.0f, false);
            if (!LocaleController.isRTL) {
        ...
        if (this.drawCount && (dialogUnreadCount = MessagesController.getInstance(this.currentAccount).getDialogUnreadCount((TLRPC.Dialog) MessagesController.getInstance(this.currentAccount).dialogs_dict.get(this.dialog_id))) != 0) {
            ...
            String str = String.format(Locale.US, TimeModel.NUMBER_FORMAT, Integer.valueOf(dialogUnreadCount));
        ...
        if (chat6 == null || this.subLabel != null) {
            ...
            if (ChatObject.isChannel(chat6)) {
                ...
                if (!chat7.megagroup) {
                    int i5 = chat7.participants_count;
                    if (i5 != 0) {
                    ...
                    if (i2 != 0) {
                        userStatus = LocaleController.formatPluralStringComma("Members", i2);
        ...
        if (this.customPaints) {
            ...
            if (textPaint4 == Theme.dialogs_offlinePaint) {
                this.statusPaint.setColor(Theme.getColor(Theme.key_windowBackgroundWhiteGrayText3, this.resourcesProvider));
            } else if (textPaint4 == Theme.dialogs_onlinePaint) {
                this.statusPaint.setColor(Theme.getColor(Theme.key_windowBackgroundWhiteBlueText3, this.resourcesProvider));
            }
            textPaint4 = this.statusPaint;
        }
        if (!TextUtils.isEmpty(userStatus)) {
            this.statusLayout = new StaticLayout(TextUtils.ellipsize(userStatus, textPaint4, i3 - AndroidUtilities.dp(12.0f), truncateAt), textPaint4, i3, alignment, 1.0f, 0.0f, false);
        ...
        if (LocaleController.isRTL) {
            if (this.nameLayout.getLineCount() > 0 && this.nameLayout.getLineLeft(0) == 0.0f) {
                ...
                if (dCeil < i6) {
                    this.nameLeft = (int) (((double) this.nameLeft) + (((double) i6) - dCeil));
                }
            }
            ...
            if (staticLayout != null && staticLayout.getLineCount() > 0 && this.statusLayout.getLineLeft(0) == 0.0f) {
                ...
                double d = i3;
                if (dCeil2 < d) {
                    this.statusLeft = (int) (((double) this.statusLeft) + (d - dCeil2));
                }
            }
        } else {
            if (this.nameLayout.getLineCount() > 0 && this.nameLayout.getLineRight(0) == this.nameWidth) {
                ...
                if (dCeil3 < i7) {
                    this.nameLeft = (int) (((double) this.nameLeft) - (((double) i7) - dCeil3));
                }
            }
            StaticLayout staticLayout2 = this.statusLayout;
            if (staticLayout2 != null && staticLayout2.getLineCount() > 0 && this.statusLayout.getLineRight(0) == i3) {
                double dCeil4 = Math.ceil(this.statusLayout.getLineWidth(0));
                double d2 = i3;
                if (dCeil4 < d2) {
                    this.statusLeft = (int) (((double) this.statusLeft) - (d2 - dCeil4));
                }
            }
        }
    ...
    /* JADX WARN: Code duplicated, block: B:15:0x0052 A[PHI: r3
  0x0052: PHI (r3v5 org.telegram.tgnet.TLRPC$FileLocation) = (r3v0 org.telegram.tgnet.TLRPC$FileLocation), (r3v7 org.telegram.tgnet.TLRPC$FileLocation) binds: [B:11:0x0048, B:13:0x004e] A[DONT_GENERATE, DONT_INLINE]] */
    /* JADX WARN: Code duplicated, block: B:24:0x007c A[PHI: r3
    ...
    public void update(int i) {
        ...
        if (i != 0) {
            ...
            if (z || (MessagesController.UPDATE_MASK_EMOJI_STATUS & i) == 0 || ((user = this.user) == null && this.chat == null)) {
                profileSearchCell = this;
            } else {
                boolean z2 = user != null ? user.verified : this.chat.verified;
                ...
                profileSearchCell = this;
                profileSearchCell.updateStatus(z2, badgesController.getBadge(tLObject), this.user, this.chat, true);
            }
            if ((!z && (MessagesController.UPDATE_MASK_NAME & i) != 0 && profileSearchCell.user != null) || ((MessagesController.UPDATE_MASK_CHAT_NAME & i) != 0 && profileSearchCell.chat != null)) {
                if (profileSearchCell.user != null) {
                    monoForumTitle2 = profileSearchCell.user.first_name + profileSearchCell.user.last_name;
                } else {
                    TLRPC.Chat chat3 = profileSearchCell.chat;
                    if (chat3.monoforum) {
                        monoForumTitle2 = ForumUtilities.getMonoForumTitle(profileSearchCell.currentAccount, chat3);
                    } else {
                        monoForumTitle2 = chat3.title;
                    }
                }
                if (!monoForumTitle2.equals(profileSearchCell.lastName)) {
                    z = true;
                }
            }
            if (!((z || !profileSearchCell.drawCount || (i & MessagesController.UPDATE_MASK_READ_DIALOG_MESSAGE) == 0 || (dialog = (TLRPC.Dialog) MessagesController.getInstance(profileSearchCell.currentAccount).dialogs_dict.get(profileSearchCell.dialog_id)) == null || MessagesController.getInstance(profileSearchCell.currentAccount).getDialogUnreadCount(dialog) == profileSearchCell.lastUnreadCount) ? z : true)) {
                return;
            }
        } else {
            profileSearchCell = this;
        }
        TLRPC.User user5 = profileSearchCell.user;
        if (user5 != null) {
            TLRPC.UserStatus userStatus2 = user5.status;
            if (userStatus2 != null) {
                profileSearchCell.lastStatus = userStatus2.expires;
            } else {
                profileSearchCell.lastStatus = 0;
            }
            profileSearchCell.lastName = profileSearchCell.user.first_name + profileSearchCell.user.last_name;
        } else {
            TLRPC.Chat chat4 = profileSearchCell.chat;
            if (chat4 != null) {
                if (chat4.monoforum) {
                    monoForumTitle = ForumUtilities.getMonoForumTitle(profileSearchCell.currentAccount, chat4);
                } else {
                    monoForumTitle = chat4.title;
                }
                profileSearchCell.lastName = monoForumTitle;
            }
        }
        profileSearchCell.lastAvatar = fileLocation2;
