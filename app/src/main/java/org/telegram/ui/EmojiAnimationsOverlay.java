...
public class EmojiAnimationsOverlay implements NotificationCenter.NotificationCenterDelegate {
            ...
            if (z9 || ((arrayList != null && !arrayList.isEmpty()) || z8)) {
                ...
                while (i3 < this.drawingObjects.size()) {
                    if (((DrawingObject) this.drawingObjects.get(i3)).messageId == i) {
                        i4++;
                        if (!z9 && (((DrawingObject) this.drawingObjects.get(i3)).imageReceiver.getLottieAnimation() == null || ((DrawingObject) this.drawingObjects.get(i3)).imageReceiver.getLottieAnimation().isGeneratingCache())) {
                            return z7;
                        }
                    }
                    if (((DrawingObject) this.drawingObjects.get(i3)).document == null || document == null) {
                        z5 = z7;
                        z6 = z8;
                    } else {
                        z5 = z7;
                        z6 = z8;
                        if (((DrawingObject) this.drawingObjects.get(i3)).document.id == document.id) {
                            i5++;
                        }
                    }
                    i3++;
                ...
                if (z9) {
                    ...
                    while (true) {
                        ...
                        document2 = (TLRPC.Document) availableEffects.documents.get(i6);
                    ...
                    if (z11) {
                        ...
                        if (messageObject != null && messageObject.isAnimatedAnimatedEmoji()) {
                            if (iAbs < 0 || iAbs > arrayList.size() - 1) {
                                ...
                                for (int i7 = z10 ? 1 : 0; i7 < arrayList.size(); i7++) {
                ...
                if (premiumStickerAnimation == null) {
                    ...
                    int i8 = iIntValue2 + 1;
                    this.lastAnimationIndex.put(Long.valueOf(document2.id), Integer.valueOf(i8));
                    ImageLocation forDocument = ImageLocation.getForDocument(document2);
                    drawingObject.imageReceiver.setUniqKeyPrefix(i8 + "_" + drawingObject.messageId + "_");
    ...
    /* JADX WARN: Code duplicated, block: B:31:0x008a A[SYNTHETIC] */
