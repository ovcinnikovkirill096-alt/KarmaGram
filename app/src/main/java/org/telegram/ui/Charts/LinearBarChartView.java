            ...
            while (i3 < this.lines.size()) {
                ...
                if (lineViewData.enabled || lineViewData.alpha != 0.0f) {
                    ...
                    while (iMax <= iMin) {
                        ...
                        if (j < 0) {
                            ...
                            if (!BaseChartView.USE_LINES) {
                                ...
                                fArr3[i5 + 8] = f17;
                                i5 += 10;
                                fArr3[i7] = (getMeasuredHeight() - this.chartBottom) - strokeWidth;
                            } else {
                    ...
                    if (i9 == 2) {
                        ...
                        if (BaseChartView.USE_LINES) {
                            float[] fArr5 = lineViewData.linesPath;
                            Paint paint = lineViewData.paint;
                            i = 0;
                            canvas.drawLines(fArr5, 0, i5, paint);
                        } else {
                    ...
                    if (BaseChartView.USE_LINES) {
                        ...
                        float[] fArr6 = lineViewData.linesPath;
                        Paint paint2 = lineViewData.paint;
                        i = 0;
                        canvas.drawLines(fArr6, 0, i5, paint2);
                    }
                    canvas.restore();
                } else {
                    f = f7;
                ...
                if (lineViewData.enabled || lineViewData.alpha != 0.0f) {
                    ...
                    while (i3 < length) {
                        ...
                        if (j < 0) {
                            ...
                            f2 = f4;
                            float f5 = chartData2.xPercentage[i3] * this.pickerWidth;
                            boolean z = BaseChartView.ANIMATE_PICKER_SIZES;
                            float f6 = z ? this.pickerMaxHeight : chartData2.maxValue;
                            float f7 = z ? this.pickerMinHeight : chartData2.minValue;
                            float f8 = (1.0f - ((j - f7) / (f6 - f7))) * this.pikerHeight;
                            if (!BaseChartView.USE_LINES) {
                                if (i3 == 0) {
                                    lineViewData.bottomLinePath.moveTo(f5 - (f3 / 2.0f), f8);
                                } else {
                                    lineViewData.bottomLinePath.lineTo(f5 - (f3 / 2.0f), f8);
                                }
                                lineViewData.bottomLinePath.lineTo(f5 + (f3 / 2.0f), f8);
                            } else if (i4 == 0) {
                    ...
                    if (lineViewData.enabled || lineViewData.alpha != f17) {
