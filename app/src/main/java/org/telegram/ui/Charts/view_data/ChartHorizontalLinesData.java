...
public class ChartHorizontalLinesData {
    ...
    /* JADX WARN: Code duplicated, block: B:81:0x00cb A[SYNTHETIC] */
    /* JADX WARN: Code duplicated, block: B:86:0x018b A[SYNTHETIC] */
                    ...
                    if (f > 0.0f) {
                        ...
                        if (z3) {
                            ...
                            if (f4 - j5 < 0.01f && i != 1 && i != 2) {
                                obj.valuesStr2[i5] = _UrlKt.FRAGMENT_ENCODE_SET;
                            } else {
                    ...
                    if (f > 0.0f) {
                        ...
                        if (z2) {
                            ...
                            if (f3 - j4 < 0.01f && i != 1 && i != 2) {
                                chartHorizontalLinesData.valuesStr2[i3] = _UrlKt.FRAGMENT_ENCODE_SET;
                            } else {
