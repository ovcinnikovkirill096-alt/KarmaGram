                ...
                if (lineViewData.enabled || lineViewData.alpha != 0.0f) {
                    ...
                    while (i3 < length) {
                        ...
                        if (j < 0) {
                            ...
                            float f2 = chartData.xPercentage[i3] * this.pickerWidth;
                            boolean z = BaseChartView.ANIMATE_PICKER_SIZES;
                            float f3 = z ? this.pickerMaxHeight : chartData.maxValue;
                            float f4 = z ? this.pickerMinHeight : chartData.minValue;
                            ...
                            if (BaseChartView.USE_LINES) {
                                ...
                                lineViewData.bottomLinePath.moveTo(f2, f5);
                            } else {
                                lineViewData.bottomLinePath.lineTo(f2, f5);
                            }
                        }
                        i3++;
                        jArr = jArr;
