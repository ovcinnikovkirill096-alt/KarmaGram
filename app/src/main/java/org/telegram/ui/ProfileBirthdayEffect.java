...
public class ProfileBirthdayEffect extends View {
    ...
    static class ImageReceiverAsset extends ImageReceiver {
        ...
        class AnonymousClass1 implements ImageReceiver.ImageReceiverDelegate {
            ...
            public void didSetImage(ImageReceiver imageReceiver, boolean z, boolean z2, boolean z3) {
                ...
                if (lottieAnimation == null) {
                    ...
                    lottieAnimation.whenCacheDone = new Runnable() { // from class: org.telegram.ui.ProfileBirthdayEffect$ImageReceiverAsset$1$$ExternalSyntheticLambda0
                        @Override // java.lang.Runnable
                        public final void run() {
                            ProfileBirthdayEffect.ImageReceiverAsset.AnonymousClass1.m16485$r8$lambda$KpChqogLAmWFbTAkMrzQEJILDc(runnableArr);
                        }
                    };
                } else {
                    this.val$callback[0].run();
            ...
            public static /* synthetic */ void m16485$r8$lambda$KpChqogLAmWFbTAkMrzQEJILDc(Runnable[] runnableArr) {
                runnableArr[0].run();
                runnableArr[0] = null;
            }
        }
