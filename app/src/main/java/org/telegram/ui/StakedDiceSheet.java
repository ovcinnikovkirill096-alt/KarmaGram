...
public class StakedDiceSheet extends BottomSheetWithRecyclerListView {
    ...
    public StakedDiceSheet(final Context context, final int i, final Theme.ResourcesProvider resourcesProvider, final Utilities.Callback callback) {
        ...
        Utilities.Callback2Return callback2Return = new Utilities.Callback2Return() { // from class: org.telegram.ui.StakedDiceSheet$$ExternalSyntheticLambda4
            ...
            public final Object run(Object obj, Object obj2) {
                return StakedDiceSheet.m17016$r8$lambda$Avzvs7HEBCdkCHlzfUQfHJlva8(context, iArr, resourcesProvider, tableView, (Integer) obj, (Float) obj2);
            }
        };
        float f = 1.0f;
        ...
        Utilities.CallbackReturn callbackReturn = new Utilities.CallbackReturn() { // from class: org.telegram.ui.StakedDiceSheet$$ExternalSyntheticLambda6
            ...
            public final Object run(Object obj) {
                return StakedDiceSheet.m17017$r8$lambda$U3QzNjIEL4Nod70FOH84Lt4RXk(context, resourcesProvider, editTextBoldCursor, (Long) obj);
            }
        };
    ...
    public static /* synthetic */ TableView.TableRowContent m17016$r8$lambda$Avzvs7HEBCdkCHlzfUQfHJlva8(Context context, int[] iArr, Theme.ResourcesProvider resourcesProvider, TableView tableView, Integer num, Float f) {
        LinearLayout linearLayout = new LinearLayout(context);
        linearLayout.setOrientation(1);
        LinearLayout linearLayout2 = new LinearLayout(context);
    ...
    public static /* synthetic */ View m17017$r8$lambda$U3QzNjIEL4Nod70FOH84Lt4RXk(Context context, Theme.ResourcesProvider resourcesProvider, final EditTextBoldCursor editTextBoldCursor, final Long l) {
        TextView textView = new TextView(context);
        textView.setGravity(17);
        textView.setTextSize(1, 13.0f);
