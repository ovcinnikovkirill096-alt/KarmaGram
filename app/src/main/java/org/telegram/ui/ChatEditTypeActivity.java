...
public class ChatEditTypeActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate {
    ...
    */
    public boolean onFragmentCreate() {
        ...
        if (chat == null) {
            ...
            if (chatSync != null) {
                ...
                if (this.info == null) {
                    TLRPC.ChatFull chatFullLoadChatInfo = getMessagesStorage().loadChatInfo(this.chatId, ChatObject.isChannel(this.currentChat), new CountDownLatch(1), false, false);
                    this.info = chatFullLoadChatInfo;
                }
            }
            return false;
        }
        this.isPrivate = (this.isForcePublic || ChatObject.isPublic(this.currentChat)) ? false : true;
        this.isChannel = ChatObject.isChannel(this.currentChat) && !this.currentChat.megagroup;
        TLRPC.Chat chat2 = this.currentChat;
        this.isSaveRestricted = chat2.ayuNoforwards;
        if ((this.isForcePublic && !ChatObject.isPublic(chat2)) || (this.isPrivate && this.currentChat.creator)) {
            TLRPC.TL_channels_checkUsername tL_channels_checkUsername = new TLRPC.TL_channels_checkUsername();
            tL_channels_checkUsername.username = "1";
            tL_channels_checkUsername.channel = new TLRPC.TL_inputChannelEmpty();
            getConnectionsManager().sendRequest(tL_channels_checkUsername, new RequestDelegate() { // from class: org.telegram.ui.ChatEditTypeActivity$$ExternalSyntheticLambda2
        ...
        if (this.currentChat != null) {
            this.editableUsernames.clear();
            this.usernames.clear();
            for (int i = 0; i < this.currentChat.usernames.size(); i++) {
                if (((TLRPC.TL_username) this.currentChat.usernames.get(i)).active) {
                    this.usernames.add((TLRPC.TL_username) this.currentChat.usernames.get(i));
                }
            }
            for (int i2 = 0; i2 < this.currentChat.usernames.size(); i2++) {
                if (!((TLRPC.TL_username) this.currentChat.usernames.get(i2)).active) {
                    this.usernames.add((TLRPC.TL_username) this.currentChat.usernames.get(i2));
                }
            }
        }
    ...
    class AnonymousClass6 extends TextInfoPrivacyCell {
            ...
            if (this.prevHeight != -1 && ChatEditTypeActivity.this.linearLayout != null) {
                ...
                valueAnimatorOfFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: org.telegram.ui.ChatEditTypeActivity$6$$ExternalSyntheticLambda0
                    ...
                    public final void onAnimationUpdate(ValueAnimator valueAnimator2) {
                        ChatEditTypeActivity.AnonymousClass6.m7019$r8$lambda$5iypMHzfd2L8oljr3QXR7PEQpM(arrayList, height, valueAnimator2);
                    }
                });
        ...
        public static /* synthetic */ void m7019$r8$lambda$5iypMHzfd2L8oljr3QXR7PEQpM(ArrayList arrayList, float f, ValueAnimator valueAnimator) {
    ...
    class UsernamesListView extends RecyclerListView {
        ...
        public static /* synthetic */ void m7020$r8$lambda$oQEsyq3f16mseGL6oDuSzZA71Y(TLObject tLObject, TLRPC.TL_error tL_error) {
        }
        ...
        public void sendReorder() {
            ...
            ChatEditTypeActivity.this.getConnectionsManager().sendRequest(tL_channels_reorderUsernames, new RequestDelegate() { // from class: org.telegram.ui.ChatEditTypeActivity$UsernamesListView$$ExternalSyntheticLambda0
                @Override // org.telegram.tgnet.RequestDelegate
                public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
                    ChatEditTypeActivity.UsernamesListView.m7020$r8$lambda$oQEsyq3f16mseGL6oDuSzZA71Y(tLObject, tL_error);
                }
            });
            updateChat();
        }
