...
public class ChatbotsActivity extends BaseFragment {
    ...
    /* JADX INFO: renamed from: org.telegram.ui.Business.ChatbotsActivity$5, reason: invalid class name */
    ...
    public void fillItems(ArrayList arrayList, UniversalAdapter universalAdapter) {
        ...
        if (user != null) {
            ...
            int i = 0;
            boolean z2 = false;
            while (i < this.searchHelper.getLocalServerSearch().size()) {
            ...
            int i2 = 0;
            boolean z3 = z2;
            while (i2 < this.searchHelper.getGlobalSearch().size()) {
            ...
            z4 = z3;
            this.editTextDivider.setVisibility(z4 ? 0 : 8);
        ...
        if (this.selectedBot != null) {
            ...
            arrayList.add(UItem.asExpandableSwitch(PERMISSION_STORIES, LocaleController.getString(R.string.BusinessBotPermissionsStories), _UrlKt.FRAGMENT_ENCODE_SET).setChecked(this.rights.manage_stories).setClickCallback(new View.OnClickListener() { // from class: org.telegram.ui.Business.ChatbotsActivity$$ExternalSyntheticLambda21
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
