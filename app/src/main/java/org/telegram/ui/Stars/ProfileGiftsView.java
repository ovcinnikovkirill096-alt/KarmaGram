...
public class ProfileGiftsView extends View implements NotificationCenter.NotificationCenterDelegate {
    ...
    /* JADX WARN: Code duplicated, block: B:32:0x0188  */
    /* JADX WARN: Code duplicated, block: B:36:0x0194  */
    /* JADX WARN: Code duplicated, block: B:39:0x01a0  */
    /* JADX WARN: Code duplicated, block: B:40:0x01a3  */
    /* JADX WARN: Code duplicated, block: B:43:0x01b4  */
    /* JADX WARN: Code duplicated, block: B:49:0x01ce A[SYNTHETIC] */
    @Override // android.view.View
    protected void dispatchDraw(Canvas canvas) {
        ...
        float f5 = fMin2 + (fMax2 / 2.0f);
        float f6 = (fMax3 / 2.0f) + fMax;
        float f7 = x + (width / 2.0f);
        float f8 = y + (height / 2.0f);
        float f9 = this.expandY;
        float f10 = f9 / this.maxExpandY;
        float fClamp02 = Utilities.clamp01((f9 - (AndroidUtilities.statusBarHeight + ActionBar.getCurrentActionBarHeight())) / AndroidUtilities.dp(50.0f));
        int i = 0;
        while (i < this.gifts.size()) {
            Gift gift = (Gift) this.gifts.get(i);
            float f11 = gift.animatedFloat.set(f3);
            float fLerp3 = AndroidUtilities.lerp(0.5f, f3, f11);
            float f12 = f3;
            float f13 = f4;
            float f14 = (f12 - this.expandProgress) * f11 * (f12 - this.actionBarProgress) * fClamp02;
            int i2 = gift.position;
            if (i2 == 0) {
                fDp = (f5 / f13) - (AndroidUtilities.dp(20.0f) * f10);
                iDp = AndroidUtilities.dp(13.0f);
            } else {
                if (i2 == 1) {
                    fLerp2 = ((f5 * f13) / 3.0f) - (AndroidUtilities.dp(6.0f) * f10);
                    fLerp = fMax - AndroidUtilities.dp(4.0f);
                } else {
                    if (i2 == 2) {
                        float fDp2 = ((f5 * f13) / 3.0f) - (AndroidUtilities.dp(12.0f) * f10);
                        ...
                        fDp = (1.5f * f5) + (AndroidUtilities.dp(20.0f) * f10);
                        iDp = AndroidUtilities.dp(13.0f);
                    } else if (i2 == 4) {
                        float f15 = fClamp02;
                        fLerp2 = ((f5 * 4.0f) / 3.0f) + (AndroidUtilities.dp(12.0f) * f10);
                        fLerp = fMax - AndroidUtilities.dp(4.0f);
                        f = 0.9f;
                        fClamp02 = f15;
                        f10 = f10;
                    } else {
                        float fDp3 = ((4.0f * f5) / 3.0f) + (AndroidUtilities.dp(12.0f) * f10);
                        fLerp = (fMax + fMax3) - AndroidUtilities.dp(16.0f);
                        fLerp2 = fDp3;
                    }
                    if (!this.isOpening || f11 >= f12) {
                        fMin = this.collapseProgress;
                    } else {
                        fMin = Math.min(f11, this.collapseProgress);
                    }
                    f2 = f * 0.2f;
                    if (fMin >= f12 - f2) {
                        fClamp01 = f12;
                    ...
                    if (fClamp01 < f12) {
                        fLerp2 = AndroidUtilities.lerp(f7, fLerp2, this.giftCollapseXInterpolator.getInterpolation(fClamp01));
                        fLerp = AndroidUtilities.lerp(f8, fLerp, this.giftCollapseYInterpolator.getInterpolation(fClamp01));
                        fLerp3 = AndroidUtilities.lerp(fLerp3 / f13, fLerp3, fClamp01);
                    }
                    gift.draw(canvas2, fLerp2, fLerp, fLerp3, 0.0f, f14, 1.0f);
                    i++;
                    canvas2 = canvas;
                    f3 = f12;
                    f4 = f13;
