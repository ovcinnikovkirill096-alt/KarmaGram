...
public class StarReactionsOverlay extends View {
    ...
    protected void dispatchDraw(Canvas canvas) {
        ...
        int i4 = iArr4[r3];
        int[] iArr5 = this.pos2;
        canvas.translate(i4 - iArr5[r3], (iArr4[1] - iArr5[1]) + this.cell.getPaddingTop());
        BaseCell baseCell2 = this.cell;
        if (baseCell2 instanceof ChatMessageCell) {
    ...
    public void tap(float f, float f2, boolean z, boolean z2) {
        ...
        if (z2) {
            ...
            this.accumulatedRippleIntensity *= Utilities.clamp(1.0f - (((jCurrentTimeMillis - j) - 100) / 200.0f), 1.0f, 0.0f);
