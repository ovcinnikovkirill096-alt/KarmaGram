...
public class NotificationsCustomSettingsActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate {
    ...
    public /* synthetic */ void lambda$createView$17(Context context, final View view, final int i, float f, float f2) {
        ...
        int i2 = this.currentType;
        if (i2 == 3 && itemInner != null && (notificationException3 = itemInner.exception) != null) {
            ItemOptions.makeOptions(this, view).setGravity(3).addIf(notificationException3.notify <= 0 || notificationException3.auto, R.drawable.msg_mute, (CharSequence) LocaleController.getString(R.string.NotificationsStoryMute), false, new Runnable() { // from class: org.telegram.ui.NotificationsCustomSettingsActivity$$ExternalSyntheticLambda6
                ...
                public final void run() {
                    this.f$0.lambda$createView$1(notificationException3, view, i);
                }
            }).addIf(notificationException3.notify > 0 || notificationException3.auto, R.drawable.msg_unmute, (CharSequence) LocaleController.getString(R.string.NotificationsStoryUnmute), false, new Runnable() { // from class: org.telegram.ui.NotificationsCustomSettingsActivity$$ExternalSyntheticLambda12
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.lambda$createView$2(notificationException3, view, i);
                }
            }).addIf(!notificationException3.auto, R.drawable.msg_delete, (CharSequence) LocaleController.getString("DeleteException", R.string.DeleteException), true, new Runnable() { // from class: org.telegram.ui.NotificationsCustomSettingsActivity$$ExternalSyntheticLambda13
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.lambda$createView$3(notificationException3, view, i);
                }
            ...
            if (adapter == searchAdapter) {
                ...
                if (object instanceof NotificationsSettingsActivity.NotificationException) {
                    ...
                    if (this.exceptionsDict.containsKey(Long.valueOf(j2))) {
                        ...
                        z4 = true;
                        notificationException2 = notificationException4;
                    }
                    if (notificationException2 == null) {
                        return;
                    }
                    ItemOptions gravity = ItemOptions.makeOptions(this, view).setGravity(3);
                    if (notificationException2.notify > 0 || notificationException2.auto) {
                        z5 = true;
                    } else {
                        z5 = false;
                    }
                    ItemOptions itemOptionsAddIf = gravity.addIf(z5, R.drawable.msg_mute, (CharSequence) LocaleController.getString(R.string.NotificationsStoryMute), false, new Runnable() { // from class: org.telegram.ui.NotificationsCustomSettingsActivity$$ExternalSyntheticLambda14
                        @Override // java.lang.Runnable
                        public final void run() {
                            this.f$0.lambda$createView$4(notificationException2, view, z4);
                        }
                    });
                    if (notificationException2.notify <= 0 || notificationException2.auto) {
                        z6 = true;
                    ...
                    ItemOptions itemOptionsAddIf2 = itemOptionsAddIf.addIf(z6, R.drawable.msg_unmute, (CharSequence) LocaleController.getString(R.string.NotificationsStoryUnmute), false, new Runnable() { // from class: org.telegram.ui.NotificationsCustomSettingsActivity$$ExternalSyntheticLambda15
                        @Override // java.lang.Runnable
                        public final void run() {
                            this.f$0.lambda$createView$5(notificationException2, view, z4);
                        }
                    });
                    if (!z4 || notificationException2.auto) {
                        z7 = false;
                    } else {
                        z7 = true;
                    }
                    itemOptionsAddIf2.addIf(z7, R.drawable.msg_delete, (CharSequence) LocaleController.getString("DeleteException", R.string.DeleteException), true, new Runnable() { // from class: org.telegram.ui.NotificationsCustomSettingsActivity$$ExternalSyntheticLambda16
                        @Override // java.lang.Runnable
                        public final void run() {
                            this.f$0.lambda$createView$6(notificationException2, view, i);
                        }
                    }).setScrimViewBackground(this.listView.getClipBackground(view)).show();
                    return;
                }
                ...
                ItemOptions itemOptionsAddIf3 = gravity2.addIf(z5, R.drawable.msg_mute, (CharSequence) LocaleController.getString(R.string.NotificationsStoryMute), false, new Runnable() { // from class: org.telegram.ui.NotificationsCustomSettingsActivity$$ExternalSyntheticLambda14
                    @Override // java.lang.Runnable
                    public final void run() {
                        this.f$0.lambda$createView$4(notificationException2, view, z4);
                    }
                ...
                ItemOptions itemOptionsAddIf4 = itemOptionsAddIf3.addIf(z6, R.drawable.msg_unmute, (CharSequence) LocaleController.getString(R.string.NotificationsStoryUnmute), false, new Runnable() { // from class: org.telegram.ui.NotificationsCustomSettingsActivity$$ExternalSyntheticLambda15
                    @Override // java.lang.Runnable
                    public final void run() {
                        this.f$0.lambda$createView$5(notificationException2, view, z4);
                    }
                ...
                itemOptionsAddIf4.addIf(z7, R.drawable.msg_delete, (CharSequence) LocaleController.getString("DeleteException", R.string.DeleteException), true, new Runnable() { // from class: org.telegram.ui.NotificationsCustomSettingsActivity$$ExternalSyntheticLambda16
                    @Override // java.lang.Runnable
                    public final void run() {
                        this.f$0.lambda$createView$6(notificationException2, view, i);
                    }
        ...
        if (this.listView.getAdapter() == this.searchAdapter || !(itemInner == null || itemInner.exception == null)) {
            ...
            if (adapter2 == searchAdapter2) {
                ...
                if (object2 instanceof NotificationsSettingsActivity.NotificationException) {
                    ...
                    if (this.exceptionsDict.containsKey(Long.valueOf(j))) {
                        notificationException = (NotificationsSettingsActivity.NotificationException) this.exceptionsDict.get(Long.valueOf(j));
                        z8 = false;
                    } else {
                        ...
                        if (z10) {
                            notificationException5.did = ((TLRPC.User) object2).id;
                        } else {
                            notificationException5.did = -((TLRPC.Chat) object2).id;
                        }
                        notificationException = notificationException5;
                    }
            ...
            final NotificationsSettingsActivity.NotificationException notificationException6 = notificationException;
            if (notificationException6 == null) {
                return;
            }
            final long j3 = notificationException6.did;
            ...
            ChatNotificationsPopupWrapper chatNotificationsPopupWrapper = new ChatNotificationsPopupWrapper(context, this.currentAccount, null, true, true, new ChatNotificationsPopupWrapper.Callback() { // from class: org.telegram.ui.NotificationsCustomSettingsActivity.3
                ...
                private void setNotDefault() {
                    ...
                    notificationException6.hasCustom = notificationsSettings.getBoolean(NotificationsSettingsFacade.PROPERTY_CUSTOM + notificationException6.did, false);
                    notificationException6.notify = notificationsSettings.getInt(NotificationsSettingsFacade.PROPERTY_NOTIFY + notificationException6.did, 0);
                    if (notificationException6.notify != 0) {
                        int i3 = notificationsSettings.getInt(NotificationsSettingsFacade.PROPERTY_NOTIFY_UNTIL + notificationException6.did, -1);
                        if (i3 != -1) {
                            notificationException6.muteUntil = i3;
                        }
                    }
                    if (z) {
                        NotificationsCustomSettingsActivity.this.exceptions.add(notificationException6);
                        NotificationsCustomSettingsActivity.this.exceptionsDict.put(Long.valueOf(notificationException6.did), notificationException6);
                ...
                public void setDefault() {
                    ...
                    if (arrayList2 != NotificationsCustomSettingsActivity.this.exceptions && (iIndexOf = NotificationsCustomSettingsActivity.this.exceptions.indexOf(notificationException6)) >= 0) {
                        NotificationsCustomSettingsActivity.this.exceptions.remove(iIndexOf);
                        NotificationsCustomSettingsActivity.this.exceptionsDict.remove(Long.valueOf(notificationException6.did));
                    }
                    arrayList2.remove(notificationException6);
        ...
        if (i3 == 6) {
            ...
            dialogsActivity.setDelegate(new DialogsActivity.DialogsActivityDelegate() { // from class: org.telegram.ui.NotificationsCustomSettingsActivity$$ExternalSyntheticLambda17
                ...
                public final boolean didSelectDialogs(DialogsActivity dialogsActivity2, ArrayList arrayList3, CharSequence charSequence, boolean z11, boolean z12, int i5, int i6, TopicsFragment topicsFragment) {
                    return this.f$0.lambda$createView$8(dialogsActivity2, arrayList3, charSequence, z11, z12, i5, i6, topicsFragment);
                }
        ...
        if (i3 == 100 || i3 == 101) {
            boolean zIsGlobalNotificationsEnabled2 = getNotificationsController().isGlobalNotificationsEnabled(this.currentType);
            ...
            if (this.storiesAuto && z11) {
                ...
                editorEdit.putBoolean("EnableAllStories", !z11);
                this.storiesEnabled = Boolean.valueOf(!z11);
            }
            editorEdit.apply();
        ...
        if (i3 == 1) {
            if (view.isEnabled()) {
                ...
                showDialog(AlertsCreator.createVibrationSelectDialog(getParentActivity(), 0L, 0L, str, new Runnable() { // from class: org.telegram.ui.NotificationsCustomSettingsActivity$$ExternalSyntheticLambda8
                    @Override // java.lang.Runnable
                    public final void run() {
                        this.f$0.lambda$createView$13(view, str, i);
                    }
                }));
                return;
            }
        ...
        if (i3 == 103 || i3 == 104) {
            boolean z12 = !LocaleController.isRTL ? f <= ((float) (view.getMeasuredWidth() - AndroidUtilities.dp(76.0f))) : f >= ((float) AndroidUtilities.dp(76.0f));
    ...
    /* JADX WARN: Code duplicated, block: B:155:0x0365  */
    /* JADX WARN: Code duplicated, block: B:158:0x0370  */
    /* JADX WARN: Code duplicated, block: B:162:0x037f A[LOOP:5: B:161:0x037d->B:162:0x037f, LOOP_END] */
    /* JADX WARN: Code duplicated, block: B:165:0x0399  */
    /* JADX WARN: Code duplicated, block: B:167:0x03a3  */
    /* JADX WARN: Code duplicated, block: B:168:0x03b2  */
    /* JADX WARN: Code duplicated, block: B:219:0x035b A[ADDED_TO_REGION, REMOVE, SYNTHETIC] */
    /* JADX WARN: Code duplicated, block: B:226:0x0375 A[SYNTHETIC] */
    ...
    public /* synthetic */ void lambda$loadExceptions$20(ArrayList arrayList) {
        ...
        while (true) {
            ...
            if (key.startsWith(NotificationsSettingsFacade.PROPERTY_NOTIFY)) {
                ...
                if (jLongValue == 0 || jLongValue == j) {
                    ...
                    arrayList10 = arrayList21;
                    notificationException.hasCustom = notificationsSettings.getBoolean(NotificationsSettingsFacade.PROPERTY_CUSTOM + jLongValue, false);
                    ...
                    if (DialogObject.isEncryptedDialog(jLongValue)) {
                        ...
                        if (chat2 == null) {
                            arrayList17.add(Long.valueOf(j2));
                            longSparseArray.put(jLongValue, notificationException);
                        } else if (!chat2.left && !chat2.kicked && chat2.migrated_to == null) {
                            if (ChatObject.isChannel(chat2) && !chat2.megagroup) {
                                arrayList15.add(notificationException);
                            } else {
        ...
        final ArrayList arrayList30 = arrayList29;
        final ArrayList arrayList31 = arrayList25;
            ...
            try {
                if (arrayList18.isEmpty()) {
                    ...
                    try {
                        arrayList4 = arrayList28;
                        try {
                            getMessagesStorage().getEncryptedChatsInternal(TextUtils.join(",", arrayList18), arrayList4, arrayList16);
                        } catch (Exception e) {
                            e = e;
                            ...
                            for (i4 = 0; i4 < size4; i4++) {
                                if (DialogObject.isChatDialog(longSparseArray.keyAt(i4))) {
                                    ...
                                    arrayList15.remove(longSparseArray.valueAt(i4));
                                } else {
                            ...
                            AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.NotificationsCustomSettingsActivity$$ExternalSyntheticLambda4
                                @Override // java.lang.Runnable
                                public final void run() {
                                    this.f$0.lambda$loadExceptions$19(arrayList32, arrayList2, arrayList33, arrayList11, arrayList12, arrayList30, arrayList31, arrayList15);
                                }
                            });
                        }
                    } catch (Exception e2) {
                        ...
                        AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.NotificationsCustomSettingsActivity$$ExternalSyntheticLambda4
                            @Override // java.lang.Runnable
                            public final void run() {
                                this.f$0.lambda$loadExceptions$19(arrayList34, arrayList2, arrayList35, arrayList11, arrayList12, arrayList30, arrayList31, arrayList15);
                            }
                        });
                    }
                }
                if (arrayList16.isEmpty()) {
                    ...
                    try {
                        arrayList3 = arrayList26;
                        try {
                            getMessagesStorage().getUsersInternal(arrayList16, arrayList3);
                        } catch (Exception e3) {
                            e = e3;
                            arrayList2 = arrayList27;
                            FileLog.e(e);
                            ...
                            AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.NotificationsCustomSettingsActivity$$ExternalSyntheticLambda4
                                @Override // java.lang.Runnable
                                public final void run() {
                                    this.f$0.lambda$loadExceptions$19(arrayList36, arrayList2, arrayList37, arrayList11, arrayList12, arrayList30, arrayList31, arrayList15);
                                }
                            });
                        }
                    } catch (Exception e4) {
                        ...
                        AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.NotificationsCustomSettingsActivity$$ExternalSyntheticLambda4
                            @Override // java.lang.Runnable
                            public final void run() {
                                this.f$0.lambda$loadExceptions$19(arrayList38, arrayList2, arrayList39, arrayList11, arrayList12, arrayList30, arrayList31, arrayList15);
                            }
                        });
                    }
                }
                ...
                if (chat.left && !chat.kicked && chat.migrated_to == null) {
                    ...
                    if (notificationException4 != null) {
                        if (ChatObject.isChannel(chat) && !chat.megagroup) {
                            arrayList15.add(notificationException4);
                        } else {
        ...
        AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.NotificationsCustomSettingsActivity$$ExternalSyntheticLambda4
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.lambda$loadExceptions$19(arrayList310, arrayList2, arrayList311, arrayList11, arrayList12, arrayList30, arrayList31, arrayList15);
            }
        });
    }
    ...
    class SearchAdapter extends RecyclerListView.SelectionAdapter {
        ...
        /* JADX WARN: Code duplicated, block: B:84:0x01dc A[LOOP:1: B:54:0x0138->B:84:0x01dc, LOOP_END] */
        /* JADX WARN: Code duplicated, block: B:90:0x01ea A[EDGE_INSN: B:90:0x01ea->B:85:0x01ea BREAK  A[LOOP:1: B:54:0x0138->B:84:0x01dc], SYNTHETIC] */
        /* JADX WARN: Code duplicated, block: B:92:0x019b A[SYNTHETIC] */
        /* JADX WARN: Code duplicated, block: B:93:0x00d2 A[SYNTHETIC] */
        /* JADX WARN: Instruction removed from duplicated block: B:59:0x014c, please report this as an issue */
        /* JADX WARN: Instruction removed from duplicated block: B:67:0x0173, please report this as an issue */
        /* JADX WARN: Instruction removed from duplicated block: B:80:0x01a9, please report this as an issue */
        public /* synthetic */ void lambda$processSearch$2(String str, ArrayList arrayList) {
            ...
            int i8 = 1;
            int i9 = 0;
            int i10 = (translitString2 != null ? 1 : 0) + 1;
            ...
            while (i11 < arrayList.size()) {
                NotificationsSettingsActivity.NotificationException notificationException = (NotificationsSettingsActivity.NotificationException) arrayList.get(i11);
                if (DialogObject.isEncryptedDialog(notificationException.did)) {
                    ...
                    if (encryptedChat != null) {
                        ...
                        if (user != null) {
                            strArr[i] = ContactsController.formatName(user.first_name, user.last_name);
                            strArr[i8] = UserObject.getPublicUsername(user);
                        }
                    } else {
                        i = i9;
                    }
                    ...
                    if (DialogObject.isUserDialog(notificationException.did)) {
                        ...
                        if (user2 != null && !user2.deleted) {
                            strArr[i] = ContactsController.formatName(user2.first_name, user2.last_name);
                            strArr[i8] = UserObject.getPublicUsername(user2);
                            obj = user2;
                            str2 = strArr[i];
                            strArr[i] = str2.toLowerCase();
                            translitString = LocaleController.getInstance().getTranslitString(strArr[i]);
                            str3 = strArr[i];
                                        ...
                                        if (str5.startsWith(str4)) {
                                            ...
                                            if (i7 != 0) {
                                                ...
                                                if (i7 == i3) {
                                                    ...
                                                    arrayList4.add(AndroidUtilities.generateSearchName("@" + strArr[i3], null, "@" + str4));
                                                }
                        ...
                        if (chat != null) {
                            if (!chat.left && !chat.kicked && chat.migrated_to == null) {
                                strArr[i] = chat.title;
                                strArr[i8] = ChatObject.getPublicUsername(chat);
                                obj = chat;
                            }
                            i11++;
                            i8 = i3;
