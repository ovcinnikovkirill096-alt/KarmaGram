...
public class DialogsAdapter extends RecyclerListView.SelectionAdapter implements DialogCell.DialogCellDelegate {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        ...
        switch (i) {
            ...
            case 21:
                ...
                if (i2 == 2 || i2 == 15) {
                    ...
                    if (showOpenBotButton()) {
                        dialogCell.allowBotOpenButton(true, new Utilities.Callback() { // from class: org.telegram.ui.Adapters.DialogsAdapter$$ExternalSyntheticLambda3
            ...
            case 16:
                ...
                break;
            case 17:
                dialogMeUrlCell = new DialogsHintCell(this.mContext);
                break;
            case 18:
                ...
                break;
            case 19:
                LastEmptyView lastEmptyView = new LastEmptyView(this.mContext);
                lastEmptyView.addView(new ArchiveHelp(this.mContext, this.currentAccount, null, new Runnable() { // from class: org.telegram.ui.Adapters.DialogsAdapter$$ExternalSyntheticLambda5
                    @Override // java.lang.Runnable
                    public final void run() {
                        this.f$0.onArchiveSettingsClick();
                    }
                }, null), LayoutHelper.createFrame(-1, -1.0f, 17, 0.0f, -40.0f, 0.0f, 0.0f));
                dialogMeUrlCell = lastEmptyView;
                break;
            case 20:
    ...
    public class LastEmptyView extends FrameLayout {
        ...
        /* JADX WARN: Code duplicated, block: B:75:0x016c A[PHI: r13
  0x016c: PHI (r13v9 int) = (r13v7 int), (r13v16 int) binds: [B:87:0x0199, B:74:0x016a] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    /* JADX WARN: Code duplicated, block: B:186:0x0411  */
    /* JADX WARN: Code duplicated, block: B:188:0x0415 A[ADDED_TO_REGION] */
    /* JADX WARN: Code duplicated, block: B:195:0x0439 A[LOOP:2: B:195:0x0439->B:204:0x0460, LOOP_START, PHI: r4
  0x0439: PHI (r4v2 int) = (r4v1 int), (r4v4 int) binds: [B:194:0x0437, B:204:0x0460] A[DONT_GENERATE, DONT_INLINE]] */
    /* JADX WARN: Code duplicated, block: B:197:0x0441  */
    /* JADX WARN: Code duplicated, block: B:205:0x0462 A[ORIG_RETURN, RETURN] */
        ...
        if (this.collapsedView || this.isTransitionSupport) {
            for (int i11 = 0; i11 < dialogsArray.size(); i11++) {
                if (this.dialogsType == 2 && (dialogsArray.get(i11) instanceof DialogsActivity.DialogsHeader)) {
                    this.itemInternals.add(new ItemInternal(14, (TLRPC.Dialog) dialogsArray.get(i11)));
                } else {
                    this.itemInternals.add(new ItemInternal(0, (TLRPC.Dialog) dialogsArray.get(i11)));
                }
            }
            ...
            if (!z) {
                for (i2 = 0; i2 < dialogsArray.size(); i2++) {
                    if (this.dialogsType != 2 && (dialogsArray.get(i2) instanceof DialogsActivity.DialogsHeader)) {
                        this.itemInternals.add(new ItemInternal(14, (TLRPC.Dialog) dialogsArray.get(i2)));
                    } else {
                        this.itemInternals.add(new ItemInternal(0, (TLRPC.Dialog) dialogsArray.get(i2)));
                    }
                }
