...
public class PinchToZoomHelper {
    ...
    public void startZoom(View view, ImageReceiver imageReceiver, View view2, View view3, MessageObject messageObject, int i) {
        ...
        if (AyuConfig.semiTransparentDeletedMessages && this.overlayView != null) {
            View child = getChild();
            if (child instanceof ChatMessageCell) {
                ChatMessageCell chatMessageCell = (ChatMessageCell) child;
                if (!chatMessageCell.ayuDeleted || chatMessageCell.getMessageObject() == null || chatMessageCell.getMessageObject().skipAyuFiltering) {
                    f = 1.0f;
                } else {
                    f = 0.7f;
                }
        ...
        if (!this.isSimple) {
            ...
            float f2 = this.fullImageHeight;
            float f3 = f2 / bitmapWidth;
            float f4 = this.imageHeight;
            float f5 = this.imageWidth;
            if (f3 == f4 / f5) {
                this.fullImageHeight = f4;
                this.fullImageWidth = f5;
            } else if (f2 / bitmapWidth < f4 / f5) {
                this.fullImageWidth = (bitmapWidth / f2) * f4;
                this.fullImageHeight = f4;
            } else {
                this.fullImageHeight = (f2 / bitmapWidth) * f5;
                this.fullImageWidth = f5;
            }
