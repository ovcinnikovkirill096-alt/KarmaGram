...
public class MenuDrawable extends Drawable {
    ...
    /* JADX WARN: Code duplicated, block: B:100:0x0498  */
    ...
    /* JADX WARN: Code duplicated, block: B:62:0x02b1  */
    /* JADX WARN: Code duplicated, block: B:65:0x0349  */
    /* JADX WARN: Code duplicated, block: B:66:0x035a  */
    /* JADX WARN: Code duplicated, block: B:77:0x03a8  */
    /* JADX WARN: Code duplicated, block: B:80:0x03c4  */
    /* JADX WARN: Code duplicated, block: B:82:0x03c8  */
    /* JADX WARN: Code duplicated, block: B:84:0x03d9  */
    /* JADX WARN: Code duplicated, block: B:85:0x03e8  */
    /* JADX WARN: Code duplicated, block: B:89:0x040d  */
    /* JADX WARN: Code duplicated, block: B:91:0x0411  */
    /* JADX WARN: Code duplicated, block: B:93:0x0421  */
    /* JADX WARN: Code duplicated, block: B:94:0x042f  */
    /* JADX WARN: Code duplicated, block: B:97:0x0487  */
    /* JADX WARN: Code duplicated, block: B:99:0x0491  */
    @Override // android.graphics.drawable.Drawable
    public void draw(Canvas canvas) {
        ...
        if (i11 == i12) {
            ...
            if ((i3 == i4 && this.currentRotation != 1.0f) || (this.previousType != i4 && this.typeAnimationProgress != 1.0f)) {
                ...
                float f20 = this.currentRotation;
                canvas2.scale(1.0f - f20, 1.0f - f20, fDp6, f8);
        ...
        if (i3 == i4) {
            ...
            canvas2.scale(1.0f - f22, 1.0f - f22, fDp6, f8);
            if (this.type == TYPE_DEFAULT) {
                f9 *= 1.0f - this.typeAnimationProgress;
            }
            this.backPaint.setColor(i2);
            ...
            f8 = -AndroidUtilities.dp(4.5f);
            f9 = AndroidUtilities.density * 5.5f;
            float f25 = this.currentRotation;
            canvas2.scale(1.0f - f25, 1.0f - f25, fDp6, f8);
            if (this.type == TYPE_DEFAULT) {
                f9 *= 1.0f - this.typeAnimationProgress;
            }
            this.backPaint.setColor(i2);
