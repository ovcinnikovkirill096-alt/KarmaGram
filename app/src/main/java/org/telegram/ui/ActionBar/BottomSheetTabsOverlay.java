...
public class BottomSheetTabsOverlay extends View {
    ...
    public static /* synthetic */ void $r8$lambda$hXGnNPWO7I1wkl5xjJT0SgMoWSw(Sheet sheet) {
        if (sheet == null || sheet.mo4945getWindowView() == null) {
            return;
        }
        sheet.mo4945getWindowView().setDrawingFromOverlay(true);
    }
    ...
    /* JADX INFO: renamed from: org.telegram.ui.ActionBar.BottomSheetTabsOverlay$2, reason: invalid class name */
    class AnonymousClass2 extends AnimatorListenerAdapter {
        ...
        public void onAnimationEnd(Animator animator) {
            ...
            this.val$sheet.mo4945getWindowView().setDrawingFromOverlay(false);
        ...
        public static /* synthetic */ void $r8$lambda$GCfik7AYPJcOu1GrqTlmVf7Z84w(BottomSheetTabs.WebTabData webTabData, Sheet sheet, Bitmap bitmap) {
            ...
            sheet.mo4945getWindowView().setDrawingFromOverlay(false);
            sheet.release();
        }
    }
    ...
    private void drawDismissingTab(Canvas canvas) {
        if (this.dismissingSheet != null) {
            ...
            SheetView sheetViewMo4945getWindowView = this.dismissingSheet.mo4945getWindowView();
            RectF rectF2 = this.rect;
            float f = this.dismissProgress;
            float fDrawInto = sheetViewMo4945getWindowView.drawInto(canvas, rectF2, f, this.clipRect, f, false);
    ...
    /* JADX WARN: Code duplicated, block: B:101:0x04ae  */
    /* JADX WARN: Code duplicated, block: B:73:0x0260  */
    /* JADX WARN: Code duplicated, block: B:89:0x02d6  */
    /* JADX WARN: Code duplicated, block: B:91:0x0455  */
    /* JADX WARN: Code duplicated, block: B:92:0x0458  */
    /* JADX WARN: Code duplicated, block: B:95:0x046a  */
    ...
    private void drawTabsPreview(Canvas canvas) {
        ...
        if (this.openProgress > 0.0f || this.openingProgress > 0.0f) {
            ...
            if (view != null) {
                ...
                int[] iArr2 = this.pos2;
                int i7 = iArr2[0];
                rectF.set(i6 - i7, iArr[1] - iArr2[1], (i6 - i7) + this.actionBarLayout.getWidth(), (this.pos[1] - this.pos2[1]) + this.actionBarLayout.getHeight());
            } else {
                int[] iArr3 = this.pos;
                iArr3[1] = 0;
                iArr3[0] = 0;
            ...
            float f10 = this.animatedCount.set(f9);
            ...
            int i9 = -1;
            int i10 = 0;
            while (i10 < this.tabs.size() + i5) {
                if (i10 == this.tabs.size()) {
                    if (i9 < 0 || this.openingProgress <= 0.5f) {
                        f2 = fDp2;
                        i = iMin;
                        i2 = iHeight;
                        f3 = f;
                        ...
                        tabPreview = (TabPreview) this.tabs.get(i9);
                    }
                    i9 = i9;
                    i10++;
                    fLerp2 = fLerp2;
                    ...
                    tabPreview = (TabPreview) this.tabs.get(i10);
                }
                f4 = f7;
                if (i10 < this.tabs.size()) {
                    i3 = i5;
                ...
                float f11 = tabDrawable2 == tabDrawable3 ? f : fLerp2;
                float f12 = tabDrawable2 == tabDrawable3 ? this.openingProgress : f6;
                float position = (f10 - f) - tabDrawable2.getPosition();
                ...
                float f13 = iHeight;
                float f14 = fDp3 + ((((fHeight - f2) - (0.26f * f13)) - fDp3) * fMax);
                float f15 = iMin / 2.0f;
                i = iMin;
                i2 = iHeight;
                this.rect2.set(f8 - f15, f14, f8 + f15, f14 + f13);
                ...
                if (tabDrawable4 != tabDrawable5) {
                    ...
                    if ((rectF3.top > fHeight || rectF3.bottom < 0.0f || fLerp2 < 0.1f) && position < f10 - 3.0f) {
                        i4 = i3;
                    } else {
                        i4 = 0;
                    }
                ...
                if (sheet2 != null && tabDrawable4 == tabDrawable5) {
                    this.rect.set(sheet2.mo4945getWindowView().getRect());
                    RectF rectF4 = this.rect2;
                    AndroidUtilities.lerpCentered(rectF4, this.rect, f12, rectF4);
                } else {
                ...
                if (tabPreview.tabDrawable != this.openingTab) {
                    ...
                    if (rectF7.top > fHeight || rectF7.bottom < 0.0f) {
                        ...
                        tabPreview.src[i3] = this.rect2.top;
                        ...
                        tabPreview.dst[i3] = this.rect2.top - AndroidUtilities.dp(0.0f);
                        tabPreview.dst[2] = this.rect2.right;
                        tabPreview.dst[3] = this.rect2.top - AndroidUtilities.dp(0.0f);
                        f5 = f11 * (1.0f - f12);
                        tabPreview.dst[4] = this.rect2.centerX() + ((this.rect2.width() / 2.0f) * AndroidUtilities.lerp(1.0f, 0.83f, f5));
                        tabPreview.dst[5] = (this.rect2.top - AndroidUtilities.dp(0.0f)) + (((this.rect2.height() * 1.0f) + AndroidUtilities.dp(0.0f)) * AndroidUtilities.lerp(1.0f, 0.6f, f5));
                        tabPreview.dst[6] = this.rect2.centerX() - (AndroidUtilities.lerp(1.0f, 0.83f, f5) * (this.rect2.width() / 2.0f));
                        tabPreview.dst[7] = (this.rect2.top - AndroidUtilities.dp(0.0f)) + (((this.rect2.height() * 1.0f) + AndroidUtilities.dp(0.0f)) * AndroidUtilities.lerp(1.0f, 0.6f, f5));
                        ...
                        float f17 = f12;
                        tabPreview2.draw(canvas2, rectF10, i4, f16, f5, f17, AndroidUtilities.lerp(Utilities.clamp01((position - f10) + 2.0f), 1.0f, Utilities.clamp01((f11 - 0.1f) / 0.8f)));
                        sheet = this.openingSheet;
                        if (sheet == null && tabPreview2.tabDrawable == this.openingTab) {
                            SheetView sheetViewMo4945getWindowView = sheet.mo4945getWindowView();
                            RectF rectF11 = this.rect2;
                            canvas2 = canvas;
                            sheetViewMo4945getWindowView.drawInto(canvas2, rectF11, 1.0f, rectF11, f17, true);
                        } else {
                            canvas2 = canvas;
                        }
                        canvas2.restore();
                    ...
                    f3 = 1.0f;
                    float f18 = fLerp;
                    TabPreview tabPreview3 = tabPreview;
                    float f19 = f12;
                    tabPreview3.draw(canvas2, rectF14, i4, f18, f5, f19, AndroidUtilities.lerp(Utilities.clamp01((position - f10) + 2.0f), 1.0f, Utilities.clamp01((f11 - 0.1f) / 0.8f)));
                    sheet = this.openingSheet;
                    if (sheet == null) {
                        canvas2 = canvas;
                    } else {
            ...
            rectF15.set(0.0f, 0.0f, fWidth, fDp);
            this.gradientClip.draw(canvas2, rectF15, z, this.openProgress);
            canvas2.restore();
            canvas2.restore();
            ...
            float f21 = (fWidth - currentWidth) / 2.0f;
            this.closeAllButtonBackground.setBounds((int) f21, (int) ((fDp - (AndroidUtilities.dp(95.0f) / 2.0f)) - AndroidUtilities.dp(14.0f)), (int) ((currentWidth + fWidth) / 2.0f), (int) ((fDp - (AndroidUtilities.dp(95.0f) / 2.0f)) + AndroidUtilities.dp(14.0f)));
            this.closeAllButtonBackground.setAlpha((int) (this.openProgress * f20));
            this.closeAllButtonBackground.draw(canvas2);
            this.closeAllButtonText.draw(canvas2, AndroidUtilities.dp(12.0f) + f21, fDp - (AndroidUtilities.dp(95.0f) / 2.0f), -1, this.openProgress);
            canvas.restore();
        }
    }
