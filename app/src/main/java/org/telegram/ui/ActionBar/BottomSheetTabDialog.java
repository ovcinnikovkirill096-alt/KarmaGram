...
public class BottomSheetTabDialog extends Dialog {
    ...
    public BottomSheetTabDialog(BottomSheetTabsOverlay.Sheet sheet) {
        super(sheet.mo4945getWindowView().getContext(), R.style.TransparentDialog);
        Paint paint = new Paint(1);
        this.navigationBarPaint = paint;
        this.sheet = sheet;
        BottomSheetTabsOverlay.SheetView sheetViewMo4945getWindowView = sheet.mo4945getWindowView();
        this.sheetView = sheetViewMo4945getWindowView;
        ...
        WindowView windowView = new WindowView(sheetViewMo4945getWindowView);
