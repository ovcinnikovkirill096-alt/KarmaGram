...
public class ChannelAffiliateProgramsFragment extends GradientHeaderActivity implements NotificationCenter.NotificationCenterDelegate {
    ...
    private CharSequence sortText(BotStarsController.ChannelSuggestedBots.Sort sort) {
        ...
        if (sort == BotStarsController.ChannelSuggestedBots.Sort.BY_PROFITABILITY) {
            spannableString = new SpannableString(LocaleController.getString(R.string.ChannelAffiliateProgramProgramsSortProfitability) + RegisterSpec.PREFIX);
        } else if (sort == BotStarsController.ChannelSuggestedBots.Sort.BY_REVENUE) {
            spannableString = new SpannableString(LocaleController.getString(R.string.ChannelAffiliateProgramProgramsSortRevenue) + RegisterSpec.PREFIX);
        } else {
            if (sort == BotStarsController.ChannelSuggestedBots.Sort.BY_DATE) {
                spannableString = new SpannableString(LocaleController.getString(R.string.ChannelAffiliateProgramProgramsSortDate) + RegisterSpec.PREFIX);
            }
    ...
    /* JADX INFO: renamed from: org.telegram.ui.bots.ChannelAffiliateProgramsFragment$4, reason: invalid class name */
    ...
    /* JADX WARN: Code duplicated, block: B:23:0x0484  */
    /* JADX WARN: Code duplicated, block: B:24:0x0563  */
    /* JADX WARN: Code duplicated, block: B:27:0x0609  */
    /* JADX WARN: Code duplicated, block: B:28:0x0629  */
    ...
    public static void showConnectAffiliateAlert(final Context context, final int i, final TL_payments.starRefProgram starrefprogram, final long j, final Theme.ResourcesProvider resourcesProvider, final boolean z) {
        ...
        int iDp = AndroidUtilities.dp(r14);
        ...
        textView3.setBackground(Theme.createRoundRectDrawable(AndroidUtilities.dp(r14), Theme.getColor(Theme.key_featuredStickers_addButton, resourcesProvider)));
        ...
        if (i7 > 0) {
            ...
            textView7.setText(Emoji.replaceEmoji(AndroidUtilities.replaceTags(LocaleController.formatString(i6, objArr)), textView7.getPaint().getFontMetricsInt(), r15));
            ...
            LinkSpanDrawable.LinksTextView linksTextView = new LinkSpanDrawable.LinksTextView(context, resourcesProvider);
            linksTextView.setText(AndroidUtilities.replaceSingleTag(LocaleController.getString(R.string.ChannelAffiliateProgramJoinButtonInfo), new Runnable() { // from class: org.telegram.ui.bots.ChannelAffiliateProgramsFragment$$ExternalSyntheticLambda13
                @Override // java.lang.Runnable
                public final void run() {
            ...
            backupImageView2.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.bots.ChannelAffiliateProgramsFragment$$ExternalSyntheticLambda14
            ...
            buttonWithCounterView.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.bots.ChannelAffiliateProgramsFragment$$ExternalSyntheticLambda15
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    ChannelAffiliateProgramsFragment.m19527$r8$lambda$XpRUTWcD8Qf60LYRYKywfdbQTg(buttonWithCounterView, jArr, i, starrefprogram, bottomSheetCreate, j, z, context, resourcesProvider, user, view);
                }
            });
            bottomSheetCreate.setOnDismissListener(new DialogInterface.OnDismissListener() { // from class: org.telegram.ui.bots.ChannelAffiliateProgramsFragment$$ExternalSyntheticLambda16
            ...
            runnable = new Runnable() { // from class: org.telegram.ui.bots.ChannelAffiliateProgramsFragment$$ExternalSyntheticLambda17
                @Override // java.lang.Runnable
                public final void run() {
            ...
            if (linearLayout != null) {
                ...
                linearLayout5.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.bots.ChannelAffiliateProgramsFragment$$ExternalSyntheticLambda18
                    @Override // android.view.View.OnClickListener
                    public final void onClick(View view) {
                        ChannelAffiliateProgramsFragment.m19526$r8$lambda$XgA49I2JQGHCeLKN4jezb1aQ(i, bottomSheetCreate, resourcesProvider, linearLayout5, jArr, runnable, view);
                    }
                });
            } else {
                resourcesProvider2 = resourcesProvider;
            }
            linearLayout3.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.bots.ChannelAffiliateProgramsFragment$$ExternalSyntheticLambda19
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
        ...
        objArr2[r15] = userName;
        objArr2[1] = charSequencePercents;
        objArr2[2] = pluralString;
        textView7.setText(Emoji.replaceEmoji(AndroidUtilities.replaceTags(LocaleController.formatString(i6, objArr2)), textView7.getPaint().getFontMetricsInt(), r15));
        linearLayout2.addView(textView7, LayoutHelper.createLinear(-1, -2, 0.0f, 0.0f, 0.0f, 22.0f));
        if (j >= 0) {
        ...
        linksTextView2.setText(AndroidUtilities.replaceSingleTag(LocaleController.getString(R.string.ChannelAffiliateProgramJoinButtonInfo), new Runnable() { // from class: org.telegram.ui.bots.ChannelAffiliateProgramsFragment$$ExternalSyntheticLambda13
            @Override // java.lang.Runnable
            public final void run() {
                Browser.openUrl(context, LocaleController.getString(R.string.ChannelAffiliateProgramJoinButtonInfoLink));
            }
        ...
        buttonWithCounterView2.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.bots.ChannelAffiliateProgramsFragment$$ExternalSyntheticLambda15
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                ChannelAffiliateProgramsFragment.m19527$r8$lambda$XpRUTWcD8Qf60LYRYKywfdbQTg(buttonWithCounterView2, jArr, i, starrefprogram, bottomSheetCreate, j, z, context, resourcesProvider, user, view);
            }
        });
        bottomSheetCreate.setOnDismissListener(new DialogInterface.OnDismissListener() { // from class: org.telegram.ui.bots.ChannelAffiliateProgramsFragment$$ExternalSyntheticLambda16
            @Override // android.content.DialogInterface.OnDismissListener
        ...
        if (linearLayout != null) {
            ...
            resourcesProvider2 = resourcesProvider;
            linearLayout7.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.bots.ChannelAffiliateProgramsFragment$$ExternalSyntheticLambda18
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    ChannelAffiliateProgramsFragment.m19526$r8$lambda$XgA49I2JQGHCeLKN4jezb1aQ(i, bottomSheetCreate, resourcesProvider, linearLayout7, jArr, runnable, view);
                }
            });
        } else {
            resourcesProvider2 = resourcesProvider;
    ...
    public static /* synthetic */ void m19526$r8$lambda$XgA49I2JQGHCeLKN4jezb1aQ(int i, BottomSheet bottomSheet, Theme.ResourcesProvider resourcesProvider, View view, final long[] jArr, final Runnable runnable, View view2) {
        final long j;
        ...
        while (i2 < size) {
            ...
            itemOptionsMakeOptions.addChat(tLObject, j == jArr[0], new Runnable() { // from class: org.telegram.ui.bots.ChannelAffiliateProgramsFragment$$ExternalSyntheticLambda23
                @Override // java.lang.Runnable
                public final void run() {
                    ChannelAffiliateProgramsFragment.m19530$r8$lambda$myZWo4kuTQPqu_UZiRZ7NiFhCg(jArr, j, runnable);
                }
            });
        }
    ...
    public static /* synthetic */ void m19530$r8$lambda$myZWo4kuTQPqu_UZiRZ7NiFhCg(long[] jArr, long j, Runnable runnable) {
        jArr[0] = j;
        runnable.run();
    }
    ...
    public static BottomSheet showShareAffiliateAlert(final Context context, final int i, final TL_payments.connectedBotStarRef connectedbotstarref, final long j, Theme.ResourcesProvider resourcesProvider) {
        ...
        if (connectedbotstarref.revoked) {
            ...
            imageView3.setScaleType(scaleType);
            resourcesProvider2 = resourcesProvider;
            imageView3.setColorFilter(new PorterDuffColorFilter(Theme.getColor(i6, resourcesProvider2), mode));
            imageView3.setImageResource(R.drawable.arrows_select);
            linearLayout4.addView(imageView3, LayoutHelper.createLinear(-2, -2, 16, 2, 0, 5, 0));
        ...
        textView7.setBackground(Theme.createSimpleSelectorRoundRectDrawable(AndroidUtilities.dp(8.0f), Theme.getColor(i5, resourcesProvider2), Theme.blendOver(Theme.getColor(i5, resourcesProvider2), Theme.getColor(Theme.key_listSelector, resourcesProvider2))));
        ...
        if (j2 <= 0) {
            i3 = 1;
            pluralString3 = LocaleController.formatString(R.string.ChannelAffiliateProgramLinkOpenedNone, UserObject.getUserName(user2));
        } else {
            i3 = 1;
            pluralString3 = LocaleController.formatPluralString("ChannelAffiliateProgramLinkOpened", (int) j2, UserObject.getUserName(user2));
        }
        ...
        final Runnable runnable = new Runnable() { // from class: org.telegram.ui.bots.ChannelAffiliateProgramsFragment$$ExternalSyntheticLambda3
            @Override // java.lang.Runnable
            public final void run() {
                ChannelAffiliateProgramsFragment.$r8$lambda$SMHHNYwLqpSUSV1onZnaUGrpXFo(connectedbotstarref, bottomSheetCreate, resourcesProvider2, user2);
            }
        };
        if (!connectedbotstarref.revoked) {
        ...
        if (r17 != 0) {
            ...
            r4.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.bots.ChannelAffiliateProgramsFragment$$ExternalSyntheticLambda7
                @Override // android.view.View.OnClickListener
                public final void onClick(View view2) {
                    ChannelAffiliateProgramsFragment.m19531$r8$lambda$rkFAKYigEpM2vOin2Pe0z1jB8Q(i, bottomSheetCreate, resourcesProvider3, r4, j, context, connectedbotstarref, view2);
                }
            });
        } else {
            connectedbotstarref2 = connectedbotstarref;
        ...
        linearLayout.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.bots.ChannelAffiliateProgramsFragment$$ExternalSyntheticLambda8
            @Override // android.view.View.OnClickListener
            public final void onClick(View view2) {
                ChannelAffiliateProgramsFragment.m19522$r8$lambda$DA_jYfNNWEocIbgyGZeSJnRhK8(bottomSheetCreate, connectedbotstarref2, view2);
            }
        });
                ...
                MessagesController.getInstance(i).loadFullUser(user, 0, true, new Utilities.Callback() { // from class: org.telegram.ui.bots.ChannelAffiliateProgramsFragment$$ExternalSyntheticLambda24
                    ...
                    public final void run(Object obj) {
                        AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.bots.ChannelAffiliateProgramsFragment$$ExternalSyntheticLambda26
                            @Override // java.lang.Runnable
                            public final void run() {
                                ChannelAffiliateProgramsFragment.m19523$r8$lambda$GfWtO3GPRLf2Utb4HcFxHVUeXo(userFull, bottomSheet, context, i, j, resourcesProvider);
                            }
                        });
                    }
                });
    ...
    public static /* synthetic */ void m19523$r8$lambda$GfWtO3GPRLf2Utb4HcFxHVUeXo(TLRPC.UserFull userFull, BottomSheet bottomSheet, Context context, int i, long j, Theme.ResourcesProvider resourcesProvider) {
    ...
    public static /* synthetic */ void m19531$r8$lambda$rkFAKYigEpM2vOin2Pe0z1jB8Q(final int i, final BottomSheet bottomSheet, Theme.ResourcesProvider resourcesProvider, View view, long j, final Context context, final TL_payments.connectedBotStarRef connectedbotstarref, View view2) {
        long j2;
        ArrayList admined = BotStarsController.getInstance(i).getAdmined();
        admined.add(0, UserConfig.getInstance(i).getCurrentUser());
    ...
    public static /* synthetic */ void m19522$r8$lambda$DA_jYfNNWEocIbgyGZeSJnRhK8(BottomSheet bottomSheet, TL_payments.connectedBotStarRef connectedbotstarref, View view) {
        bottomSheet.dismiss();
        BaseFragment safeLastFragment = LaunchActivity.getSafeLastFragment();
        if (safeLastFragment != null) {
