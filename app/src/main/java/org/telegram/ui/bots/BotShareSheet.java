...
public class BotShareSheet extends BottomSheetWithRecyclerListView {
                ...
                if (!file.exists()) {
                    ...
                    final HttpGetFileTask httpGetFileTask = new HttpGetFileTask(new Utilities.Callback() { // from class: org.telegram.ui.bots.BotShareSheet$$ExternalSyntheticLambda3
                        ...
                        public final void run(Object obj) {
                            BotShareSheet.m19421$r8$lambda$vgRbaSSp7en3a3AYtxdSwXe9Kw(fileArr, alertDialog, runnable2, (File) obj);
                        }
                    }, null);
    ...
    public static /* synthetic */ void m19421$r8$lambda$vgRbaSSp7en3a3AYtxdSwXe9Kw(File[] fileArr, AlertDialog alertDialog, Runnable runnable, File file) {
        fileArr[0] = file;
        alertDialog.dismiss();
        runnable.run();
    }
    ...
    public static MessageObject convert(int i, long j, TLRPC.BotInlineResult botInlineResult, File file) {
        ...
        return convert(i, j, botInlineResult, tL_photo2, tL_document);
    }
