...
public abstract class FloatingDebugController {
        ...
        if (z) {
            ...
            floatingDebugView.dismiss(new Runnable() { // from class: org.telegram.ui.Components.FloatingDebug.FloatingDebugController$$ExternalSyntheticLambda0
                ...
                public final void run() {
                    FloatingDebugController.m9203$r8$lambda$vjnbHUwRPIFZGxpn6HtKtrH0fU(launchActivity);
                }
            });
        }
        if (z2) {
    ...
    public static /* synthetic */ void m9203$r8$lambda$vjnbHUwRPIFZGxpn6HtKtrH0fU(LaunchActivity launchActivity) {
