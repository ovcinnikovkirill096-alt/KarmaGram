        ...
        public void draw(Canvas canvas, View view) {
            ...
            if (TableLayout.this.drawLines) {
                ...
                if (i8 == 0) {
                    ...
                    int i10 = this.x;
                    canvas2.drawLine(i10 + strokeWidth, f7, i10 + strokeWidth, f8, linePaint);
                    paint = linePaint2;
                } else {
                    int i11 = this.y;
                    paint = linePaint2;
                    canvas.drawLine(i8 - strokeWidth2, i11, i8 - strokeWidth2, i11 + this.measuredHeight, paint);
                }
                int i12 = this.y;
                if (i12 == 0) {
                    int i13 = this.x;
                    float f9 = i13;
                    float f10 = this.measuredWidth + i13;
                    if (i13 == 0) {
                        f9 += iDp;
                    }
                    ...
                    int i14 = this.y;
                    canvas.drawLine(f9, i14 + strokeWidth, f10, i14 + strokeWidth, linePaint);
                } else {
                    int i15 = this.x;
                    canvas.drawLine(i15, i12 - strokeWidth2, i15 + this.measuredWidth, i12 - strokeWidth2, paint);
                }
                ...
                canvas.drawLine((i16 + i17) - strokeWidth, f11, (i16 + i17) - strokeWidth, f12, linePaint);
                int i18 = this.x;
                float f13 = (i18 == 0 && z4) ? i18 + iDp : i18 - strokeWidth;
                if (z3 && z4) {
                    f2 = (i18 + this.measuredWidth) - iDp;
                } else {
                ...
                canvas.drawLine(f13, (i19 + i20) - strokeWidth, f14, (i19 + i20) - strokeWidth, linePaint);
                if (this.x == 0 && this.y == 0) {
                    RectF rectF2 = TableLayout.this.rect;
                    int i21 = this.x;
                    int i22 = this.y;
                    float f15 = iDp * 2;
                    rectF2.set(i21 + strokeWidth, i22 + strokeWidth, i21 + strokeWidth + f15, i22 + strokeWidth + f15);
                ...
                if (z3 && this.y == 0) {
                    ...
                    float f16 = iDp * 2;
                    int i25 = this.y;
                    rectF3.set(((i23 + i24) - strokeWidth) - f16, i25 + strokeWidth, (i23 + i24) - strokeWidth, i25 + strokeWidth + f16);
                ...
                if (this.x == 0 && z4) {
                    ...
                    float f17 = iDp * 2;
                    rectF4.set(i26 + strokeWidth, ((i27 + i28) - strokeWidth) - f17, i26 + strokeWidth + f17, (i27 + i28) - strokeWidth);
                    canvas.drawArc(TableLayout.this.rect, 180.0f, -90.0f, false, linePaint);
                }
                if (z3 && z4) {
                    ...
                    rectF5.set(((i29 + i30) - strokeWidth) - f18, ((i31 + i32) - strokeWidth) - f18, (i29 + i30) - strokeWidth, (i31 + i32) - strokeWidth);
                    canvas.drawArc(TableLayout.this.rect, 0.0f, 90.0f, false, linePaint);
                }
            }
        }
