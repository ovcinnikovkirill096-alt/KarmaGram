...
public abstract class DrawingInBackgroundThreadDrawable implements NotificationCenter.NotificationCenterDelegate {
    ...
    private final Runnable bitmapCreateTask = new Runnable() { // from class: org.telegram.ui.Components.DrawingInBackgroundThreadDrawable.1
        /* JADX WARN: Code duplicated, block: B:11:0x0020 A[Catch: Exception -> 0x001e, TryCatch #0 {Exception -> 0x001e, blocks: (B:2:0x0000, B:4:0x000b, B:6:0x0015, B:15:0x0042, B:11:0x0020, B:13:0x0026, B:14:0x0029), top: B:20:0x0000 }] */
        /* JADX WARN: Code duplicated, block: B:13:0x0026 A[Catch: Exception -> 0x001e, TryCatch #0 {Exception -> 0x001e, blocks: (B:2:0x0000, B:4:0x000b, B:6:0x0015, B:15:0x0042, B:11:0x0020, B:13:0x0026, B:14:0x0029), top: B:20:0x0000 }] */
