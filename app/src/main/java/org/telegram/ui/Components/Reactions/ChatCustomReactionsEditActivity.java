...
public class ChatCustomReactionsEditActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate {
    ...
    /* JADX WARN: Code duplicated, block: B:76:0x03a1 A[EDGE_INSN: B:76:0x03a1->B:43:0x03a1 BREAK  A[LOOP:1: B:30:0x0350->B:35:0x0372], SYNTHETIC] */
    /* JADX WARN: Code duplicated, block: B:79:0x0372 A[SYNTHETIC] */
    @Override // org.telegram.ui.ActionBar.BaseFragment
    public View createView(Context context) {
        ...
        FrameLayout frameLayout = new FrameLayout(context) { // from class: org.telegram.ui.Components.Reactions.ChatCustomReactionsEditActivity.2
            ...
            /* JADX INFO: renamed from: org.telegram.ui.Components.Reactions.ChatCustomReactionsEditActivity$2$1, reason: invalid class name */
        ...
        if (chatReactions instanceof TLRPC.TL_chatReactionsAll) {
            ...
            ArrayList arrayList = ((TLRPC.TL_chatReactionsSome) chatReactions).reactions;
            int size = arrayList.size();
            int i6 = 0;
            int i7 = 0;
            while (i7 < size) {
                int i8 = i7 + 1;
                TLRPC.Reaction reaction = (TLRPC.Reaction) arrayList.get(i7);
        ...
        } else if ((chatReactions instanceof TLRPC.TL_chatReactionsNone) && chatFull2 != null && chatFull2.paid_media_allowed && chatFull2.paid_reactions_available) {
    ...
    /* JADX INFO: renamed from: org.telegram.ui.Components.Reactions.ChatCustomReactionsEditActivity$5, reason: invalid class name */
