...
public abstract class TopicsTabsView extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public TopicsTabsView(Context context, BaseFragment baseFragment, int i, long j, Theme.ResourcesProvider resourcesProvider) {
        ...
        ImageView imageViewCreateButton = createButton(context, R.drawable.menu_sidebar, new View.OnClickListener() { // from class: org.telegram.ui.Components.TopicsTabsView$$ExternalSyntheticLambda1
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
        ...
        ImageView imageViewCreateButton2 = createButton(context, R.drawable.menu_sidebar, new View.OnClickListener() { // from class: org.telegram.ui.Components.TopicsTabsView$$ExternalSyntheticLambda1
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                this.f$0.onSideMenuButtonClick(view);
            }
        ...
        ImageView imageViewCreateButton3 = createButton(context, R.drawable.msg_select, new View.OnClickListener() { // from class: org.telegram.ui.Components.TopicsTabsView$$ExternalSyntheticLambda2
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
        ...
        ImageView imageViewCreateButton4 = createButton(context, R.drawable.msg_select, new View.OnClickListener() { // from class: org.telegram.ui.Components.TopicsTabsView$$ExternalSyntheticLambda2
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                this.f$0.onCloseButtonClick(view);
            }
    ...
    /* JADX INFO: renamed from: org.telegram.ui.Components.TopicsTabsView$5, reason: invalid class name */
        ...
        if (!this.sideTabs.isReorderAllowed() && !this.topTabs.isReorderAllowed()) {
            ...
            if (obj instanceof TLRPC.TL_forumTopic) {
                ...
                if (ChatObject.isMonoForum(chat)) {
                    ...
                    itemOptionsMakeOptions.add(R.drawable.msg_clear, LocaleController.getString(R.string.ClearHistory), new Runnable() { // from class: org.telegram.ui.Components.TopicsTabsView$$ExternalSyntheticLambda10
                        @Override // java.lang.Runnable
                        public final void run() {
                    ...
                    if (ChatObject.canManageTopics(chat4) || UserObject.isBotForumWithEditableTopics(user)) {
                        ...
                        itemOptionsMakeOptions.add(z ? R.drawable.msg_unpin : R.drawable.msg_pin, LocaleController.getString(z ? R.string.DialogUnpin : R.string.DialogPin), new Runnable() { // from class: org.telegram.ui.Components.TopicsTabsView$$ExternalSyntheticLambda12
                            @Override // java.lang.Runnable
                            public final void run() {
                        ...
                        if (tL_forumTopic.pinned) {
                            itemOptionsMakeOptions.add(R.drawable.tabs_reorder, LocaleController.getString(R.string.FilterReorder), new Runnable() { // from class: org.telegram.ui.Components.TopicsTabsView$$ExternalSyntheticLambda13
                                @Override // java.lang.Runnable
                                public final void run() {
                    ...
                    if (ChatObject.canManageTopics(chat4) || UserObject.isBotForumWithEditableTopics(user)) {
                        itemOptionsMakeOptions.add(R.drawable.outline_profile_edit_24, LocaleController.getString(R.string.EditTopic), new Runnable() { // from class: org.telegram.ui.Components.TopicsTabsView$$ExternalSyntheticLambda14
                            @Override // java.lang.Runnable
                            public final void run() {
                    ...
                    itemOptionsMakeOptions.add(zIsDialogMuted ? R.drawable.msg_unmute : R.drawable.msg_mute, LocaleController.getString(zIsDialogMuted ? R.string.Unmute : R.string.Mute), new Runnable() { // from class: org.telegram.ui.Components.TopicsTabsView$$ExternalSyntheticLambda15
                        @Override // java.lang.Runnable
                        public final void run() {
                    ...
                    if (ChatObject.canManageTopic(this.currentAccount, chat4, tL_forumTopic) && !UserObject.isBotForum(user)) {
                        ...
                        itemOptionsMakeOptions.add(z2 ? R.drawable.msg_topic_restart : R.drawable.msg_topic_close, LocaleController.getString(z2 ? R.string.RestartTopic : R.string.CloseTopic), new Runnable() { // from class: org.telegram.ui.Components.TopicsTabsView$$ExternalSyntheticLambda16
                            @Override // java.lang.Runnable
                            public final void run() {
                    ...
                    if (ChatObject.canDeleteTopic(this.currentAccount, chat4, tL_forumTopic)) {
                        itemOptionsMakeOptions.add(R.drawable.msg_delete, LocaleController.getPluralString("DeleteTopics", 1), new Runnable() { // from class: org.telegram.ui.Components.TopicsTabsView$$ExternalSyntheticLambda17
                            @Override // java.lang.Runnable
                            public final void run() {
    ...
    public static class VerticalTabView extends FrameLayout {
        ...
        /* JADX INFO: renamed from: -$$Nest$fgetcountScale, reason: not valid java name */
        static /* bridge */ /* synthetic */ float m11804$$Nest$fgetcountScale(VerticalTabView verticalTabView) {
            return verticalTabView.countScale;
        }

        /* JADX INFO: renamed from: -$$Nest$fgetcounterBackgroundColorKey, reason: not valid java name */
        static /* bridge */ /* synthetic */ int m11805$$Nest$fgetcounterBackgroundColorKey(VerticalTabView verticalTabView) {
            return verticalTabView.counterBackgroundColorKey;
        }

        /* JADX INFO: renamed from: -$$Nest$fgetcounterText, reason: not valid java name */
        static /* bridge */ /* synthetic */ AnimatedTextView.AnimatedTextDrawable m11806$$Nest$fgetcounterText(VerticalTabView verticalTabView) {
        ...
        public VerticalTabView(Context context, int i, Theme.ResourcesProvider resourcesProvider) {
            ...
            FrameLayout frameLayout = new FrameLayout(context, resourcesProvider) { // from class: org.telegram.ui.Components.TopicsTabsView.VerticalTabView.2
                ...
                jadx.core.utils.exceptions.JadxRuntimeException: Type update failed for variable: r2v15 ??, new type: org.telegram.ui.Components.AnimatedTextView$AnimatedTextDrawable
                	at jadx.core.dex.visitors.typeinference.TypeUpdate.apply(TypeUpdate.java:109)
                	at jadx.core.dex.visitors.typeinference.TypeUpdate.apply(TypeUpdate.java:59)
                	at jadx.core.dex.visitors.typeinference.TypeInferenceVisitor.calculateFromBounds(TypeInferenceVisitor.java:147)
                	at jadx.core.dex.visitors.typeinference.TypeInferenceVisitor.setBestType(TypeInferenceVisitor.java:125)
                ...
                jadx.core.utils.exceptions.JadxRuntimeException: Type update failed for variable: r2v16 ??, new type: android.graphics.RectF
                	at jadx.core.dex.visitors.typeinference.TypeUpdate.apply(TypeUpdate.java:109)
                	at jadx.core.dex.visitors.typeinference.TypeUpdate.apply(TypeUpdate.java:59)
                	at jadx.core.dex.visitors.typeinference.TypeInferenceVisitor.calculateFromBounds(TypeInferenceVisitor.java:147)
                	at jadx.core.dex.visitors.typeinference.TypeInferenceVisitor.setBestType(TypeInferenceVisitor.java:125)
