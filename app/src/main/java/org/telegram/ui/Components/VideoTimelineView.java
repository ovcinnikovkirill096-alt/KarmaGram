...
public class VideoTimelineView extends View {
    ...
    private void drawCorners(Canvas canvas, int i, int i2, int i3, int i4) {
        ...
        canvas.drawBitmap(this.roundCornerBitmap, f, i7 - this.roundCornersSize, (Paint) null);
        canvas.restore();
        canvas.save();
        int i8 = i3 + i2;
        float f4 = i8 - i6;
        ...
        canvas.drawBitmap(this.roundCornerBitmap, i8 - this.roundCornersSize, f2, (Paint) null);
        canvas.restore();
    }
