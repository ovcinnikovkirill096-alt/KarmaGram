        ...
        if (getViewType() == 7) {
            ...
            if (getViewType() == 19) {
                ...
                while (true) {
                    ...
                    while (i8 < getColumnsCount()) {
                        if (i7 != 0 || i8 >= this.skipDrawItemsCount) {
                            int iDp8 = (AndroidUtilities.dp(2.0f) + measuredWidth) * i8;
                            paint = paint5;
                            canvas.drawRect(iDp8, iDp7, iDp8 + measuredWidth, iDp7 + i6, paint);
                        } else {
                            paint = paint5;
                        }
                        i8++;
                    ...
                    Paint paint7 = paint5;
                    iDp7 += AndroidUtilities.dp(2.0f) + i6;
                    i7++;
                ...
                while (iDp15 < getMeasuredWidth()) {
                    ...
                    int i11 = iDp15 + iDp16;
                    rectF3.set(AndroidUtilities.dp(4.0f) + iDp15, AndroidUtilities.dp(4.0f), i11 - AndroidUtilities.dp(4.0f), getMeasuredHeight() - AndroidUtilities.dp(4.0f));
