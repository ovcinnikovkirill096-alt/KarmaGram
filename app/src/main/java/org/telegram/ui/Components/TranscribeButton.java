...
public abstract class TranscribeButton {
    ...
    private static void transcribePressed(final MessageObject messageObject, boolean z, final ChatMessageCell.ChatMessageCellDelegate chatMessageCellDelegate) {
        ...
        if (z) {
            ...
            int i3 = UserConfig.getInstance(i).isPremiumReal() ? 0 : 1024;
            ...
            if (VoiceRecognitionController.isCustomRecognitionEnabled() && !UserConfig.getInstance(UserConfig.selectedAccount).isPremiumReal()) {
                MediaLoader.loadFiles(AccountInstance.getInstance(i), new ArrayList() { // from class: org.telegram.ui.Components.TranscribeButton.1
                    ...
                    public final void run(int i4) {
                        TranscribeButton.m11818$r8$lambda$kNGsRkppBULGalCwHXfcm26L9g(messageObject, requestDelegate, i4);
                    }
                });
                return;
            } else {
        ...
        if (tL_messages_transcribedAudio != null) {
            ...
            if ((tL_messages_transcribedAudio.flags & 2) != 0) {
                ...
                AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.Components.TranscribeButton$$ExternalSyntheticLambda8
                    @Override // java.lang.Runnable
                    public final void run() {
                        TranscribeButton.m11817$r8$lambda$a2o22si0EBawgKyJsqzCtlJsVw(chatMessageCellDelegate, tL_messages_transcribedAudio);
                    }
                });
            }
            ...
            if (tL_error != null && (str = tL_error.text) != null) {
                if (str.startsWith("FLOOD_WAIT_")) {
                    ...
                    AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.Components.TranscribeButton$$ExternalSyntheticLambda9
                        @Override // java.lang.Runnable
                        public final void run() {
                            TranscribeButton.m11819$r8$lambda$oaPhGEe95pO5I2f8R2G6iDBAyg(messageObject, chatMessageCellDelegate, i);
                        }
                    });
                    return;
                }
    ...
    public static /* synthetic */ void m11817$r8$lambda$a2o22si0EBawgKyJsqzCtlJsVw(ChatMessageCell.ChatMessageCellDelegate chatMessageCellDelegate, TLRPC.TL_messages_transcribedAudio tL_messages_transcribedAudio) {
    ...
    public static /* synthetic */ void m11819$r8$lambda$oaPhGEe95pO5I2f8R2G6iDBAyg(MessageObject messageObject, ChatMessageCell.ChatMessageCellDelegate chatMessageCellDelegate, int i) {
        HashMap map = transcribeOperationsByDialogPosition;
        if (map != null) {
            map.remove(Integer.valueOf(reqInfoHash(messageObject)));
        }
    ...
    public static /* synthetic */ void m11818$r8$lambda$kNGsRkppBULGalCwHXfcm26L9g(MessageObject messageObject, RequestDelegate requestDelegate, int i) {
        if (i > 0) {
        ...
        try {
            ...
            if (messageObject != null && messageObject.messageOwner != null) {
                ...
                AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.Components.TranscribeButton$$ExternalSyntheticLambda1
                    @Override // java.lang.Runnable
                    public final void run() {
                        TranscribeButton.m11816$r8$lambda$1VsD2GsCgYYhqv4wc1i0EhIq0(messageObject, j, str);
                    }
                });
                return true;
            }
    ...
    public static /* synthetic */ void m11816$r8$lambda$1VsD2GsCgYYhqv4wc1i0EhIq0(MessageObject messageObject, long j, String str) {
