        ...
        textureView.setSurfaceTextureListener(new TextureView.SurfaceTextureListener() { // from class: org.telegram.ui.Components.spoilers.SpoilerEffect2.3
            ...
            public void onSurfaceTextureAvailable(SurfaceTexture surfaceTexture, int i5, int i6) {
                if (SpoilerEffect2.this.thread == null) {
                    ...
                    spoilerEffect2.thread = spoilerEffect3.new SpoilerThread(surfaceTexture, i5, i6, new Runnable() { // from class: org.telegram.ui.Components.spoilers.SpoilerEffect2$3$$ExternalSyntheticLambda0
                        @Override // java.lang.Runnable
                        public final void run() {
