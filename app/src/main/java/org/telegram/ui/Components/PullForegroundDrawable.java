...
public abstract class PullForegroundDrawable {
    ...
    /* JADX WARN: Code duplicated, block: B:100:0x049b  */
    /* JADX WARN: Code duplicated, block: B:103:0x04a5  */
    /* JADX WARN: Code duplicated, block: B:115:0x0538  */
    /* JADX WARN: Code duplicated, block: B:70:0x0387  */
    /* JADX WARN: Code duplicated, block: B:72:0x0398  */
    /* JADX WARN: Code duplicated, block: B:73:0x03a7  */
    /* JADX WARN: Code duplicated, block: B:76:0x03cd  */
    /* JADX WARN: Code duplicated, block: B:78:0x03d1 A[DONT_INVERT] */
    /* JADX WARN: Code duplicated, block: B:79:0x03d3  */
    /* JADX WARN: Code duplicated, block: B:80:0x03e8  */
    /* JADX WARN: Code duplicated, block: B:86:0x03f6  */
    /* JADX WARN: Code duplicated, block: B:88:0x042c  */
    /* JADX WARN: Code duplicated, block: B:91:0x044b  */
    /* JADX WARN: Code duplicated, block: B:92:0x0452  */
    /* JADX WARN: Code duplicated, block: B:96:0x0479  */
    /* JADX WARN: Code duplicated, block: B:99:0x0498  */
    ...
    public void draw(Canvas canvas, boolean z) {
        ...
        float f11 = this.bounceIn ? (this.bounceProgress * 0.07f) - 0.05f : this.bounceProgress * 0.02f;
        checkTextLayouts((this.cell.getWidth() - (iDp * 4)) - AndroidUtilities.dp(16.0f));
        updateTextProgress(getPullProgress());
        float f12 = this.outProgress * 2.0f;
        float f13 = f12 > 1.0f ? 1.0f : f12;
        float f14 = this.outCx;
        float f15 = this.outCy;
        if (z) {
            f15 += viewOffset;
        }
        int i5 = iDp + iDp3;
        ...
        int i6 = (iDp2 * 2) + iDp4;
        float f16 = height2 > i6 ? 1.0f : height2 / i6;
        canvas2.save();
        if (z) {
        ...
        if (this.outProgress == 0.0f) {
            ...
            float f17 = this.outRadius;
            float width = f17 + (f17 * f11) + ((this.cell.getWidth() - this.outRadius) * (1.0f - this.outProgress));
            if (this.accentRevalProgress == 1.0f || this.accentRevalProgressOut == 1.0f) {
                f = f15;
                f2 = 0.0f;
                i = i5;
                ...
                z2 = true;
                canvas2 = canvas;
                canvas2.drawRoundRect(f14 - width, f15 - width, f14 + width, f18 + width, ExteraConfig.getAvatarCorners(f19, true, false), ExteraConfig.getAvatarCorners(f19, true, false), this.backgroundPaint);
            }
            this.circleClipPath.reset();
            this.rectF.set(f14 - width, f - width, f14 + width, f + width);
            float f20 = width * 2.0f;
            this.circleClipPath.addRoundRect(this.rectF, ExteraConfig.getAvatarCorners(f20, z2, false), ExteraConfig.getAvatarCorners(f20, z2, false), Path.Direction.CW);
        ...
        if (!this.animateToColorize) {
            if (this.accentRevalProgress > this.accentRevalProgressOut) {
                ...
                canvas2.translate((f14 - f21) * f22, (f - f23) * f22);
                canvas2.drawRoundRect(f21 - (this.cell.getWidth() * this.accentRevalProgress), f23 - (this.cell.getWidth() * this.accentRevalProgress), f21 + (this.cell.getWidth() * this.accentRevalProgress), f23 + (this.cell.getWidth() * this.accentRevalProgress), ExteraConfig.getAvatarCorners(this.cell.getWidth() * 2, r14, false) * this.accentRevalProgress, ExteraConfig.getAvatarCorners(this.cell.getWidth() * 2, r14, false) * this.accentRevalProgress, this.paintBackgroundAccent);
                canvas2.restore();
            }
            if (this.accentRevalProgressOut > f2) {
                ...
                canvas2.translate((f14 - f24) * f25, (f - f26) * f25);
                i2 = 0;
                canvas2.drawRoundRect(f24 - (this.cell.getWidth() * this.accentRevalProgressOut), f26 - (this.cell.getWidth() * this.accentRevalProgressOut), f24 + (this.cell.getWidth() * this.accentRevalProgressOut), f26 + (this.cell.getWidth() * this.accentRevalProgressOut), ExteraConfig.getAvatarCorners(this.cell.getWidth() * 2, r14, false) * this.accentRevalProgressOut, this.accentRevalProgressOut * ExteraConfig.getAvatarCorners(this.cell.getWidth() * 2, r14, false), this.backgroundPaint);
                canvas2.restore();
            }
            i3 = height2;
            if (i3 > i6) {
                this.paintSecondary.setAlpha((int) ((1.0f - f13) * 0.4f * f16 * 255.0f));
                if (z) {
                    this.rectF.set(iDp, iDp2, iDp + iDp4, iDp2 + viewOffset + iDp3);
                } else {
                    this.rectF.set(iDp, ((this.cell.getHeight() - i3) + iDp2) - viewOffset, iDp + iDp4, this.cell.getHeight() - iDp2);
                }
                float f27 = iDp3;
                canvas2.drawRoundRect(this.rectF, f27, f27, this.paintSecondary);
            }
            if (z) {
                canvas2.restore();
                return;
            ...
            f3 = this.outProgress;
            if (f3 != f2 || z3) {
                this.paintWhite.setAlpha((int) (f16 * 255.0f * (1.0f - f3)));
                float f28 = i;
                float f29 = measuredHeight;
                canvas2.drawCircle(f28, f29, iDp3, this.paintWhite);
                ...
                float f30 = 1.0f - f5;
                canvas2.save();
                canvas2.rotate(180.0f * f30, f28, f29);
                canvas2.translate(f2, (AndroidUtilities.dpf2(1.0f) * 1.0f) - f30);
            ...
            if (this.pullTooltipLayout != null) {
                ...
                if (f9 > 0.0f && f9 < 1.0f) {
                    ...
                    canvas2.scale(f31, f31, f6, (AndroidUtilities.dp(16.0f) * (1.0f - this.textSwappingProgress)) + height);
                }
                canvas2.saveLayerAlpha(0.0f, 0.0f, this.cell.getMeasuredWidth(), this.cell.getMeasuredHeight(), (int) (this.textSwappingProgress * f4 * f16 * this.textInProgress), 31);
                ...
                canvas2.scale(f32, f32, this.pullTooltipLayoutLeft + (this.pullTooltipLayoutWidth / 2.0f), this.pullTooltipLayout.getHeight());
            ...
            if (this.releaseTooltipLayout != null) {
                ...
                if (f7 > 0.0f && f7 < 1.0f) {
                    canvas2.save();
                    float f33 = ((1.0f - this.textSwappingProgress) * 0.1f) + 0.9f;
                    canvas2.scale(f33, f33, f6, height - (AndroidUtilities.dp(r11) * this.textSwappingProgress));
                }
                canvas2.saveLayerAlpha(0.0f, 0.0f, this.cell.getMeasuredWidth(), this.cell.getMeasuredHeight(), (int) ((1.0f - this.textSwappingProgress) * f4 * f16 * this.textInProgress), 31);
                ...
                float f34 = this.releaseTooltipLayoutScale;
                canvas2.scale(f34, f34, this.releaseTooltipLayoutLeft + (this.releaseTooltipLayoutWidth / 2.0f), this.releaseTooltipLayout.getHeight());
            ...
            if (z3 && this.changeAvatarColor && this.outProgress > 0.0f) {
                ...
                float f37 = fDp + ((1.0f - fDp) * f36) + f11;
                canvas2.translate((i - f14) * (1.0f - f36), (height3 - f) * (1.0f - f36));
                float f38 = f14;
                float f39 = f;
                canvas2.scale(f37, f37, f38, f39);
                ...
                float f40 = f35 / 2.0f;
                Theme.dialogs_archiveAvatarDrawable.setBounds((int) (f38 - f40), (int) (f39 - f40), (int) (f38 + f40), (int) (f40 + f39));
        ...
        if (this.accentRevalProgressOut > this.accentRevalProgress) {
            ...
            float f43 = measuredHeight2;
            canvas2.translate((f14 - f41) * f42, (f - f43) * f42);
            canvas2.drawRoundRect(f41 - (this.cell.getWidth() * this.accentRevalProgressOut), f43 - (this.cell.getWidth() * this.accentRevalProgressOut), f41 + (this.cell.getWidth() * this.accentRevalProgressOut), f43 + (this.cell.getWidth() * this.accentRevalProgressOut), ExteraConfig.getAvatarCorners(this.cell.getWidth() * 2, r14, false) * this.accentRevalProgressOut, ExteraConfig.getAvatarCorners(this.cell.getWidth() * 2, r14, false) * this.accentRevalProgressOut, this.backgroundPaint);
            canvas2.restore();
        }
        if (this.accentRevalProgress > f2) {
            canvas2.save();
            float f44 = i;
            float f45 = this.outProgress;
            float f46 = measuredHeight2;
            canvas2.translate((f14 - f44) * f45, (f - f46) * f45);
            canvas2.drawRoundRect(f44 - (this.cell.getWidth() * this.accentRevalProgress), f46 - (this.cell.getWidth() * this.accentRevalProgress), f44 + (this.cell.getWidth() * this.accentRevalProgress), f46 + (this.cell.getWidth() * this.accentRevalProgress), ExteraConfig.getAvatarCorners(this.cell.getWidth() * 2, r14, false) * this.accentRevalProgress, ExteraConfig.getAvatarCorners(this.cell.getWidth() * 2, r14, false) * this.accentRevalProgress, this.paintBackgroundAccent);
            canvas2.restore();
        }
        i2 = 0;
        i3 = height2;
        ...
        if (f3 != f2) {
            this.paintWhite.setAlpha((int) (f16 * 255.0f * (1.0f - f3)));
            float f211 = i;
            float f212 = measuredHeight;
            canvas2.drawCircle(f211, f212, iDp3, this.paintWhite);
            ...
            float f310 = 1.0f - f5;
            canvas2.save();
            canvas2.rotate(180.0f * f310, f211, f212);
            canvas2.translate(f2, (AndroidUtilities.dpf2(1.0f) * 1.0f) - f310);
            ...
            this.paintWhite.setAlpha((int) (f16 * 255.0f * (1.0f - f3)));
            float f213 = i;
            float f214 = measuredHeight;
            canvas2.drawCircle(f213, f214, iDp3, this.paintWhite);
            ...
            float f311 = 1.0f - f5;
            canvas2.save();
            canvas2.rotate(180.0f * f311, f213, f214);
        ...
        if (this.pullTooltipLayout != null) {
            ...
            if (f9 > 0.0f) {
                canvas2.save();
                float f312 = (this.textSwappingProgress * 0.2f) + 0.8f;
                canvas2.scale(f312, f312, f6, (AndroidUtilities.dp(16.0f) * (1.0f - this.textSwappingProgress)) + height);
            }
            canvas2.saveLayerAlpha(0.0f, 0.0f, this.cell.getMeasuredWidth(), this.cell.getMeasuredHeight(), (int) (this.textSwappingProgress * f4 * f16 * this.textInProgress), 31);
            canvas2.translate((f6 - this.pullTooltipLayoutLeft) - (this.pullTooltipLayoutWidth / 2.0f), ((AndroidUtilities.dp(8.0f) * (1.0f - this.textSwappingProgress)) + height) - this.pullTooltipLayout.getHeight());
            float f313 = this.pullTooltipLayoutScale;
            canvas2.scale(f313, f313, this.pullTooltipLayoutLeft + (this.pullTooltipLayoutWidth / 2.0f), this.pullTooltipLayout.getHeight());
            this.pullTooltipLayout.draw(canvas2);
            canvas2.restore();
            f10 = this.textSwappingProgress;
            if (f10 > 0.0f) {
        ...
        if (this.releaseTooltipLayout != null) {
            ...
            if (f7 > 0.0f) {
                canvas2.save();
                float f314 = ((1.0f - this.textSwappingProgress) * 0.1f) + 0.9f;
                canvas2.scale(f314, f314, f6, height - (AndroidUtilities.dp(r11) * this.textSwappingProgress));
            }
            canvas2.saveLayerAlpha(0.0f, 0.0f, this.cell.getMeasuredWidth(), this.cell.getMeasuredHeight(), (int) ((1.0f - this.textSwappingProgress) * f4 * f16 * this.textInProgress), 31);
            canvas2.translate((f6 - this.releaseTooltipLayoutLeft) - (this.releaseTooltipLayoutWidth / 2.0f), (height + (AndroidUtilities.dp(r11) * this.textSwappingProgress)) - this.releaseTooltipLayout.getHeight());
            float f315 = this.releaseTooltipLayoutScale;
            canvas2.scale(f315, f315, this.releaseTooltipLayoutLeft + (this.releaseTooltipLayoutWidth / 2.0f), this.releaseTooltipLayout.getHeight());
            this.releaseTooltipLayout.draw(canvas2);
            canvas2.restore();
            f8 = this.textSwappingProgress;
            if (f8 > 0.0f) {
