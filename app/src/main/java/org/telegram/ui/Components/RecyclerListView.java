...
public class RecyclerListView extends RecyclerView implements IBlur3Capture {
    ...
    public class FastScroll extends View {
        ...
        */
        ...
        /* JADX WARN: Code duplicated, block: B:34:0x022e A[DONT_INVERT] */
        /* JADX WARN: Code duplicated, block: B:35:0x0230  */
        /* JADX WARN: Code duplicated, block: B:39:0x023f A[DONT_INVERT] */
        /* JADX WARN: Code duplicated, block: B:40:0x0241  */
        /* JADX WARN: Code duplicated, block: B:41:0x024d  */
        /* JADX WARN: Code duplicated, block: B:44:0x0265  */
        /* JADX WARN: Code duplicated, block: B:45:0x026b  */
        /* JADX WARN: Code duplicated, block: B:48:0x0270  */
        /* JADX WARN: Code duplicated, block: B:49:0x0273  */
        @Override // android.view.View
        protected void onDraw(Canvas canvas) {
            ...
            if (i == 0) {
                if (this.isMoving || this.bubbleProgress != 0.0f) {
                    ...
                    if (iDp2 <= AndroidUtilities.dp(f2)) {
                        fDp = AndroidUtilities.dp(f2) - iDp2;
                    ...
                    if (staticLayout != null) {
                        ...
                        canvas.scale(f4, f4, this.scrollX, iDp - iDp2);
                ...
                this.rect.set((fDp7 - ((this.replaceLayoutProgress * this.letterLayout.getWidth()) + (this.fromWidth * (1.0f - this.replaceLayoutProgress)))) - AndroidUtilities.dp(f3), (fCenterY - (this.letterLayout.getHeight() / 2.0f)) - AndroidUtilities.dp(8.0f), fDp7 - AndroidUtilities.dp(f2), (this.letterLayout.getHeight() / 2.0f) + fCenterY + AndroidUtilities.dp(8.0f));
        ...
        public boolean onInterceptTouchEvent(RecyclerView recyclerView, MotionEvent motionEvent) {
            ...
            if ((actionMasked == 0 || actionMasked == 5) && RecyclerListView.this.currentChildView == null && z) {
                ...
                if (RecyclerListView.this.currentChildView instanceof ViewGroup) {
                    ...
                    RecyclerListView recyclerListView = RecyclerListView.this;
                    if (recyclerListView.hasClickableChild((ViewGroup) recyclerListView.currentChildView, x2, y2)) {
                        RecyclerListView.this.currentChildView = null;
                    }
                }
                ...
                if (RecyclerListView.this.currentChildView != null) {
                    ...
                    if (recyclerListView2.useLayoutPositionOnClick) {
                        recyclerListView2.currentChildPosition = recyclerView.getChildLayoutPosition(recyclerListView2.currentChildView);
                    } else {
                        recyclerListView2.currentChildPosition = recyclerView.getChildAdapterPosition(recyclerListView2.currentChildView);
                    }
            ...
            if (actionMasked == 0 || actionMasked == 5) {
                if (!RecyclerListView.this.interceptedByChild && RecyclerListView.this.currentChildView != null) {
                    ...
                    if (RecyclerListView.this.currentChildView.isEnabled()) {
                        ...
                        if (recyclerListView3.canHighlightChildAt(recyclerListView3.currentChildView, x3 - RecyclerListView.this.currentChildView.getX(), y3 - RecyclerListView.this.currentChildView.getY())) {
                            RecyclerListView recyclerListView4 = RecyclerListView.this;
                            recyclerListView4.positionSelector(recyclerListView4.currentChildPosition, RecyclerListView.this.currentChildView);
                ...
                recyclerListView5.onChildPressed(recyclerListView5.currentChildView, 0.0f, 0.0f, false);
                RecyclerListView.this.currentChildView = null;
                RecyclerListView.this.interceptedByChild = false;
                RecyclerListView.this.removeSelection(view, motionEvent);
        ...
        if (isAnimating()) {
            ...
            for (int i2 = 0; i2 < getChildCount(); i2++) {
                ...
                if (childAt != this.draggingChild && childAt != this.emptyView && childAt.getVisibility() == 0 && childAt.getAlpha() > 0.0f && ((Boolean) this.sectionsItemDecoration.isSectionItem.run(childAt)).booleanValue()) {
                    ...
                    if (childViewHolder.isRemoved() && childAt.getAlpha() < 1.0f) {
                        if (!hasSectionChildAt(childAt, i2, false)) {
                        ...
                        if (!childViewHolder.isRemoved() && alpha < 0.99f && hasSectionChildAt(childAt, i2, true)) {
                            alpha = 1.0f;
                        }
            ...
            while (i3 < getChildCount()) {
                ...
                if (childAt2 == this.draggingChild || childAt2 == this.emptyView || childAt2.getVisibility() != 0 || childAt2.getAlpha() <= 0.0f || !((Boolean) this.sectionsItemDecoration.isSectionItem.run(childAt2)).booleanValue()) {
                    ...
                    if (isInsideForcedSection(getChildAdapterPosition(childAt2))) {
                        canvas3 = canvas;
                    } else {
                        if (view2 == null || Math.abs(view3.getAlpha() - childAt2.getAlpha()) <= 0.1f) {
                            canvas4 = canvas;
                        } else {
                            boolean zHasAbove = hasAbove(view2, i4);
                            boolean zHasBelow = hasBelow(view3, i5);
                            Canvas canvas5 = canvas;
                            drawSectionBackground(canvas5, view2, view3, zHasAbove, zHasBelow);
                            view2 = null;
                            i4 = -1;
                            canvas4 = canvas5;
                        }
                ...
                drawSectionBackground(canvas3, view2, view3, hasAbove(view2, i4), hasBelow(view3, i5));
                view = null;
                childAt2 = null;
                i4 = -1;
                i = -1;
            ...
            canvas2 = canvas;
            recyclerListView = this;
            recyclerListView.drawSectionBackground(canvas2, view2, view3, hasAbove(view2, i4), hasBelow(view3, i6));
        }
        if (recyclerListView.forcedSections != null) {
            for (int i7 = 0; i7 < recyclerListView.forcedSections.size(); i7++) {
                long jLongValue = ((Long) recyclerListView.forcedSections.get(i7)).longValue();
                int iUnpackA = AndroidUtilities.unpackA(jLongValue);
                int iUnpackB = AndroidUtilities.unpackB(jLongValue);
