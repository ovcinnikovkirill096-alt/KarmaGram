...
public class MotionBackgroundDrawable extends Drawable {
    ...
    /* JADX WARN: Code duplicated, block: B:37:0x01d4  */
    public void drawPattern(Canvas canvas) {
        ...
        if (this.intensity < 0) {
            ...
            if (bitmap != null) {
                ...
                if (useLegacyBitmap) {
                    if (errorWhileGenerateLegacyBitmap) {
                        ...
                        float f7 = width2 * fMax2;
                        float f8 = height2 * fMax2;
                        float f9 = (fWidth - f7) / 2.0f;
                        float f10 = (fHeight - f8) / 2.0f;
                        this.rect.set(f9, f10, f7 + f9, f8 + f10);
                        int[] iArr = this.colors;
                    ...
                    float f17 = (fWidth - (width4 * fMax4)) / 2.0f;
                    float f18 = ((fHeight - (height4 * fMax4)) / 2.0f) + f;
                    this.matrix.setTranslate((int) f17, (int) f18);
                    if (!this.disableGradientShaderScaling || fMax4 > 1.4f || fMax4 < 0.8f) {
                        this.matrix.preScale(fMax4, fMax4);
                        f6 = fMax4;
                    }
                    ...
                    drawGiftPatternsForNegativeIntensity(canvas, f17, f18, f6);
                }
            }
        } else {
            Bitmap bitmap3 = this.patternBitmap;
            if (bitmap3 != null) {
                ...
                float fMax5 = Math.max(fWidth / width5, fHeight / height5);
                float f19 = width5 * fMax5;
                float f20 = height5 * fMax5;
                float f21 = (fWidth - f19) / 2.0f;
                float f22 = (fHeight - f20) / 2.0f;
                this.rect.set(f21, f22, f19 + f21, f20 + f22);
    ...
    public void draw(Canvas canvas) {
        ...
        boolean z = (Build.VERSION.SDK_INT < 28 || this.motionBackgroundPaint == null || this.currentBitmap == null || this.patternBitmap == null) ? false : true;
        if (this.intensity < 0) {
            if (!z) {
                canvas.drawColor(ColorUtils.setAlphaComponent(-16777216, (int) (this.alpha * this.backgroundAlpha)));
            }
            ...
            if (bitmap != null) {
                if (useLegacyBitmap) {
                    if (errorWhileGenerateLegacyBitmap) {
                        ...
                        float height2 = this.patternBitmap.getHeight();
                        float fMax2 = Math.max(fWidth / width2, fHeight / height2);
                        float f8 = width2 * fMax2;
                        float f9 = height2 * fMax2;
                        float f10 = (fWidth - f8) / 2.0f;
                        float f11 = (fHeight - f9) / 2.0f;
                        ...
                        if (bitmap2 != null) {
                            if (this.invalidateLegacy) {
                                ...
                                float height3 = this.patternBitmap.getHeight();
                                float fMax3 = Math.max(fWidth / width3, fHeight / height3);
                                float f12 = width3 * fMax3;
                                float f13 = height3 * fMax3;
                                float f14 = (fWidth - f12) / 2.0f;
                                float f15 = (fHeight - f13) / 2.0f;
                    ...
                    float height4 = this.patternBitmap.getHeight();
                    float fMax4 = Math.max(fWidth / width4, fHeight / height4);
                    float f18 = (fWidth - (width4 * fMax4)) / 2.0f;
                    float f19 = ((fHeight - (height4 * fMax4)) / 2.0f) + f;
                    this.matrix.setTranslate((int) f18, (int) f19);
                    if (!this.disableGradientShaderScaling || fMax4 > 1.4f || fMax4 < 0.8f) {
                        this.matrix.preScale(fMax4, fMax4);
                    } else {
                        fMax4 = 1.0f;
                    ...
                    if (z) {
                        ...
                        canvas.drawRoundRect(rectF2, i5, i5, this.paint2);
                    }
                    drawGiftPatternsForNegativeIntensity(canvas, f18, f19, fMax4);
                }
            }
        } else {
            ...
            if (bitmap3 != null) {
                ...
                float height5 = this.patternBitmap.getHeight();
                float fMax5 = Math.max(fWidth / width5, fHeight / height5);
                float f20 = width5 * fMax5;
                float f21 = height5 * fMax5;
