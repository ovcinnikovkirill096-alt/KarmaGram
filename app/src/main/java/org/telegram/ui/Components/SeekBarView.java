...
public class SeekBarView extends FrameLayout {
    ...
    /* JADX WARN: Code duplicated, block: B:22:0x0148  */
    /* JADX WARN: Code duplicated, block: B:23:0x0177  */
    /* JADX WARN: Code duplicated, block: B:25:0x017d  */
    /* JADX WARN: Code duplicated, block: B:26:0x01b4  */
    /* JADX WARN: Code duplicated, block: B:29:0x01c6  */
    /* JADX WARN: Code duplicated, block: B:32:0x01f6  */
    /* JADX WARN: Code duplicated, block: B:35:0x0209  */
    /* JADX WARN: Code duplicated, block: B:38:0x0212  */
    /* JADX WARN: Code duplicated, block: B:40:0x0218  */
    /* JADX WARN: Code duplicated, block: B:42:0x0227  */
    /* JADX WARN: Code duplicated, block: B:43:0x022a  */
    ...
    /* JADX WARN: Code duplicated, block: B:57:0x0259  */
    /* JADX WARN: Code duplicated, block: B:59:0x0273  */
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (!this.twoSided && this.separatorsCount > 1) {
            ...
            if (this.twoSided) {
                canvas2.drawRoundRect((getMeasuredWidth() / 2) - AndroidUtilities.dp(1.0f), (getMeasuredHeight() / 2) - AndroidUtilities.dp(6.0f), (getMeasuredWidth() / 2) + AndroidUtilities.dp(1.0f), (getMeasuredHeight() / 2) + AndroidUtilities.dp(6.0f), 100.0f, 100.0f, this.outerPaint1);
                measuredWidth2 = getMeasuredWidth();
                i2 = this.selectorWidth;
                if (i > (measuredWidth2 - i2) / 2) {
                    canvas2 = canvas;
                    canvas2.drawRoundRect(getMeasuredWidth() / 2, (getMeasuredHeight() / 2) - AndroidUtilities.dp(1.0f), (this.selectorWidth / 2) + i, (getMeasuredHeight() / 2) + AndroidUtilities.dp(1.0f), 100.0f, 100.0f, this.outerPaint1);
                } else {
                    canvas2 = canvas;
                    canvas2.drawRoundRect((i2 / 2) + i, (getMeasuredHeight() / 2) - AndroidUtilities.dp(1.0f), getMeasuredWidth() / 2, (getMeasuredHeight() / 2) + AndroidUtilities.dp(1.0f), 100.0f, 100.0f, this.outerPaint1);
                }
            } else {
                f2 = this.minProgress;
                if (f2 >= 0.0f) {
    ...
    /* JADX WARN: Code duplicated, block: B:92:0x01e0 A[EDGE_INSN: B:92:0x01e0->B:83:0x01e0 BREAK  A[LOOP:2: B:29:0x00aa->B:82:0x01d6], SYNTHETIC] */
    /* JADX WARN: Code duplicated, block: B:93:0x01d6 A[SYNTHETIC] */
