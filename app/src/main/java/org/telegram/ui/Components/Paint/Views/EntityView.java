...
public abstract class EntityView extends FrameLayout {
    ...
    public class SelectionView extends FrameLayout {
        ...
        /* JADX WARN: Code duplicated, block: B:57:0x021a  */
            ...
            if (actionMasked == 0) {
                ...
                if (actionMasked == 2) {
                    ...
                    if (i == 3) {
                        ...
                        zOnTouchMove = entityView10.onTouchMove(entityView10.xy[0], EntityView.this.xy[1], z, EntityView.this.xy2[0], EntityView.this.xy2[1]);
                    } else if (i != 0) {
