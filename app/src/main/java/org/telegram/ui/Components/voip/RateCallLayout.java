...
public class RateCallLayout extends FrameLayout {
    ...
    public void show(OnRateSelected onRateSelected) {
        ...
        while (i < this.startsViews.length) {
            ...
            char c3 = c2;
            ObjectAnimator objectAnimatorOfFloat4 = ObjectAnimator.ofFloat(this.startsViews[i], (Property<StarContainer, Float>) property, 0.0f, 1.0f);
            char c4 = c;
            ObjectAnimator objectAnimatorOfFloat5 = ObjectAnimator.ofFloat(this.startsViews[i], (Property<StarContainer, Float>) property2, 0.3f, 1.0f);
            float f2 = f;
            ObjectAnimator objectAnimatorOfFloat6 = ObjectAnimator.ofFloat(this.startsViews[i], (Property<StarContainer, Float>) property3, 0.3f, 1.0f);
            StarContainer starContainer = this.startsViews[i];
            float[] fArr2 = new float[2];
            fArr2[0] = AndroidUtilities.dp(30.0f);
            fArr2[c4] = f2;
            ObjectAnimator objectAnimatorOfFloat7 = ObjectAnimator.ofFloat(starContainer, (Property<StarContainer, Float>) property4, fArr2);
            Animator[] animatorArr = new Animator[4];
            animatorArr[0] = objectAnimatorOfFloat4;
            animatorArr[c4] = objectAnimatorOfFloat5;
