        ...
        if (this.isImport) {
            ...
            builder.setItems(new CharSequence[]{LocaleController.getString(R.string.CreateNewContact), LocaleController.getString(R.string.AddToExistingContact)}, new DialogInterface.OnClickListener() { // from class: org.telegram.ui.Components.PhonebookShareAlert.5
                ...
                public void onClick(DialogInterface dialogInterface, int i) {
                    ...
                    boolean z2;
                    boolean z3;
                    AnonymousClass5 anonymousClass6 = this;
                    int i3 = 3;
                    Integer num2 = 3;
                    int i4 = 1;
                    if (i == 0) {
                    ...
                    while (true) {
                        ...
                        anonymousClass6.fillRowWithType(vcardItem.getRawType(false), contentValues);
                    ...
                    while (i6 < PhonebookShareAlert.this.other.size()) {
                        ...
                        if (i7 == i4) {
                            ...
                            anonymousClass6.fillRowWithType(vcardItem2.getRawType(z4), contentValues2);
                            arrayList.add(contentValues2);
                        } else if (i7 == i3) {
                            ContentValues contentValues3 = new ContentValues();
                            contentValues3.put(str2, "vnd.android.cursor.item/website");
                            contentValues3.put(str, vcardItem2.getValue(z4));
                            anonymousClass6.fillUrlRowWithType(vcardItem2.getRawType(z4), contentValues3);
                                ...
                                if (i7 == 2) {
                                    ...
                                    if (i7 == 20) {
                                        ...
                                        if (i7 == 6 && !z) {
                                            ...
                                            String str7 = str3;
                                            contentValues8.put(str7, "vnd.android.cursor.item/organization");
                                            anonymousClass5 = this;
                                            int i8 = i2;
                    ...
                    AnonymousClass5 anonymousClass7 = anonymousClass6;
