...
public class ReactionsContainerLayout extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    jadx.core.utils.exceptions.JadxRuntimeException: Type update failed for variable: r6v14 ??, new type: float
    ...
    public final class ReactionHolderView extends FrameLayout {
        ...
        /* JADX INFO: renamed from: -$$Nest$fgetisEnter, reason: not valid java name */
        static /* bridge */ /* synthetic */ boolean m10895$$Nest$fgetisEnter(ReactionHolderView reactionHolderView) {
            return reactionHolderView.isEnter;
        }
