    ...
    public static class ThumbBlurer {
        ...
        public /* synthetic */ void lambda$getBitmap$1(final Bitmap bitmap, int i, int i2, final String str, final boolean z) {
            ...
            if (i9 > 0) {
                ...
                canvas.drawRect(i11 + iRound, i11, i11 + iRound + i11, i11 + iRound2, this.clearPaint);
                int i12 = this.padding;
                canvas.drawRect(0.0f, i12 + iRound2, iRound + i12 + i12, iRound2 + i12 + i12, this.clearPaint);
            }
