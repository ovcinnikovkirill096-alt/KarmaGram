...
public class FilterShaders {
    ...
    private static class ToneCurve {
        ...
        /* JADX WARN: Code duplicated, block: B:14:0x0075 A[PHI: r2
            ...
            while (i < length - 1) {
                ...
                while (true) {
                    ...
                    if (i3 < ((int) f)) {
                        ...
                        double d = ((double) (f2 - f3)) / ((double) (f - f3));
                        double d2 = 1.0d - d;
                        float f4 = f - f3;
                        double[] dArr = dArrSecondDerivative;
                        int i4 = length;
                        double d3 = f4;
                        float f5 = (float) ((((double) pointF.y) * d2) + (((double) pointF2.y) * d) + (((d3 * d3) / 6.0d) * (((((d2 * d2) * d2) - d2) * dArr[i]) + ((((d * d) * d) - d) * dArr[i2]))));
                        float f6 = 255.0f;
                        if (f5 > 255.0f) {
                            f5 = f6;
                        } else {
