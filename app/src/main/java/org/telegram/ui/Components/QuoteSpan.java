...
public class QuoteSpan implements LeadingMarginSpan {
    ...
    public static ArrayList updateQuoteBlocks(View view, Layout layout, ArrayList arrayList, boolean[] zArr) {
        ...
        if (layout != null) {
            ...
            if (text != null && (text instanceof Spannable)) {
                ...
                int i2 = 0;
                while (i2 < quoteSpanArr.length) {
                    QuoteSpan quoteSpan = quoteSpanArr[i2];
                    boolean z = quoteSpan.last;
                    Block block = new Block(view, layout, spannable, quoteSpan);
                    QuoteSpan quoteSpan2 = block.span;
                    if (quoteSpan2.edit) {
                        int i3 = quoteSpan2.start;
                        if (i3 != 0 && text.charAt(i3 - 1) != '\n') {
                            spannable.removeSpan(quoteSpanArr[i2]);
                            spannable.removeSpan(quoteSpanArr[i2].styleSpan);
                            QuoteCollapsedPart quoteCollapsedPart = quoteSpanArr[i2].collapsedSpan;
                            ...
                            if (block.span.end != text.length() && text.charAt(block.span.end) != '\n') {
                                int i4 = block.span.end;
                                while (i4 <= text.length() && i4 != text.length() && text.charAt(i4) != '\n') {
                                    i4++;
                                }
                                spannable.removeSpan(quoteSpanArr[i2]);
                                spannable.removeSpan(quoteSpanArr[i2].styleSpan);
                                spannable.setSpan(quoteSpanArr[i2], block.span.start, i4, 33);
                                spannable.setSpan(quoteSpanArr[i2].styleSpan, block.span.start, i4, 33);
                                block = new Block(view, layout, spannable, quoteSpanArr[i2]);
                            }
                            if (spannable instanceof SpannableStringBuilder) {
                                ...
                                char c4 = (i5 + (-1) < 0 || spannableStringBuilder.charAt(i5 + (-1)) != '\n') ? c3 : (char) 1;
                                if (block.hasButton()) {
                                ...
                                if (c4 != c2) {
                                    ...
                                    if (c4 != 0) {
                                        ...
                                        i = i7 + 2;
                                        char c5 = (Selection.getSelectionStart(spannableStringBuilder) == block.span.end && Selection.getSelectionStart(spannableStringBuilder) == Selection.getSelectionEnd(spannableStringBuilder)) ? (char) 1 : c3;
                                    ...
                                    block.span.end = Math.min(i, spannable.length());
                                    spannable.removeSpan(quoteSpanArr[i2]);
                                    spannable.removeSpan(quoteSpanArr[i2].styleSpan);
                                    QuoteSpan quoteSpan4 = block.span;
                                    int i9 = quoteSpan4.start;
                                    int i10 = quoteSpan4.end;
                                    if (i9 > i10) {
                                        i9 = i10;
                                    }
                                    spannable.setSpan(quoteSpanArr[i2], i9, i10, 33);
                                    spannable.setSpan(quoteSpanArr[i2].styleSpan, i9, i10, 33);
                                    if (zArr != null) {
                                        zArr[c] = true;
                                    }
                                } else {
                            ...
                            if (quoteSpan5.isCollapsing) {
                                int lineStart = layout.getLineStart(Math.min(layout.getLineForOffset(quoteSpan5.start) + COLLAPSE_LINES, layout.getLineCount()));
                                int i11 = block.span.end;
                                if (lineStart > spannable.length()) {
                                    lineStart = spannable.length();
                                }
                                if (lineStart < i11) {
                                    QuoteSpan quoteSpan6 = block.span;
                                    if (quoteSpan6.collapsedSpan == null) {
                                        quoteSpan6.collapsedSpan = new QuoteCollapsedPart(block.span);
                                    }
                                    spannable.setSpan(block.span.collapsedSpan, lineStart, i11, 33);
                                }
                            }
                        }
                        i2++;
                    ...
                    if (quoteSpanArr[i2].last != z && zArr != null) {
                        zArr[c] = true;
                    }
    ...
    public static class Block {
        ...
        /* JADX WARN: Code duplicated, block: B:31:0x02b1  */
        /* JADX WARN: Code duplicated, block: B:33:0x02ce  */
        public void draw(Canvas canvas, float f, int i, int i2, float f2, TextPaint textPaint) {
            ...
            if (iDp >= ((double) i) * 0.95d) {
                iDp = i;
            }
            canvas.save();
            canvas.translate(0.0f, f);
            RectF rectF = AndroidUtilities.rectTmp;
            rectF.set(0.0f, this.top, iDp, this.bottom);
            ...
            if (quoteSpan2.edit && this.view != null) {
                if (quoteSpan2.isCollapsing != quoteSpan2.expandTextCollapsed) {
                    ...
                    boolean z = quoteSpan3.isCollapsing;
                    quoteSpan3.expandTextCollapsed = z;
                ...
                c3 = 2;
                float f3 = i3;
                this.collapseButtonBounds.set(i3 - iDp2, (i4 - iDp4) - iDp3, f3, i4 - iDp4);
                ...
                quoteSpan = this.span;
                if (!quoteSpan.rtl) {
                    intrinsicHeight = (int) (((this.top + this.bottom) - quoteSpan.quoteDrawable.getIntrinsicHeight()) / 2.0f);
            ...
            c3 = 2;
            rectF.set(-AndroidUtilities.dp(3.0f), this.top, 0.0f, this.bottom);
            float[] fArr16 = this.span.linePathRadii;
            float[] fArr17 = this.span.linePathRadii;
            float[] fArr18 = this.span.linePathRadii;
            float[] fArr19 = this.span.linePathRadii;
            float fDp3 = AndroidUtilities.dp(4.0f);
            fArr19[c2] = fDp3;
            fArr18[c4] = fDp3;
            fArr17[c] = fDp3;
            fArr16[0] = fDp3;
            float[] fArr110 = this.span.linePathRadii;
            float[] fArr111 = this.span.linePathRadii;
            float[] fArr112 = this.span.linePathRadii;
            this.span.linePathRadii[5] = 0.0f;
            fArr112[4] = 0.0f;
            fArr111[3] = 0.0f;
            fArr110[c3] = 0.0f;
