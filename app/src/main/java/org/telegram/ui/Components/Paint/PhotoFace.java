...
public class PhotoFace {
    ...
    public PhotoFace(Face face, Bitmap bitmap, Size size, boolean z) {
        ...
        if (pointTransposePoint != null && pointTransposePoint2 != null) {
            ...
            float degrees = (float) Math.toDegrees(Math.atan2(pointTransposePoint2.y - pointTransposePoint.y, pointTransposePoint2.x - pointTransposePoint.x) + 3.141592653589793d);
            this.angle = degrees;
