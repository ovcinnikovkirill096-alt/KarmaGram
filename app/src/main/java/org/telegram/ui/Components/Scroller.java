...
public class Scroller {
    ...
    public void fling(int i, int i2, int i3, int i4, int i5, int i6, int i7, int i8) {
        ...
        if (this.mFlywheel && !this.mFinished) {
            ...
            int iExp = (int) (((double) 800.0f) * Math.exp((((double) f9) / (((double) f9) - 1.0d)) * dLog));
            this.mMinX = i5;
            this.mMaxX = i6;
            this.mMinY = i7;
            this.mMaxY = i8;
            float f10 = iExp;
            int iRound = i + Math.round(f * f10);
            this.mFinalX = iRound;
            int iMin = Math.min(iRound, this.mMaxX);
            this.mFinalX = iMin;
        ...
        int iExp2 = (int) (((double) 800.0f) * Math.exp((((double) f11) / (((double) f11) - 1.0d)) * dLog2));
        this.mMinX = i5;
        this.mMaxX = i6;
        this.mMinY = i7;
        this.mMaxY = i8;
        float f12 = iExp2;
        int iRound3 = i + Math.round(f * f12);
        this.mFinalX = iRound3;
        int iMin3 = Math.min(iRound3, this.mMaxX);
        this.mFinalX = iMin3;
        this.mFinalX = Math.max(iMin3, this.mMinX);
        int iRound4 = Math.round(f12 * f8) + i2;
