...
public class PremiumPreviewBottomSheet extends BottomSheetWithRecyclerListView implements NotificationCenter.NotificationCenterDelegate {
    ...
    /* JADX WARN: Code duplicated, block: B:89:0x028c  */
    /* JADX WARN: Code duplicated, block: B:91:0x02aa  */
    /* JADX WARN: Code duplicated, block: B:92:0x02b1  */
        ...
        if (tL_emojiStatusCollectible != null) {
                ...
                if (stickerSet == null || stickerSet.documents.isEmpty()) {
                    ...
                    if (stickerSet.set != null) {
                        for (int i2 = 0; i2 < stickerSet.documents.size(); i2++) {
                            if (((TLRPC.Document) stickerSet.documents.get(i2)).id == stickerSet.set.thumb_document_id) {
                                document = (TLRPC.Document) stickerSet.documents.get(i2);
                                break;
                            }
                        }
                    }
            ...
            if (giftPremiumBottomSheet$GiftTier != null) {
                if (this.isOutboundGift) {
                    ...
                    String string2 = LocaleController.formatString(i5, user4 != null ? user4.first_name : _UrlKt.FRAGMENT_ENCODE_SET, LocaleController.formatPluralString("GiftMonths", giftPremiumBottomSheet$GiftTier.getMonths(), new Object[0]));
                    ...
                    if (user5 != null) {
                        str = user5.first_name;
                    }
                    String string3 = LocaleController.formatString(i6, str);
    ...
    /* JADX INFO: renamed from: org.telegram.ui.Components.Premium.PremiumPreviewBottomSheet$4, reason: invalid class name */
