    ...
    public EmptyTextProgressView(Context context, View view, Theme.ResourcesProvider resourcesProvider) {
        ...
        setOnTouchListener(new View.OnTouchListener() { // from class: org.telegram.ui.Components.EmptyTextProgressView$$ExternalSyntheticLambda0
            ...
            public final boolean onTouch(View view2, MotionEvent motionEvent) {
                return EmptyTextProgressView.m9104$r8$lambda$Vq18KDUqpLFj2u41GI6nolj8(view2, motionEvent);
            }
        });
    }

    /* JADX INFO: renamed from: $r8$lambda$Vq18KDUqpLFj2-u41GI6no-lj-8, reason: not valid java name */
    public static /* synthetic */ boolean m9104$r8$lambda$Vq18KDUqpLFj2u41GI6nolj8(View view, MotionEvent motionEvent) {
        return true;
    }
