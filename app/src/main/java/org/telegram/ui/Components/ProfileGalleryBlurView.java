        ...
        if (profileGalleryView != null && profileGalleryView.isAttachedToWindow() && this.view.getVisibility() != 8) {
            ...
            synchronized (profileGalleryBlurView.lock) {
                try {
                    ...
                    if (profileGalleryBlurView.offset != 0 && profileGalleryBlurView.paints[r7].getShader() != null) {
                        canvas2.save();
                        ...
                        canvas2.drawRect(0.0f, i3, profileGalleryBlurView.frameWidth, i3 + f7, profileGalleryBlurView.paints[r7]);
                        canvas.restore();
                        profileGalleryBlurView.paints[r7].setAlpha((int) (f4 * 255.0f));
                        int i4 = profileGalleryBlurView.frameHeight;
                        canvas.drawRect(0.0f, i4 * f3, profileGalleryBlurView.frameWidth, i4, profileGalleryBlurView.paints[r7]);
                        profileGalleryBlurView.paints[1].setAlpha(255);
                        canvas.restore();
                    }
                } catch (Throwable th) {
                    throw th;
