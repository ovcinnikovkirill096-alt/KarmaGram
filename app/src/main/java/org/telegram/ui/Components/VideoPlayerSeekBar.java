...
public class VideoPlayerSeekBar {
        ...
        try {
            ...
            Collections.sort(this.timestamps, new Comparator() { // from class: org.telegram.ui.Components.VideoPlayerSeekBar$$ExternalSyntheticLambda0
                ...
                public final int compare(Object obj, Object obj2) {
                    return VideoPlayerSeekBar.m11929$r8$lambda$o3EHnMr9BcAI6WfiUzSrQzpwFA((Pair) obj, (Pair) obj2);
                }
            });
        } catch (Exception e) {
            FileLog.e(e);
    ...
    public static /* synthetic */ int m11929$r8$lambda$o3EHnMr9BcAI6WfiUzSrQzpwFA(Pair pair, Pair pair2) {
    ...
    /* JADX WARN: Code duplicated, block: B:93:0x0209 A[EDGE_INSN: B:93:0x0209->B:84:0x0209 BREAK  A[LOOP:2: B:30:0x00d9->B:83:0x01fe], SYNTHETIC] */
    /* JADX WARN: Code duplicated, block: B:94:0x01fe A[SYNTHETIC] */
    private void drawProgressBar(Canvas canvas, RectF rectF, Paint paint2) {
        ...
        while (i3 <= i2) {
            char c5 = c4;
            float fFloatValue = i3 == i ? f2 : ((Float) ((Pair) videoPlayerSeekBar.timestamps.get(i3 - 1)).first).floatValue();
            float fFloatValue2 = i3 == i2 ? f3 : ((Float) ((Pair) videoPlayerSeekBar.timestamps.get(i3)).first).floatValue();
            ...
            if (f5 >= f6) {
                ...
                if (i3 != i) {
                    ...
                    if (i3 >= i2) {
                        ...
                        float f8 = 0.7f * fDp * videoPlayerSeekBar.timestampsAppearing;
                        fArr2[5] = f8;
                        fArr2[c2] = f8;
                        fArr2[3] = f8;
                        fArr2[c] = f8;
                ...
                fArr3[c5] = fDp;
                fArr3[0] = fDp;
                float f9 = 0.7f * fDp * videoPlayerSeekBar.timestampsAppearing;
                fArr3[5] = f9;
                fArr3[c2] = f9;
                fArr3[3] = f9;
                fArr3[c] = f9;
    ...
    private void drawTimestampLabel(Canvas canvas) {
        ...
        while (true) {
            if (size < 0) {
                size = -1;
                break;
            } else if (((Float) ((Pair) this.timestamps.get(size)).first).floatValue() - 0.001f <= f2) {
                break;
            } else {
                size--;
            }
        ...
        float fAbs = Math.abs(fLerp - f3) - AndroidUtilities.dp(16.0f);
        float f4 = this.lastWidth;
        if (f4 > 0.0f && Math.abs(f4 - fAbs) > 0.01f) {
            StaticLayout[] staticLayoutArr = this.timestampLabel;
        ...
        canvas.save();
        int i2 = this.height;
        canvas.translate(fLerp + ((fLerp2 - f3) * this.transitionProgress), AndroidUtilities.lerp((this.lineHeight + i2) / f, i2 - AndroidUtilities.dp(3.0f), this.transitionProgress) + AndroidUtilities.dp(12.0f));
        ...
        if (this.timestampLabel[r14] != null) {
            canvas.save();
            if (this.timestampChangeDirection != 0) {
            ...
            canvas.translate(0.0f, (-this.timestampLabel[r14].getHeight()) / f);
