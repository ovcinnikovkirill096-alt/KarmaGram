...
public abstract class ScrollSlidingTabStrip extends HorizontalScrollView {
  ...
  0x0021: PHI (r0v13 int) = (r0v5 int), (r0v8 int), (r0v16 int) binds: [B:14:0x0049, B:11:0x0038, B:5:0x001f] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    /* JADX INFO: renamed from: org.telegram.ui.Components.ScrollSlidingTabStrip$7, reason: invalid class name */
    ...
    public void setImages() {
        ...
        for (int i2 = 0; i2 < this.currentPlayingImages.size(); i2++) {
            this.currentPlayingImagesTmp.put(((StickerTabView) this.currentPlayingImages.valueAt(i2)).index, (StickerTabView) this.currentPlayingImages.valueAt(i2));
        }
            ...
            if (childAt instanceof StickerTabView) {
                ...
                if (stickerTabView.type == 2) {
                    ...
                    if (tag3 instanceof TLRPC.Document) {
                        ...
                        if (tag4 instanceof TLRPC.TL_messages_stickerSet) {
                            ...
                            if (!stickerTabView.inited) {
                                ...
                                stickerTabView.svgThumb = DocumentObject.getSvgThumb(arrayList2, Theme.key_emptyListPlaceholder, 0.2f, DocumentObject.containsPhotoSizeType(arrayList2, RegisterSpec.PREFIX));
                            }
                        } else {
                            i = 0;
                        }
                    ...
                    if (imageLocation != null) {
                        ...
                        if ((str != null || !MessageObject.isVideoSticker(document) || (arrayList = document.thumbs) == null || arrayList.size() <= 0) && (str == null || !str.equalsIgnoreCase(RegisterSpec.PREFIX))) {
        ...
        for (int i3 = 0; i3 < this.currentPlayingImagesTmp.size(); i3++) {
            if (((StickerTabView) this.currentPlayingImagesTmp.valueAt(i3)) != this.draggingView) {
                ((StickerTabView) this.currentPlayingImagesTmp.valueAt(i3)).imageView.setImageDrawable(null);
            }
        }
    }
