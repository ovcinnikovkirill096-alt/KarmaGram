...
public class ViewPagerFixed extends FrameLayout {
    ...
    /* JADX WARN: Code duplicated, block: B:30:0x0045  */
    /* JADX WARN: Code duplicated, block: B:31:0x0047  */
    /* JADX WARN: Code duplicated, block: B:34:0x004f A[RETURN] */
        ...
        if (motionEvent != null && motionEvent.getAction() == 0 && !this.startedTracking && !this.maybeStartTracking) {
            ...
            if (this.startedTracking && (((z = this.animatingForward) && x2 > 0) || (!z && x2 < 0))) {
                if (!prepareForMoving(motionEvent, x2 < 0)) {
                    ...
                    if (view2 != null) {
                        setTranslationX(view2, this.animatingForward ? viewArr[0].getMeasuredWidth() : -viewArr[0].getMeasuredWidth());
                    }
                    this.nextPosition = 0;
                    this.currentProgress = 1.0f;
            ...
            if (this.maybeStartTracking && !this.startedTracking) {
                ...
                if (this.nextPosition == -1) {
                    ...
                    if (view3 != null) {
                        if (this.animatingForward) {
                            setTranslationX(view3, viewArr2[0].getMeasuredWidth() + x2);
                        } else {
                            setTranslationX(view3, x2 - viewArr2[0].getMeasuredWidth());
                        }
                    }
                }
                float f = 1.0f - fAbs;
            ...
            if (this.startedTracking) {
                ...
                } else if (Math.abs(xVelocity) > AppUtils.getSwipeVelocity()) {
                ...
                if (this.backAnimation) {
                    ...
                    if (this.animatingForward) {
                        ...
                        animatorSet.playTogether(translateAnimator(view7, -view7.getMeasuredWidth()));
                        ...
                        animatorSet2.playTogether(translateAnimator(view9, view9.getMeasuredWidth()));
                        View view10 = this.viewPages[1];
                        if (view10 != null) {
                            this.tabsAnimation.playTogether(translateAnimator(view10, 0.0f));
                        }
                    }
                } else {
                    measuredWidth = 0.0f;
    ...
    public static class TabsView extends FrameLayout {
        ...
        public class TabView extends View {
            ...
            protected void onDraw(Canvas canvas) {
                ...
                canvas2.save();
                float f2 = this.shakeAlpha.set(this.reordering);
                if (f2 > 0.0f) {
                    if (this.shaker == null) {
                        this.shaker = new Shaker(this);
                    }
                    canvas2.translate(getWidth() / 2.0f, getHeight() / 2.0f);
                    this.shaker.concat(canvas2, f2);
                    canvas2.translate((-getWidth()) / 2.0f, (-getHeight()) / 2.0f);
                }
                if (this.currentTab.id != Integer.MAX_VALUE && TabsView.this.editingAnimationProgress != 0.0f) {
                    canvas2.save();
                    float f3 = TabsView.this.editingAnimationProgress * (this.currentPosition % 2 == 0 ? 1.0f : -1.0f);
                    canvas2.translate(AndroidUtilities.dp(0.66f) * f3, 0.0f);
                    canvas2.rotate(f3, getMeasuredWidth() / 2, getMeasuredHeight() / 2);
                }
                ...
                if (str2 != null || (this.currentTab.id != Integer.MAX_VALUE && (TabsView.this.isEditing || TabsView.this.editingStartAnimationProgress != 0))) {
                    canvas2 = canvas2;
                    canvas2 = canvas2;
                    canvas2 = canvas2;
                    ...
                    if (this.currentTab.id != Integer.MAX_VALUE && ((TabsView.this.isEditing || TabsView.this.editingStartAnimationProgress != r7) && str2 == null)) {
                    ...
                    canvas2.drawRoundRect(rectF, f4 * 11.5f, f4 * 11.5f, TabsView.this.counterPaint);
                    if (str2 != null) {
                        if (this.currentTab.id != Integer.MAX_VALUE) {
                            TabsView.this.textCounterPaint.setAlpha((int) ((f - TabsView.this.editingStartAnimationProgress) * 255.0f));
                        }
                        RectF rectF2 = this.rect;
                        canvas2.drawText(str2, rectF2.left + ((rectF2.width() - i8) / 2.0f), measuredHeight + AndroidUtilities.dp(14.5f), TabsView.this.textCounterPaint);
                    }
                    if (this.currentTab.id != Integer.MAX_VALUE && (TabsView.this.isEditing || TabsView.this.editingStartAnimationProgress != r7)) {
                ...
                canvas2 = canvas2;
                canvas2 = canvas2;
                if (this.currentTab.id != Integer.MAX_VALUE && TabsView.this.editingAnimationProgress != r7) {
                    canvas.restore();
                }
                canvas.restore();
            }
            ...
            if (view == this.listView) {
                ...
                if (this.animatingIndicator || this.manualScrollingToPosition != -1) {
                    ...
                    if (iFindFirstVisibleItemPosition == -1 || (viewHolderFindViewHolderForAdapterPosition = this.listView.findViewHolderForAdapterPosition(iFindFirstVisibleItemPosition)) == null) {
                        ...
                        int i5 = this.positionToX.get(i);
                        int i6 = this.positionToX.get(i2);
                        int i7 = this.positionToWidth.get(i);
                        int i8 = this.positionToWidth.get(i2);
                        if (this.additionalTabWidth != 0) {
                            left = ((int) (i5 + ((i6 - i5) * this.animatingIndicatorProgress))) + AndroidUtilities.dp(this.tabMarginDp);
                        } else {
                            left = (((int) (i5 + ((i6 - i5) * this.animatingIndicatorProgress))) - (this.positionToX.get(iFindFirstVisibleItemPosition) - viewHolderFindViewHolderForAdapterPosition.itemView.getLeft())) + AndroidUtilities.dp(this.tabMarginDp);
                        }
                        i3 = (int) (i7 + ((i8 - i7) * this.animatingIndicatorProgress));
                        int i9 = i3;
                        i4 = left;
                        iLerp = i9;
                    }
                ...
                int x = (int) (i4 + this.listView.getX());
                if (iLerp != 0) {
                    int i11 = this.selectorType;
                    if (i11 == 9 || i11 == 10) {
