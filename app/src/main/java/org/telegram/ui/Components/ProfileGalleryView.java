...
public class ProfileGalleryView extends CircularViewPager implements NotificationCenter.NotificationCenterDelegate {
            ...
            if (!this.isDownReleased) {
                ...
                if (realCount > 1) {
                    if (motionEvent.getX() > getWidth() / 3.0f) {
                        ...
                        extraCount = i2 < extraCount2 ? (realCount + extraCount2) - 1 : i2;
                    }
    ...
    private int getCurrentAvatarPhotoIndex() {
        ...
        for (int i = 0; i < this.photos.size(); i++) {
            ...
            if (photo != null && photo.id == currentAvatarPhoto.id) {
                return i;
            }
        }
        return -1;
                ...
                if (DialogObject.isChatDialog(this.dialogId)) {
                    ...
                    if (forUserOrChat != null) {
                        ...
                        if (chatFull != null && FileLoader.isSamePhoto((TLRPC.FileLocation) forUserOrChat.location, chatFull.chat_photo)) {
                            ...
                            if (!this.chatInfo.chat_photo.video_sizes.isEmpty()) {
                                TLRPC.VideoSize closestVideoSizeWithSize2 = FileLoader.getClosestVideoSizeWithSize(this.chatInfo.chat_photo.video_sizes, MediaDataController.MAX_STYLE_RUNS_COUNT);
                ...
                for (int i5 = 0; i5 < arrayList2.size(); i5++) {
                    ...
                    if (photo2 == null || (photo2 instanceof TLRPC.TL_photoEmpty) || (arrayList = photo2.sizes) == null) {
                        ...
                        for (int i6 = 0; i6 < size; i6++) {
                            TLRPC.PhotoSize photoSize2 = (TLRPC.PhotoSize) photo2.sizes.get(i6);
                        ...
                        if (forUserOrChat != null) {
                            ...
                            while (true) {
                                if (i7 < size2) {
                                    TLRPC.FileLocation fileLocation = ((TLRPC.PhotoSize) photo2.sizes.get(i7)).location;
                                    ...
                                    if (closestPhotoSizeWithSize != null) {
                                        ...
                                        if (forPhoto != null) {
                                            ...
                                            if (imageLocation == null && imageLocation.photoId == forPhoto.photoId && !this.isProfileFragment && this.dialogId != UserConfig.getInstance(this.currentAccount).getClientUserId()) {
                                                this.thumbsFileNames.add(null);
