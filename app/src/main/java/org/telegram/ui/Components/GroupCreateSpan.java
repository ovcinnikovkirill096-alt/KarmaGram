...
public class GroupCreateSpan extends View {
    ...
    /* JADX WARN: Code duplicated, block: B:73:0x02c6  */
    /* JADX WARN: Code duplicated, block: B:74:0x02c9  */
    /* JADX WARN: Code duplicated, block: B:77:0x02de  */
    /* JADX WARN: Code duplicated, block: B:78:0x02e0  */
    /* JADX WARN: Code duplicated, block: B:80:0x02e9  */
    /* JADX WARN: Code duplicated, block: B:81:0x02ec  */
    /* JADX WARN: Code duplicated, block: B:84:0x02f5  */
    /* JADX WARN: Code duplicated, block: B:85:0x02f8  */
    /* JADX WARN: Code duplicated, block: B:88:0x030a A[DONT_INVERT] */
    /* JADX WARN: Code duplicated, block: B:90:0x030d  */
    ...
    public GroupCreateSpan(Context context, Object obj, ContactsController.Contact contact, boolean z, Theme.ResourcesProvider resourcesProvider) {
        ...
        if (!z2) {
            ...
            staticLayout = new StaticLayout(TextUtils.ellipsize(Emoji.replaceEmoji(string.replace('\n', ' '), textPaint.getFontMetricsInt(), false), textPaint, iMin, TextUtils.TruncateAt.END), textPaint, MediaDataController.MAX_STYLE_RUNS_COUNT, Layout.Alignment.ALIGN_NORMAL, 1.0f, 0.0f, false);
