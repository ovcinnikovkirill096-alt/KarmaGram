...
public class VoIpSwitchLayout extends FrameLayout {
    ...
    /* JADX INFO: renamed from: org.telegram.ui.Components.voip.VoIpSwitchLayout$4, reason: invalid class name */
    ...
    public void setType(Type type, boolean z, boolean z2) {
        ...
        if (i == 1) {
            if (this.type != Type.MICRO) {
                this.voIpButtonView.unSelectedIcon = new RLottieDrawable(R.raw.call_mute, _UrlKt.FRAGMENT_ENCODE_SET + R.raw.call_mute, iDp, iDp, true, null);
                this.voIpButtonView.selectedIcon = new RLottieDrawable(R.raw.call_mute, _UrlKt.FRAGMENT_ENCODE_SET + R.raw.call_mute, iDp, iDp, true, null);
            ...
            if (i == 2) {
                ...
                if (type2 == Type.SPEAKER || type2 == Type.BLUETOOTH) {
                    ...
                    this.voIpButtonView.singleIcon = new RLottieDrawable(R.raw.camera_flip2, _UrlKt.FRAGMENT_ENCODE_SET + R.raw.camera_flip2, iDp, iDp, true, null);
                ...
                this.voIpButtonView.unSelectedIcon = new RLottieDrawable(R.raw.video_stop, _UrlKt.FRAGMENT_ENCODE_SET + R.raw.video_stop, iDp, iDp, true, null);
                this.voIpButtonView.selectedIcon = new RLottieDrawable(R.raw.video_stop, _UrlKt.FRAGMENT_ENCODE_SET + R.raw.video_stop, iDp, iDp, true, null);
                this.voIpButtonView.selectedIcon.setColorFilter(new PorterDuffColorFilter(-16777216, PorterDuff.Mode.MULTIPLY));
                this.voIpButtonView.selectedIcon.setMasterParent(this.voIpButtonView);
            }
            if (!z3) {
                ...
                voIpButtonView3.setSelectedState(z, z4, type);
            }
            setText(type, z);
            this.type = type;
        }
