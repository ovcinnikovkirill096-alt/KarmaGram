...
public class LivePlayer implements NotificationCenter.NotificationCenterDelegate, AudioManager.OnAudioFocusChangeListener {
    ...
    public static /* synthetic */ void m17511$r8$lambda$Zf53pjibKnjUHxoDqBPPYdZKM(int[] iArr, float[] fArr, boolean[] zArr) {
    }
    ...
    public void continueStreaming() {
        ...
        PermissionRequest.ensureAllPermissions(R.raw.permission_request_camera, R.string.PermissionNoCameraMicVideo, new String[]{"android.permission.CAMERA", "android.permission.RECORD_AUDIO"}, new Utilities.Callback() { // from class: org.telegram.ui.Stories.LivePlayer$$ExternalSyntheticLambda12
    ...
    private void init() {
        ...
        NativeInstance nativeInstanceMakeGroup = NativeInstance.makeGroup(VoIPHelper.getLogFilePath("live_" + this.inputCall.id), 0L, false, SharedConfig.noiseSupression, new NativeInstance.PayloadCallback() { // from class: org.telegram.ui.Stories.LivePlayer$$ExternalSyntheticLambda5
            ...
            public final void run(int[] iArr, float[] fArr, boolean[] zArr) {
                LivePlayer.m17511$r8$lambda$Zf53pjibKnjUHxoDqBPPYdZKM(iArr, fArr, zArr);
            }
