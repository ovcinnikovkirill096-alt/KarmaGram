...
public abstract class SelfStoryViewsPage extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    class AnonymousClass4 implements RecyclerListView.OnItemLongClickListener {
        ...
        public boolean onItemClick(View view, int i) {
            ...
            if (TextUtils.isEmpty(user.first_name)) {
                strSubstring = TextUtils.isEmpty(user.last_name) ? _UrlKt.FRAGMENT_ENCODE_SET : user.last_name;
            } else {
            ...
            final ItemOptions itemOptionsAddIf = ItemOptions.makeOptions(this.val$storyViewer.containerView, SelfStoryViewsPage.this.resourcesProvider, view).setGravity(3).ignoreX().setScrimViewBackground(new ColorDrawable(Theme.getColor(Theme.key_dialogBackground, SelfStoryViewsPage.this.resourcesProvider))).setDimAlpha(133).addIf((!zIsStoryShownToUser || zIsBlocked || z2 || zIsUserSelf) ? false : true, R.drawable.msg_stories_myhide, LocaleController.formatString(R.string.StoryHideFrom, strSubstring), new Runnable() { // from class: org.telegram.ui.Stories.SelfStoryViewsPage$4$$ExternalSyntheticLambda0
    ...
    /* JADX WARN: Code duplicated, block: B:124:0x01e1  */
    ...
    class ListAdapter extends RecyclerListView.SelectionAdapter {
        ...
        /* JADX WARN: Code duplicated, block: B:26:0x00e9 A[DONT_INVERT] */
        /* JADX WARN: Code duplicated, block: B:27:0x00eb  */
        /* JADX WARN: Code duplicated, block: B:28:0x00fb A[DONT_INVERT] */
        ...
        /* JADX WARN: Code duplicated, block: B:39:0x0196  */
            ...
            switch (i) {
                case 0:
                    fixedHeightEmptyCell = new View(SelfStoryViewsPage.this.getContext()) { // from class: org.telegram.ui.Stories.SelfStoryViewsPage.ListAdapter.1
                        ...
                        protected void onMeasure(int i4, int i5) {
                            super.onMeasure(i4, View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(SelfStoryViewsPage.this.TOP_PADDING), TLObject.FLAG_30));
                        }
                    };
                    break;
                case 1:
                    ...
                    SelfStoryViewsPage selfStoryViewsPage = SelfStoryViewsPage.this;
                    fixedHeightEmptyCell = new ReactedUserHolderView(i4, selfStoryViewsPage.currentAccount, selfStoryViewsPage.getContext(), SelfStoryViewsPage.this.resourcesProvider, false, true) { // from class: org.telegram.ui.Stories.SelfStoryViewsPage.ListAdapter.2
                ...
                default:
                    fixedHeightEmptyCell = new View(SelfStoryViewsPage.this.getContext()) { // from class: org.telegram.ui.Stories.SelfStoryViewsPage.ListAdapter.3
                        ...
                        protected void onMeasure(int i5, int i6) {
                            ...
                            super.onMeasure(i5, View.MeasureSpec.makeMeasureSpec(lastItemHeight, TLObject.FLAG_30));
                        }
                    };
                    break;
                case 3:
                ...
                case 10:
                    if (!SelfStoryViewsPage.this.defaultModel.isExpiredViews) {
                        ...
                        stickerEmptyView = new StickerEmptyView(SelfStoryViewsPage.this.getContext(), null, i2, SelfStoryViewsPage.this.resourcesProvider) { // from class: org.telegram.ui.Stories.SelfStoryViewsPage.ListAdapter.4
                            @Override // android.widget.FrameLayout, android.view.View
                            protected void onMeasure(int i5, int i6) {
                                super.onMeasure(i5, View.MeasureSpec.makeMeasureSpec((SelfStoryViewsPage.this.measuerdHeight - SelfStoryViewsPage.this.recyclerListView.getPaddingTop()) - AndroidUtilities.dp(SelfStoryViewsPage.this.TOP_PADDING), TLObject.FLAG_30));
                            }
                        };
                        if (i == 7) {
                    ...
                    if (i == 7) {
                        ...
                        if (!MessagesController.getInstance(SelfStoryViewsPage.this.currentAccount).premiumFeaturesBlocked()) {
                            spannableStringBuilder.append((CharSequence) "\n\n");
                            String string3 = LocaleController.getString(R.string.ExpiredViewsStubPremiumDescription);
                            final SelfStoryViewsPage selfStoryViewsPage4 = SelfStoryViewsPage.this;
                            spannableStringBuilder.append((CharSequence) AndroidUtilities.replaceSingleTag(string3, new Runnable() { // from class: org.telegram.ui.Stories.SelfStoryViewsPage$ListAdapter$$ExternalSyntheticLambda1
                                @Override // java.lang.Runnable
                                public final void run() {
                                    selfStoryViewsPage4.showPremiumAlert();
                                }
                            }));
                            String string4 = LocaleController.getString(R.string.LearnMore);
                            final SelfStoryViewsPage selfStoryViewsPage5 = SelfStoryViewsPage.this;
                            stickerEmptyView.createButtonLayout(string4, new Runnable() { // from class: org.telegram.ui.Stories.SelfStoryViewsPage$ListAdapter$$ExternalSyntheticLambda1
                                @Override // java.lang.Runnable
                                public final void run() {
                                    selfStoryViewsPage5.showPremiumAlert();
                                }
                            });
                        }
                        stickerEmptyView.subtitle.setText(spannableStringBuilder);
                ...
                case 12:
                    ...
                    if (i == 11) {
                        linksTextView.setText(AndroidUtilities.replaceSingleTag(LocaleController.getString(R.string.StoryViewsPremiumHint), new Runnable() { // from class: org.telegram.ui.Stories.SelfStoryViewsPage$ListAdapter$$ExternalSyntheticLambda0
                            @Override // java.lang.Runnable
                            public final void run() {
        ...
        private void applyLocalFilter() {
            ...
            Collections.sort(this.views, Comparator.CC.comparingInt(new ToIntFunction() { // from class: org.telegram.ui.Stories.SelfStoryViewsPage$ViewsModel$$ExternalSyntheticLambda2
                ...
                public final int applyAsInt(Object obj) {
                    return SelfStoryViewsPage.ViewsModel.m17813$r8$lambda$keJViVULdsq7Tmm19unD9O4elA((TL_stories.StoryView) obj);
                }
            }));
        }

        /* JADX INFO: renamed from: $r8$lambda$keJViVULdsq7T-mm19unD9O4elA, reason: not valid java name */
        public static /* synthetic */ int m17813$r8$lambda$keJViVULdsq7Tmm19unD9O4elA(TL_stories.StoryView storyView) {
