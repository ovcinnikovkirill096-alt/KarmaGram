...
public class StoryLinesDrawable {
    ...
    public void draw(Canvas canvas, int i, int i2, float f, int i3, float f2, float f3, boolean z, boolean z2, float f4) {
        ...
        float f6 = storyLinesDrawable.zoomT.set(z2);
        if (f6 > 0.0f) {
            float fLerp = AndroidUtilities.lerp(f, f4, f6);
            canvas.save();
            storyLinesDrawable.zoomHintPaint.setAlpha((int) (f6 * 255.0f));
            f = fLerp;
            storyLinesDrawable.zoomHintPaint.setShadowLayer(AndroidUtilities.dp(3.0f), 0.0f, AndroidUtilities.dp(1.0f), Theme.multAlpha(805306368, f6));
            canvas.translate(((i5 - storyLinesDrawable.zoomHintLayoutWidth) / 2.0f) - storyLinesDrawable.zoomHintLayoutLeft, AndroidUtilities.lerp(AndroidUtilities.dp(4.0f), AndroidUtilities.dp(16.0f), f6));
        ...
        while (i7 < i6) {
            ...
            if (fDp2 <= i5) {
                float f8 = fDp2 + fDp;
                if (f8 >= 0.0f && f3 > 0.0f) {
                    float fLerp2 = AndroidUtilities.lerp(fMin, AndroidUtilities.dpf2(2.0f), f6);
                    if (i7 > i2 || i7 != i2) {
                        f7 = f7;
                        f5 = 1.0f;
                    } else {
                        ...
                        f7 = f7;
                        rectF.set(fDp2, 0.0f, f8, AndroidUtilities.lerp(AndroidUtilities.dpf2(2.0f), AndroidUtilities.dpf2(5.0f), (i2 == i7 ? 1 : 0) * f6));
                        if (z3) {
                            if (storyLinesDrawable.incrementBuffering) {
                                float f9 = storyLinesDrawable.bufferingProgress + 0.026666667f;
                                storyLinesDrawable.bufferingProgress = f9;
                                if (f9 > 0.5f) {
                        ...
                        if (f6 > 0.0f) {
                            int i8 = i7 - i2;
                            rectF.left = Utilities.clamp(AndroidUtilities.lerp(rectF.left, (i8 * i) + AndroidUtilities.dp(5.0f), f6), i - AndroidUtilities.dp(5.0f), AndroidUtilities.dp(5.0f));
                            rectF.right = Utilities.clamp(AndroidUtilities.lerp(rectF.right, ((i8 + 1) * i) - AndroidUtilities.dp(5.0f), f6), i - AndroidUtilities.dp(5.0f), AndroidUtilities.dp(5.0f));
                        }
                        canvas.drawRoundRect(rectF, fLerp2, fLerp2, paint2);
                        f5 = f7;
                    }
                    RectF rectF2 = AndroidUtilities.rectTmp;
                    rectF2.set(fDp2, 0.0f, f8, AndroidUtilities.lerp(AndroidUtilities.dpf2(2.0f), AndroidUtilities.dpf2(5.0f), (i2 == i7 ? 1 : 0) * f6));
                    if (f6 > 0.0f) {
                        int i9 = i7 - i2;
                        rectF2.left = Utilities.clamp(AndroidUtilities.lerp(rectF2.left, (i9 * i) + AndroidUtilities.dp(5.0f), f6), i - AndroidUtilities.dp(5.0f), AndroidUtilities.dp(5.0f));
                        rectF2.right = Utilities.clamp(AndroidUtilities.lerp(rectF2.right, ((i9 + 1) * i) - AndroidUtilities.dp(5.0f), f6), i - AndroidUtilities.dp(5.0f), AndroidUtilities.dp(5.0f));
                    }
                    rectF2.right = AndroidUtilities.lerp(rectF2.left, rectF2.right, f5);
                    if (i7 <= i2) {
