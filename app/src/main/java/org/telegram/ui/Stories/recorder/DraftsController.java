        ...
        public StoryDraft(AbstractSerializedData abstractSerializedData, boolean z) {
            ...
            if (abstractSerializedData.remaining() > 0) {
                ...
                if (int37 == 1450380236) {
                    ...
                    this.error = TLRPC.TL_error.TLdeserialize(abstractSerializedData, int37, z);
                }
            ...
            if (abstractSerializedData.remaining() > 0) {
                ...
                if (int38 != 1450380236) {
                    this.botEdit = TLRPC.InputMedia.TLdeserialize(abstractSerializedData, int38, z);
                }
            }
