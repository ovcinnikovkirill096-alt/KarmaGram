...
public class PrivacySettingsActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate {
    ...
    public static /* synthetic */ void m15912$r8$lambda$DPP8PtFalvDYsSlbRJJHb1FeA(TLObject tLObject, TLRPC.TL_error tL_error) {
    }
    ...
    public /* synthetic */ void lambda$createView$18(AlertDialog alertDialog, int i) {
        ...
        getConnectionsManager().sendRequest(tL_payments_clearSavedInfo, new RequestDelegate() { // from class: org.telegram.ui.PrivacySettingsActivity$$ExternalSyntheticLambda24
            @Override // org.telegram.tgnet.RequestDelegate
            public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
                PrivacySettingsActivity.m15912$r8$lambda$DPP8PtFalvDYsSlbRJJHb1FeA(tLObject, tL_error);
            }
        });
    ...
    private class ListAdapter extends RecyclerListView.SelectionAdapter {
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int i) {
            ...
            if (itemViewType == 0) {
                ...
                textSettingsCell.setDrawLoading(z2, i5, z4);
                return;
            }
            if (itemViewType == 1) {
            ...
            if (i == PrivacySettingsActivity.this.autoDeleteMesages) {
                ...
                int i7 = PrivacySettingsActivity.this.sessionsRow;
                ...
                if (i == i7) {
                    ...
                    if (PrivacySettingsActivity.this.currentPassword == null) {
                        ...
                        if (iIndexOf != iLastIndexOf && iIndexOf != -1 && iLastIndexOf != -1) {
                            ...
                            textStyleRun.end = i8;
                            spannableStringBuilderValueOf.setSpan(new TextStyleSpan(textStyleRun), iIndexOf, i8, 0);
                    ...
                    int i10 = PrivacySettingsActivity.this.getMessagesController().totalBlockedCount;
                    if (i10 == 0) {
                        string2 = LocaleController.getString("BlockedEmpty", R.string.BlockedEmpty);
                    } else {
                        if (i10 > 0) {
                            string2 = String.format(LocaleController.getInstance().getCurrentLocale(), TimeModel.NUMBER_FORMAT, Integer.valueOf(i10));
                        } else {
            ...
            textCell.setDrawLoading(z2, 16, z5);
        }
