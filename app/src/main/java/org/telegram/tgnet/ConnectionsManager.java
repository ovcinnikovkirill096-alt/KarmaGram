...
public class ConnectionsManager extends BaseController {
    ...
    public ConnectionsManager(int i) {
        ...
        init(65809, Opcodes.XOR_INT_LIT8, BuildVars.getExteraAppId(), str7, str, str8, str3, str6, string, FileLog.getNetworkLogPath(), regId, "49C1522548EBACD46CE322B6FD47F6092BB745D0F88082145CAF35E14DCC38E1", rawOffset, getUserConfig().getClientUserId(), getUserConfig().getCurrentUser() != null ? getUserConfig().getCurrentUser().premium : false, zIsPushConnectionEnabled);
    }
    ...
    public <T extends TLObject> int sendRequestTyped(TLMethod tLMethod, final Executor executor, final Utilities.Callback2<T, TLRPC.TL_error> callback2, int i, int i2) {
        return sendRequest(tLMethod, new RequestDelegate() { // from class: org.telegram.tgnet.ConnectionsManager$$ExternalSyntheticLambda7
            ...
            public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
                ConnectionsManager.m4133$r8$lambda$8rHrGzkyrliJMokXSq2auMo358(executor, callback2, tLObject, tL_error);
            }
        }, null, null, null, i2, i, 1, true);
    }

    /* JADX INFO: renamed from: $r8$lambda$8rHrGzkyrl-iJMokXSq2auMo358, reason: not valid java name */
    public static /* synthetic */ void m4133$r8$lambda$8rHrGzkyrliJMokXSq2auMo358(Executor executor, final Utilities.Callback2 callback2, final TLObject tLObject, final TLRPC.TL_error tL_error) {
        if (executor != null) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* JADX INFO: renamed from: sendRequestInternal, reason: merged with bridge method [inline-methods] */
        ...
        try {
            ...
            if (tLObjectExecutePreRequestHook == null) {
                ...
                Utilities.stageQueue.postRunnable(new Runnable() { // from class: org.telegram.tgnet.ConnectionsManager$$ExternalSyntheticLambda16
                    @Override // java.lang.Runnable
                    public final void run() {
                        ConnectionsManager.m4135$r8$lambda$D2ugMv1x2U6BVpWEBmN5ANmZL0(requestDelegate2, requestDelegateTimestamp);
                    }
                });
                return;
            }
    ...
    public /* synthetic */ void lambda$sendRequestInternal$6(RequestDelegate requestDelegate, final Long l, Integer num, final long j, TLObject tLObject, TLRPC.TL_error tL_error) {
        ...
        if (dialog == null || (i = dialog.last_message_date) == 0) {
            i = Integer.MAX_VALUE;
        }
        AyuRequestUtils.markReadOnServer(this.currentAccount, l.longValue(), num.intValue(), i, j);
    }
    ...
    /* JADX INFO: renamed from: $r8$lambda$D2-ugMv1x2U6BVpWEBmN5ANmZL0, reason: not valid java name */
    public static /* synthetic */ void m4135$r8$lambda$D2ugMv1x2U6BVpWEBmN5ANmZL0(RequestDelegate requestDelegate, RequestDelegateTimestamp requestDelegateTimestamp) {
        if (requestDelegate != null) {
            requestDelegate.run(null, null);
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$sendRequestInternal$11(TLObject tLObject, int i, long j, final RequestDelegate requestDelegate, final RequestDelegateTimestamp requestDelegateTimestamp, QuickAckDelegate quickAckDelegate, WriteToSocketDelegate writeToSocketDelegate, int i2, int i3, boolean z, int i4, String str, long j2, int i5, String str2, int i6, final long j3, long j4, int i7) {
        int iLimit;
        ...
        try {
            ...
            Utilities.stageQueue.postRunnable(new Runnable() { // from class: org.telegram.tgnet.ConnectionsManager$$ExternalSyntheticLambda3
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.lambda$sendRequestInternal$10(requestDelegate, tLObject3, tL_error4, requestDelegateTimestamp, j3);
                }
            });
        } catch (Exception e2) {
            FileLog.e(e2);
    ...
    public static void onLogout(final int i) {
        AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.tgnet.ConnectionsManager$$ExternalSyntheticLambda8
            @Override // java.lang.Runnable
            public final void run() {
                ConnectionsManager.m4142$r8$lambda$loB8nrbH0oqRzudHM4OT0QQmuA(i);
            }
        });
    }

    /* JADX INFO: renamed from: $r8$lambda$loB8nrbH0oqRzudHM4OT0Q-QmuA, reason: not valid java name */
    public static /* synthetic */ void m4142$r8$lambda$loB8nrbH0oqRzudHM4OT0QQmuA(int i) {
    ...
    public static /* synthetic */ void $r8$lambda$6otnYjIkmMErIgnx1D9Mdsob9zM(final int i, final int i2) {
        ...
        Utilities.stageQueue.postRunnable(new Runnable() { // from class: org.telegram.tgnet.ConnectionsManager$$ExternalSyntheticLambda1
            @Override // java.lang.Runnable
            public final void run() {
                ConnectionsManager.m4139$r8$lambda$ZZyJtFiwxxPLSlMN8xvRRNpAAY(i, zIsNetworkOnline, i2);
            }
        });
    }

    /* JADX INFO: renamed from: $r8$lambda$ZZyJtFiwxxPLSlMN8xvR-RNpAAY, reason: not valid java name */
    public static /* synthetic */ void m4139$r8$lambda$ZZyJtFiwxxPLSlMN8xvRRNpAAY(int i, boolean z, int i2) {
    ...
    public static void getHostByName(final String str, final long j) {
        AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.tgnet.ConnectionsManager$$ExternalSyntheticLambda2
            @Override // java.lang.Runnable
            public final void run() {
                ConnectionsManager.m4138$r8$lambda$T_9M4pSIMsvYNII18iqTZB9dWo(str, j);
            }
        });
    }

    /* JADX INFO: renamed from: $r8$lambda$T_9M4pSIMsvYNII18iqTZB-9dWo, reason: not valid java name */
    public static /* synthetic */ void m4138$r8$lambda$T_9M4pSIMsvYNII18iqTZB9dWo(String str, long j) {
    ...
    public static /* synthetic */ void $r8$lambda$uk9k7jmimCuXawtpPnwQvHSXIFc(boolean z, int i, int i2) {
        boolean z2;
        if (z) {
