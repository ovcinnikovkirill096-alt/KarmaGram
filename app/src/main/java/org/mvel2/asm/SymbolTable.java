...
final class SymbolTable {
    ...
    SymbolTable(ClassWriter classWriter, ClassReader classReader) {
        ...
        byteVector.putByteArray(bArr, item, i3);
        ...
        while (i4 < this.constantPoolCount) {
            int item2 = classReader.getItem(i4);
            ...
            switch (b2) {
                ...
                case 11:
                    ...
                    symbolTable = this;
                    i4 = i4;
                    symbolTable.addConstantMemberReference(i4, b, classReader.readClass(item2, cArr), classReader.readUTF8(item3, cArr), classReader.readUTF8(item3 + 2, cArr));
                    i = i4;
                    if (b != 5) {
                        i2 = 2;
                    } else {
                ...
                case 15:
                    ...
                    symbolTable = this;
                    symbolTable.addConstantMethodHandle(i4, classReader.readByte(item2), classReader.readClass(item4, cArr), classReader.readUTF8(item5, cArr), classReader.readUTF8(item5 + 2, cArr));
                    i = i4;
                    if (b != 5) {
                        i2 = 2;
                    } else {
