...
public class ClassWriter extends ClassVisitor {
    ...
    public byte[] toByteArray() {
        ...
        int i8 = iComputeAttributesSize2;
        if ((this.accessFlags & 65536) == 0 && this.firstRecordComponent == null) {
            ...
            int i10 = i8 + iComputeRecordComponentInfoSize + 8;
            i = attributeCount + 1;
        ...
        if (this.sourceFileIndex != 0) {
            byteVector5.putShort(this.symbolTable.addConstantUtf8(AttSourceFile.ATTRIBUTE_NAME)).putInt(i4).putShort(this.sourceFileIndex);
        }
        ByteVector byteVector7 = this.debugExtension;
        if (byteVector7 != null) {
            int i12 = byteVector7.length;
            i5 = 0;
            byteVector5.putShort(this.symbolTable.addConstantUtf8(AttSourceDebugExtension.ATTRIBUTE_NAME)).putInt(i12).putByteArray(this.debugExtension.data, 0, i12);
        } else {
            i5 = 0;
        }
        if ((this.accessFlags & 131072) != 0) {
            byteVector5.putShort(this.symbolTable.addConstantUtf8(AttDeprecated.ATTRIBUTE_NAME)).putInt(i5);
        }
        ...
        if ((this.accessFlags & 65536) != 0 || this.firstRecordComponent != null) {
            byteVector5.putShort(this.symbolTable.addConstantUtf8("Record")).putInt(iComputeRecordComponentInfoSize + 2).putShort(i2);
