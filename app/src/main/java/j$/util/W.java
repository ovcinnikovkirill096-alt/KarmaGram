...
public final /* synthetic */ class W implements java.util.Spliterator.OfInt {
    ...
    public /* synthetic */ W(Spliterator.OfInt ofInt) {
        this.a = ofInt;
    }

    public static /* synthetic */ java.util.Spliterator.OfInt a(Spliterator.OfInt ofInt) {
        if (ofInt == null) {
            return null;
        }
        return ofInt instanceof V ? ((V) ofInt).a : new W(ofInt);
    }
