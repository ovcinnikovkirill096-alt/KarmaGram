...
public class C0185h implements java.util.Collection, Serializable, Collection {
    ...
    public C0185h(java.util.Collection collection) {
        this.a = (java.util.Collection) Objects.requireNonNull(collection);
        this.b = this;
    }

    public C0185h(java.util.Collection collection, Object obj) {
        this.a = (java.util.Collection) Objects.requireNonNull(collection);
