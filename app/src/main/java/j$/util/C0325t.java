...
public final class C0325t implements java.util.Map, Serializable, Map {
    private static final long serialVersionUID = -1034234728574286014L;
    public final java.util.Map a;
    public transient java.util.Set b;
    public transient C0195s c;
    public transient java.util.Collection d;

    public C0325t(java.util.Map map) {
        map.getClass();
        this.a = map;
    }
    ...
    public final java.util.Set entrySet() {
        if (this.c == null) {
            this.c = new C0195s(this.a.entrySet());
        }
        return this.c;
    }
