...
public final class L2 extends AbstractC0247k0 implements Z3 {
    public final /* synthetic */ int s;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public /* synthetic */ L2(AbstractC0201b abstractC0201b, int i, int i2) {
    ...
    public Spliterator C0(AbstractC0201b abstractC0201b, Spliterator spliterator) {
        switch (this.s) {
            case 1:
                return EnumC0215d3.ORDERED.n(abstractC0201b.m) ? B0(abstractC0201b, spliterator, new C0217e0(20)).spliterator() : new h4((j$.util.Z) abstractC0201b.v0(spliterator), 1);
            case 2:
                return EnumC0215d3.ORDERED.n(abstractC0201b.m) ? B0(abstractC0201b, spliterator, new C0217e0(21)).spliterator() : new h4((j$.util.Z) abstractC0201b.v0(spliterator), 0);
            default:
    ...
    public final J0 B0(AbstractC0322z1 abstractC0322z1, Spliterator spliterator, IntFunction intFunction) {
        switch (this.s) {
            case 0:
                ...
                long[] jArr = (long[]) ((H0) abstractC0322z1.d0(spliterator, true, intFunction)).b();
                Arrays.sort(jArr);
    ...
    public final InterfaceC0279q2 E0(int i, InterfaceC0279q2 interfaceC0279q2) {
        switch (this.s) {
            case 0:
                ...
                return EnumC0215d3.SIZED.n(i) ? new Q2(interfaceC0279q2) : new I2(interfaceC0279q2);
            case 1:
                return new V3(this, interfaceC0279q2);
            default:
                return new W3(this, interfaceC0279q2, false);
        }
    }
