...
public final class C0314x3 extends AbstractC0319y3 implements Spliterator {
    ...
    public C0314x3(Spliterator spliterator, long j, long j2) {
    ...
    public final Spliterator a(Spliterator spliterator, long j, long j2, long j3, long j4) {
        return new C0314x3(spliterator, j, j2, j3, j4);
    }
    ...
    public final boolean tryAdvance(Consumer consumer) {
        ...
        while (true) {
            ...
            this.c.tryAdvance(new C0217e0(16));
            this.d++;
        }
        if (j >= this.e) {
            return false;
    ...
    public final void forEachRemaining(Consumer consumer) {
        ...
        while (j2 > this.d) {
            this.c.tryAdvance(new C0217e0(17));
            this.d++;
        }
        while (this.d < this.e) {
