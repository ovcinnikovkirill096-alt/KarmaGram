...
public final class n extends AbstractC0162a implements Serializable {
    ...
    static {
        n nVar = new n();
        l = nVar;
        AbstractC0162a.k(nVar, "Hijrah");
        AbstractC0162a.k(nVar, "islamic");
    }
    ...
    public final void Q() {
        ...
        try {
            ...
            int[][] iArrV = V();
            int iE = (int) LocalDate.of(1882, 11, 12).E();
            for (int i = 1300; i <= 1600; i++) {
                int[] iArr = iArrV[i - 1300];
                if (iArr.length != 12) {
            ...
            for (int i2 = 1300; i2 < 1600; i2++) {
                int iW = W(i2, 12);
                this.j = Math.min(this.j, iW);
                this.k = Math.max(this.k, iW);
            }
            this.c = true;
        } catch (Exception e) {
    ...
    public final InterfaceC0163b j() {
        return new p(this, LocalDate.a0(j$.com.android.tools.r8.a.Z()).D(j$.time.temporal.a.EPOCH_DAY));
    }

    @Override // j$.time.chrono.k
    public final InterfaceC0163b A(j$.time.temporal.n nVar) {
        if (!(nVar instanceof p)) {
            return new p(this, nVar.D(j$.time.temporal.a.EPOCH_DAY));
        }
        return (p) nVar;
    }
    ...
    public final boolean O(long j) {
        Q();
        return j >= ((long) S(0)) && j <= ((long) (S(this.d.length - 1) - 1)) && W((int) j, 12) > 354;
    }
    ...
    public final j$.time.temporal.v q(j$.time.temporal.a aVar) {
        ...
        if (aVar != null) {
            switch (m.a[aVar.ordinal()]) {
                ...
                case 4:
                case 5:
                    return j$.time.temporal.v.f(S(0), S(this.d.length - 1) - 1);
                case 6:
