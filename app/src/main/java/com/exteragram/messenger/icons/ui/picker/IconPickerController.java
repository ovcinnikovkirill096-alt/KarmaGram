    ...
    private static void hidePicker(final LaunchActivity launchActivity) {
        ...
        iconPickerView.dismiss(new Runnable() { // from class: com.exteragram.messenger.icons.ui.picker.IconPickerController$$ExternalSyntheticLambda0
            ...
            public final void run() {
                IconPickerController.m1155$r8$lambda$OfRV3mAQKhYExDNLrcksaoqPBI(launchActivity, iconPickerView);
            }
        });
    }

    /* JADX INFO: renamed from: $r8$lambda$OfRV3mAQKhYExDNLrcksaoq-PBI, reason: not valid java name */
    public static /* synthetic */ void m1155$r8$lambda$OfRV3mAQKhYExDNLrcksaoqPBI(LaunchActivity launchActivity, IconPickerView iconPickerView) {
        FrameLayout mainContainerFrameLayout = launchActivity.getMainContainerFrameLayout();
        if (mainContainerFrameLayout != null) {
