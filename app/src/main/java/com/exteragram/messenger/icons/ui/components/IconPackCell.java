...
public class IconPackCell extends FrameLayout {
    ...
    public static class Factory extends UItem.UItemFactory {
            ...
            if (view instanceof IconPackCell) {
                ...
                iconPackCell.getHandle().setOnTouchListener(new View.OnTouchListener() { // from class: com.exteragram.messenger.icons.ui.components.IconPackCell$Factory$$ExternalSyntheticLambda0
                    ...
                    public final boolean onTouch(View view2, MotionEvent motionEvent) {
                        return IconPackCell.Factory.m1137$r8$lambda$CP8IXe3DODPybMaF8F7KjxaU4(universalRecyclerView, view, view2, motionEvent);
                    }
                });
            }
        }
        ...
        public static /* synthetic */ boolean m1137$r8$lambda$CP8IXe3DODPybMaF8F7KjxaU4(UniversalRecyclerView universalRecyclerView, View view, View view2, MotionEvent motionEvent) {
