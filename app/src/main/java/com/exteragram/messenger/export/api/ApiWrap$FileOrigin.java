...
public final class ApiWrap$FileOrigin extends RecordTag {
    ...
    public final String toString() {
        return GenerateFromMessageBottomSheet$GenerationData$$ExternalSyntheticRecord0.m($record$getFieldsAsObjects(), ApiWrap$FileOrigin.class, "split;peer;messageId;storyId;customEmojiId");
    }
