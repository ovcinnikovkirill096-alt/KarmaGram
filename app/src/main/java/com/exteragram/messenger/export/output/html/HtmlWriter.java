...
public class HtmlWriter extends AbstractWriter {
    ...
    public static String WriteUserpicThumb(String str, String str2, final UserpicData userpicData) {
        return (String) HtmlContext.WriteImageThumb(str, str2, new Function() { // from class: com.exteragram.messenger.export.output.html.HtmlWriter$$ExternalSyntheticLambda4
            ...
            public final Object apply(Object obj) {
                return HtmlWriter.m1052$r8$lambda$0DixWPzMjZ6lOOvAG9W5PMq7o(userpicData, (Dimension) obj);
            }
    ...
    public static /* synthetic */ Dimension m1052$r8$lambda$0DixWPzMjZ6lOOvAG9W5PMq7o(UserpicData userpicData, Dimension dimension) {
    ...
    private AbstractWriter.Result writePreparedPersonal(ApiWrap$ExportPersonalInfo apiWrap$ExportPersonalInfo, String str) {
        ...
        pushRows("names", ImageCapture$$ExternalSyntheticBackport1.m(new Object[]{new Pair("First name", apiWrap$ContactInfo.firstName), new Pair("Last name", apiWrap$ContactInfo.lastName)}), sb);
        ...
        pushRows("info", ImageCapture$$ExternalSyntheticBackport1.m(new Object[]{pair, new Pair("Username", str2)}), sb);
        pushRows("bio", ImageCapture$$ExternalSyntheticBackport1.m(new Object[]{new Pair("Bio", apiWrap$ExportPersonalInfo.bio)}), sb);
        sb.append(this._summary.popTag());
    ...
    private AbstractWriter.Result writeSessions(ApiWrap$SessionsList apiWrap$SessionsList) {
        ...
        while (i < size) {
            ...
            sb4.append(tL_authorization.ip);
            sb4.append(" - ");
    ...
    private AbstractWriter.Result writeWebSessions(ApiWrap$SessionsList apiWrap$SessionsList) {
        ...
        while (i < size) {
            ...
            String str4 = apiWrap$WebSession.ip() + " - " + apiWrap$WebSession.region();
            StringBuilder sb2 = new StringBuilder();
    ...
    public AbstractWriter.Result writeDialogSlice(ApiWrap$MessagesSlice apiWrap$MessagesSlice) {
        ...
        while (i4 < size) {
            i4++;
            ApiWrap$Message apiWrap$Message = (ApiWrap$Message) arrayList.get(i4);
            if (!DataTypesUtils.SkipMessageByDate(apiWrap$Message, this._settings)) {
                int i5 = this._messagesCount / MediaDataController.MAX_STYLE_RUNS_COUNT;
                if (i3 != i5) {
                ...
                if (DataTypesUtils.DisplayDate(i6, messageInfo3 != null ? messageInfo3.date : z)) {
        ...
        while (i < size) {
            ...
            apiWrap$StoryData.imageLink = (String) HtmlContext.WriteImageThumb(this._settings.path, str, new Function() { // from class: com.exteragram.messenger.export.output.html.HtmlWriter$$ExternalSyntheticLambda3
                ...
                public final Object apply(Object obj2) {
                    return HtmlWriter.m1053$r8$lambda$B8MGwMXHL_evNdsjLxRh5KBA((Dimension) obj2);
                }
    ...
    public static /* synthetic */ Dimension m1053$r8$lambda$B8MGwMXHL_evNdsjLxRh5KBA(Dimension dimension) {
        ...
        ?? r2 = new Utilities.Callback2() { // from class: com.exteragram.messenger.export.output.html.HtmlWriter.1
            ...
            public void run(ArrayList arrayList, String str) {
                ...
                while (i < size2) {
                    ...
                    UserpicData userpicData = new UserpicData();
                    userpicData.colorIndex = DataTypesUtils.PeerColorIndex(apiWrap$TopPeer.peer.id());
                    userpicData.pixelSize = 48;
                    userpicData.firstName = strName;
                    userpicData.lastName = str2;
                    String str3 = str;
                    sb.append(htmlContextFileWithRelativePath.pushListEntry(userpicData, DataTypesUtils.ComposeName(userpicData, "Deleted Account"), "Rating: " + apiWrap$TopPeer.rating, str3, _UrlKt.FRAGMENT_ENCODE_SET));
                    str = str3;
                }
            }
        };
