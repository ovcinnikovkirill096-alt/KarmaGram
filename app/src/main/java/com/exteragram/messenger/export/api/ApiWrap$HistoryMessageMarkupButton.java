...
public final class ApiWrap$HistoryMessageMarkupButton extends RecordTag {
    ...
    public final String toString() {
        return GenerateFromMessageBottomSheet$GenerationData$$ExternalSyntheticRecord0.m($record$getFieldsAsObjects(), ApiWrap$HistoryMessageMarkupButton.class, "type;text;data;forwardText;buttonId");
    }
