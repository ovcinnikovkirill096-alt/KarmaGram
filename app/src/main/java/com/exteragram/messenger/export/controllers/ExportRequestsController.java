...
public class ExportRequestsController {
    ...
    public static ApiWrap$DialogsInfo ParseDialogsInfo(TLRPC.InputPeer inputPeer, TLRPC.messages_Chats messages_chats) {
        ...
        while (i < size) {
            ...
            if (chat instanceof TLRPC.TL_channel) {
                j2 = ((TLRPC.TL_channel) chat).id;
            } else if (chat instanceof TLRPC.TL_channelForbidden) {
                j2 = ((TLRPC.TL_channelForbidden) chat).id;
            } else {
                j2 = chat.id;
            }
            if (j2 == j) {
    ...
    private void startMainSession(final Runnable runnable) {
        ...
        tL_users_getUsers.id = new ArrayList(ImageCapture$$ExternalSyntheticBackport1.m(new Object[]{tL_inputUser}));
        ConnectionsManager.getInstance(this.selectedAcc).sendRequest(tL_users_getUsers, new RequestDelegate() { // from class: com.exteragram.messenger.export.controllers.ExportRequestsController$$ExternalSyntheticLambda38
            ...
            public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
                this.f$0.lambda$startMainSession$1(exportRequests$InitTakeoutSession, runnable, tLObject, tL_error);
            }
        });
    }
    ...
    private void filePartExtractReference(final long j, TL_stories.TL_stories_stories tL_stories_stories) {
        ...
        while (i < size) {
            ...
            if (apiWrap$Story.id == this._fileProcess.origin.storyId()) {
    ...
    private void filePartExtractReference(final long j, TLRPC.messages_Messages messages_messages) {
        ...
        while (i < size) {
            ...
            i++;
            ApiWrap$Message apiWrap$Message = (ApiWrap$Message) obj;
            if (apiWrap$Message.id == this._fileProcess.origin.messageId()) {
    ...
    */
    private void filePartDone(long j, TLObject tLObject) {
        ApiWrap$FileProcess.Request request;
        ...
        if (tLObject instanceof TLRPC.TL_upload_file) {
            ...
            if (tL_upload_file.bytes.limit() == 0) {
                ApiWrap$FileProcess apiWrap$FileProcess = this._fileProcess;
                if (apiWrap$FileProcess.size > 0) {
                    throw new IllegalStateException("received data has 0 length and fileProcess size is not 0!!!");
                }
                if (!apiWrap$FileProcess.file.writeBlock(_UrlKt.FRAGMENT_ENCODE_SET).isSuccess()) {
                    throw new IllegalStateException("writing empty block was not successful!");
                }
            } else {
                Iterator it = this._fileProcess.requests.iterator();
                do {
                    if (!it.hasNext()) {
                        request = null;
                        break;
                    }
                    request = (ApiWrap$FileProcess.Request) it.next();
                } while (request.offset != j);
                if (request == null) {
                    throw new IllegalStateException("req not found!");
                }
                request.bytes = tL_upload_file.bytes;
                while (!this._fileProcess.requests.isEmpty() && ((ApiWrap$FileProcess.Request) this._fileProcess.requests.getFirst()).bytes.limit() != 0) {
                    NativeByteBuffer nativeByteBuffer = ((ApiWrap$FileProcess.Request) this._fileProcess.requests.getFirst()).bytes;
                    if (!this._fileProcess.file.writeBlock(nativeByteBuffer).isSuccess()) {
                        throw new RuntimeException("wtf! tried to write: " + ((int) nativeByteBuffer.buffer.get()));
                    }
                    this._fileProcess.requests.removeFirst();
                }
                ApiWrap$FileProcess apiWrap$FileProcess2 = this._fileProcess;
                Utilities.CallbackReturn callbackReturn = apiWrap$FileProcess2.progress;
                if (callbackReturn != null) {
                    callbackReturn.run(new ApiWrap$FileProgress(apiWrap$FileProcess2.file.size(), this._fileProcess.size));
                }
                if (this._fileProcess.requests.isEmpty()) {
                    ApiWrap$FileProcess apiWrap$FileProcess3 = this._fileProcess;
                    long j2 = apiWrap$FileProcess3.size;
                    if (j2 != 0) {
                    }
                }
                loadFilePart();
        ...
        ApiWrap$FileProcess apiWrap$FileProcess4 = this._fileProcess;
        this._fileCache.save(apiWrap$FileProcess4.location, apiWrap$FileProcess4.relativePath);
        apiWrap$FileProcess4.done.run(apiWrap$FileProcess4.relativePath);
    }
    ...
    private void finishUserpicsSlice() {
        ...
        if (!arrayList.isEmpty()) {
            ...
            this._userpicsProcess.maxId = ((HtmlWriter.Photo) arrayList.get(arrayList.size() - 1)).id;
    ...
    private void finishMessagesSlice() {
        ...
        if (!apiWrap$MessagesSliceAdjustMigrateMessageIds.list.isEmpty()) {
            ...
            apiWrap$ChatProcess.largestIdPlusOne = ((ApiWrap$Message) arrayList.get(arrayList.size() - 1)).id + 1;
            ApiWrap$ChatProcess apiWrap$ChatProcess2 = this._chatProcess;
    ...
    public void requestPersonalInfo(final Utilities.Callback callback) {
        ...
        mainRequest(tL_users_getFullUser, new Utilities.Callback2() { // from class: com.exteragram.messenger.export.controllers.ExportRequestsController$$ExternalSyntheticLambda10
            @Override // org.telegram.messenger.Utilities.Callback2
            public final void run(Object obj, Object obj2) {
                ExportRequestsController.m1043$r8$lambda$K6Z8Dxak9YlqZ3WIvUBpQOpswQ(callback, (TLObject) obj, (TLRPC.TL_error) obj2);
            }
        });
    }

    /* JADX INFO: renamed from: $r8$lambda$K6Z8Dxak9YlqZ-3WIvUBpQOpswQ, reason: not valid java name */
    public static /* synthetic */ void m1043$r8$lambda$K6Z8Dxak9YlqZ3WIvUBpQOpswQ(Utilities.Callback callback, TLObject tLObject, TLRPC.TL_error tL_error) {
    ...
    public void invokeFinish(boolean z, final Runnable runnable) {
        ...
        mainRequest(exportRequests$FinishTakeoutSession, new Utilities.Callback2() { // from class: com.exteragram.messenger.export.controllers.ExportRequestsController$$ExternalSyntheticLambda4
            @Override // org.telegram.messenger.Utilities.Callback2
            public final void run(Object obj, Object obj2) {
                ExportRequestsController.m1042$r8$lambda$K5E2oN2LAwJDAki5Obw5XGaixo(runnable, (TLObject) obj, (TLRPC.TL_error) obj2);
            }
        });
    }

    /* JADX INFO: renamed from: $r8$lambda$K5E2oN2LAwJDAki5Obw5-XGaixo, reason: not valid java name */
    public static /* synthetic */ void m1042$r8$lambda$K5E2oN2LAwJDAki5Obw5XGaixo(Runnable runnable, TLObject tLObject, TLRPC.TL_error tL_error) {
        runnable.run();
