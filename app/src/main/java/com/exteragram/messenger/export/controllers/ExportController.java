...
public class ExportController extends BaseController {
    ...
    public static /* synthetic */ void m1027$r8$lambda$XpHL9OJ9E0jsaOwD7m1Z3whHP0(ProcessingState processingState) {
    }
    ...
    private void exportNext() {
        ...
        switch (AnonymousClass1.$SwitchMap$com$exteragram$messenger$export$controllers$ExportController$ProcessingState$Step[((ProcessingState.Step) this._steps.get(this._stepIndex)).ordinal()]) {
            case 1:
                initialize();
                break;
            case 2:
    ...
    private ProcessingState statePersonalInfo() {
        return prepareState(ProcessingState.Step.PersonalInfo, new Utilities.Callback() { // from class: com.exteragram.messenger.export.controllers.ExportController$$ExternalSyntheticLambda23
            @Override // org.telegram.messenger.Utilities.Callback
            public final void run(Object obj) {
                ExportController.m1027$r8$lambda$XpHL9OJ9E0jsaOwD7m1Z3whHP0((ExportController.ProcessingState) obj);
            }
        });
    }
