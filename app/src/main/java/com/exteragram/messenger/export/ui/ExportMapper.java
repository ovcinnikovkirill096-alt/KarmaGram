...
public class ExportMapper {
    ...
    /* JADX WARN: Code duplicated, block: B:126:0x03f8  */
    /* JADX WARN: Multi-variable type inference failed */
    /* JADX WARN: Type inference failed for: r1v5, types: [boolean] */
    private TLRPC.MessageMedia mapMedia(final JsonMessage jsonMessage) throws Throwable {
        ...
        switch (str) {
            ...
            case "animation":
            case "audio_file":
                ?? Equals = jsonMessage.media.mediaType.equals("sticker");
                if (Equals != 0) {
                    byte[] bArrDecode = Base64.decode(jsonMessage.media.serializedSticker, 0);
                    NativeByteBuffer nativeByteBuffer2 = 0;
                    try {
                        try {
                            ...
                            th = th;
                            nativeByteBuffer2 = Equals;
                            if (nativeByteBuffer2 != 0) {
