...
public class JsonContext {
    ...
    public static String SerializeMessage(final JsonContext jsonContext, final ApiWrap$Message apiWrap$Message, final HashMap map, String str) {
        ...
        if (apiWrap$Message.media.content instanceof ApiWrap$UnsupportedMedia) {
            return SerializeObject(jsonContext, new Pair("id", Integer.valueOf(apiWrap$Message.id)), new Pair("type", SerializeString("unsupported")));
        }
        ...
        Utilities.CallbackReturn callbackReturn2 = new Utilities.CallbackReturn() { // from class: com.exteragram.messenger.export.output.json.JsonContext$$ExternalSyntheticLambda4
            @Override // org.telegram.messenger.Utilities.CallbackReturn
            public final Object run(Object obj) {
                return JsonContext.m1067$r8$lambda$Lb75cXPDJ068NTmfGbGV7wsayQ(callbackReturn, (Long) obj);
            }
        };
        ...
        if (arrayList2 != null && !arrayList2.isEmpty()) {
            ...
            List list = (List) Collection.EL.stream(apiWrap$Message.inlineButtonRows).map(new Function() { // from class: com.exteragram.messenger.export.output.json.JsonContext$$ExternalSyntheticLambda1
                ...
                public final Object apply(Object obj) {
                    return JsonContext.m1068$r8$lambda$hmtII8_x5IKMyyqN62IoDyQTf4(callbackReturn5, (ArrayList) obj);
                }
    ...
    public static /* synthetic */ ApiWrap$User m1067$r8$lambda$Lb75cXPDJ068NTmfGbGV7wsayQ(Utilities.CallbackReturn callbackReturn, Long l) {
    ...
    public static /* synthetic */ void $r8$lambda$oOh1TbUsZyqtWEJs5VUnyheqEho(ApiWrap$Message apiWrap$Message, Utilities.Callback2 callback2, Utilities.CallbackReturn callbackReturn, Utilities.Callback2 callback3, String str) {
        ...
        if (j != 0) {
            ...
            callback3.run(str + "_id", Long.valueOf(apiWrap$Message.fromId));
        }
    }
    ...
    public static /* synthetic */ String $r8$lambda$lKrxcF5Xyg1WzKTSgzvku1TscPg(final JsonContext jsonContext, ArrayList arrayList) {
        ...
        List list = (List) Collection.EL.stream(arrayList).map(new Function() { // from class: com.exteragram.messenger.export.output.json.JsonContext$$ExternalSyntheticLambda13
            ...
            @Override // java.util.function.Function
            public final Object apply(Object obj) {
                return JsonContext.m1072$r8$lambda$z_7ew4tZrjahCzTlJ65jxaK0v0(this.f$0, (ApiWrap$HistoryMessageMarkupButton) obj);
            }
    ...
    public static /* synthetic */ String m1072$r8$lambda$z_7ew4tZrjahCzTlJ65jxaK0v0(JsonContext jsonContext, ApiWrap$HistoryMessageMarkupButton apiWrap$HistoryMessageMarkupButton) {
    ...
    public static /* synthetic */ String m1068$r8$lambda$hmtII8_x5IKMyyqN62IoDyQTf4(Utilities.CallbackReturn callbackReturn, ArrayList arrayList) {
    ...
    private static String SerializeMessageMedia(ApiWrap$Message apiWrap$Message, final JsonContext jsonContext, final HashMap map, String str) {
        ...
        final Utilities.CallbackReturn callbackReturn = new Utilities.CallbackReturn() { // from class: com.exteragram.messenger.export.output.json.JsonContext$$ExternalSyntheticLambda29
            @Override // org.telegram.messenger.Utilities.CallbackReturn
            public final Object run(Object obj) {
                return JsonContext.m1062$r8$lambda$0G3AK7RwrqIoB5h65Np1ClK9s((Long) obj);
            }
        };
        ...
        final Utilities.CallbackReturn callbackReturn2 = new Utilities.CallbackReturn() { // from class: com.exteragram.messenger.export.output.json.JsonContext$$ExternalSyntheticLambda31
            @Override // org.telegram.messenger.Utilities.CallbackReturn
            public final Object run(Object obj) {
                return JsonContext.m1065$r8$lambda$A7SAhkqqvPMMCDUVzfseNfek48(map, (Long) obj);
            }
        };
        ...
        final Utilities.Callback3 callback4 = new Utilities.Callback3() { // from class: com.exteragram.messenger.export.output.json.JsonContext$$ExternalSyntheticLambda33
            ...
            public final void run(Object obj, Object obj2, Object obj3) {
                JsonContext.m1064$r8$lambda$5ZTMoi45tFEPX66k7pRMwqlwpI(callback3, (ApiWrap$File) obj, (String) obj2, (String) obj3);
            }
        };
        ...
        if (obj instanceof HtmlWriter.Photo) {
            ...
            if (z) {
                ...
                ArrayList arrayList5 = jsonContext.nesting;
                ...
                ArrayList arrayList6 = jsonContext.nesting;
    ...
    public static /* synthetic */ String m1062$r8$lambda$0G3AK7RwrqIoB5h65Np1ClK9s(Long l) {
        if (l.longValue() < 0) {
            return SerializeString("chat" + l);
        }
        return SerializeString("user" + l);
    ...
    public static /* synthetic */ ApiWrap$Peer m1065$r8$lambda$A7SAhkqqvPMMCDUVzfseNfek48(HashMap map, Long l) {
        ApiWrap$Peer apiWrap$Peer = (ApiWrap$Peer) map.get(l);
        return apiWrap$Peer != null ? apiWrap$Peer : new ApiWrap$Peer(new ApiWrap$User());
    }
    ...
    public static /* synthetic */ void m1064$r8$lambda$5ZTMoi45tFEPX66k7pRMwqlwpI(Utilities.Callback2 callback2, ApiWrap$File apiWrap$File, String str, String str2) {
        String str3;
        String str4;
        if (str2.isEmpty()) {
    ...
    private static String SerializeMessageAction(final JsonContext jsonContext, TLRPC.MessageAction messageAction, final ApiWrap$Message apiWrap$Message, final HashMap map) {
        ...
        final Utilities.CallbackReturn callbackReturn2 = new Utilities.CallbackReturn() { // from class: com.exteragram.messenger.export.output.json.JsonContext$$ExternalSyntheticLambda18
            @Override // org.telegram.messenger.Utilities.CallbackReturn
            public final Object run(Object obj) {
                return JsonContext.m1069$r8$lambda$l3kw5Q6evJjim0J_zsiqvwknVk(callbackReturn, (Long) obj);
            }
        };
        ...
        Utilities.Callback2 callback5 = new Utilities.Callback2() { // from class: com.exteragram.messenger.export.output.json.JsonContext$$ExternalSyntheticLambda25
            @Override // org.telegram.messenger.Utilities.Callback2
            public final void run(Object obj, Object obj2) {
                JsonContext.m1071$r8$lambda$qketphKXD6umlaSqbPSIjrbZ8c(callbackReturn2, callback2, jsonContext, (ArrayList) obj, (String) obj2);
            }
        };
        ...
        Utilities.Callback callback7 = new Utilities.Callback() { // from class: com.exteragram.messenger.export.output.json.JsonContext$$ExternalSyntheticLambda15
            @Override // org.telegram.messenger.Utilities.Callback
            public final void run(Object obj) {
                JsonContext.m1063$r8$lambda$0JEATGwgrDcrUlHLnU4tlxdjgY(callback6, callback3, (ApiWrap$Image) obj);
            }
        };
    ...
    public static /* synthetic */ ApiWrap$User m1069$r8$lambda$l3kw5Q6evJjim0J_zsiqvwknVk(Utilities.CallbackReturn callbackReturn, Long l) {
        ApiWrap$User apiWrap$User = ((ApiWrap$Peer) callbackReturn.run(l)).user;
        return apiWrap$User != null ? apiWrap$User : new ApiWrap$User();
    }
    ...
    public static /* synthetic */ void $r8$lambda$hw2aHHYioc0DYTvaVxxcyJjnUJs(ApiWrap$Message apiWrap$Message, Utilities.Callback2 callback2, Utilities.CallbackReturn callbackReturn, Utilities.Callback2 callback3, String str) {
        ...
        if (j != 0) {
            ...
            callback3.run(str + "_id", tL_peerUser);
        }
    }
    ...
    public static /* synthetic */ void m1071$r8$lambda$qketphKXD6umlaSqbPSIjrbZ8c(Utilities.CallbackReturn callbackReturn, Utilities.Callback2 callback2, JsonContext jsonContext, ArrayList arrayList, String str) {
        ArrayList arrayList2 = new ArrayList();
    ...
    public static /* synthetic */ void m1063$r8$lambda$0JEATGwgrDcrUlHLnU4tlxdjgY(Utilities.Callback3 callback3, Utilities.Callback2 callback2, ApiWrap$Image apiWrap$Image) {
        callback3.run(apiWrap$Image.file, "photo", _UrlKt.FRAGMENT_ENCODE_SET);
        int i = apiWrap$Image.width;
        if (i == 0 || apiWrap$Image.height == 0) {
            return;
    ...
    public static String Indentation(int i) {
        return HtmlContext$$ExternalSyntheticBackport0.m(" ", i);
    }
