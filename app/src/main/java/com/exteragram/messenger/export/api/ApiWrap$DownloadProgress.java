...
public final class ApiWrap$DownloadProgress extends RecordTag {
    ...
    public final String toString() {
        return GenerateFromMessageBottomSheet$GenerationData$$ExternalSyntheticRecord0.m($record$getFieldsAsObjects(), ApiWrap$DownloadProgress.class, "randomId;path;itemIndex;ready;total");
    }
