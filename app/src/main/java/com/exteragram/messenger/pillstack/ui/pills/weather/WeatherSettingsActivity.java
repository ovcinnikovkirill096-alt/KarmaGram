...
public class WeatherSettingsActivity extends BasePreferencesActivity {
    ...
    protected void fillItems(ArrayList arrayList, UniversalAdapter universalAdapter) {
        arrayList.add(UItem.asTopView(LocaleController.getString(R.string.WeatherPillTopInfo), "RestrictedEmoji", "🌤"));
        arrayList.add(UItem.asButton(1, R.drawable.msg_settings_old, LocaleController.getString(R.string.PillStackPills)));
        arrayList.add(UItem.asShadow());
        if (PillStackConfig.activePills.contains(Integer.valueOf(PillStackConfig.PillType.WEATHER.id))) {
            arrayList.add(UItem.asHeader(LocaleController.getString(R.string.WeatherLocation)));
            arrayList.add(UItem.asRadio(2, LocaleController.getString(R.string.CurrentLocation)).setChecked(PillStackConfig.useCurrentLocation));
            arrayList.add(UItem.asRadio(3, LocaleController.getString(R.string.SelectLocation)).setChecked(true ^ PillStackConfig.useCurrentLocation));
