...
public abstract class ExchangeRates {
    ...
    public static final class State extends RecordTag {
        ...
        public final String toString() {
            return GenerateFromMessageBottomSheet$GenerationData$$ExternalSyntheticRecord0.m($record$getFieldsAsObjects(), State.class, "usdRates");
        }
        ...
        public BigDecimal getUsdRate(String str) {
            ...
            BigDecimal bigDecimal = this.usdRates.get(ExchangeRates.normalize(str));
    ...
    public static /* synthetic */ void $r8$lambda$cWqt41mowJXyOQJBhkZjVVpZpSM(int i, int i2, Object[] objArr) {
        if (i == NotificationCenter.pillStackSettingsChanged && PillStackConfig.shouldUpdatePill(objArr, PillStackConfig.PillType.TON.id, PillStackConfig.PillType.BTC.id, PillStackConfig.PillType.USD.id)) {
            clearCache();
        }
    }
    ...
    public static void complete(final State state) {
        ...
        AndroidUtilities.runOnUIThread(new Runnable() { // from class: com.exteragram.messenger.pillstack.ui.pills.crypto.utils.ExchangeRates$$ExternalSyntheticLambda2
            @Override // java.lang.Runnable
            public final void run() {
                ExchangeRates.m1227$r8$lambda$N2ze8JRy2FQCLLaC_XD27HNkyw(arrayList, state);
            }
        });
    }

    /* JADX INFO: renamed from: $r8$lambda$N2-ze8JRy2FQCLLaC_XD27HNkyw, reason: not valid java name */
    public static /* synthetic */ void m1227$r8$lambda$N2ze8JRy2FQCLLaC_XD27HNkyw(ArrayList arrayList, State state) {
