...
public abstract class PillStackCurrencies {
    ...
    private static final class CurrencyInfo extends RecordTag {
        ...
        public final String toString() {
            return GenerateFromMessageBottomSheet$GenerationData$$ExternalSyntheticRecord0.m($record$getFieldsAsObjects(), CurrencyInfo.class, "code;nameResId;symbolOverride;suffixSymbol");
        }
    }
