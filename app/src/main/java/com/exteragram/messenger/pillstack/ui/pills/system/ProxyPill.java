...
public class ProxyPill extends BasePill implements NotificationCenter.NotificationCenterDelegate {
    ...
    public boolean onPillLongClicked() {
        ...
        ItemOptions.makeOptions(safeLastFragment, this).add(R.drawable.msg_settings, LocaleController.getString(R.string.Settings), new Runnable() { // from class: com.exteragram.messenger.pillstack.ui.pills.system.ProxyPill$$ExternalSyntheticLambda0
