...
public abstract class RatePill extends BasePill implements NotificationCenter.NotificationCenterDelegate {
    ...
    public boolean onPillLongClicked() {
        ...
        itemOptionsMakeOptions.add(actionBarMenuSubItem).addGap().add(R.drawable.msg_retry, LocaleController.getString(R.string.Refresh), new Runnable() { // from class: com.exteragram.messenger.pillstack.ui.pills.crypto.RatePill$$ExternalSyntheticLambda4
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.lambda$onPillLongClicked$2();
            }
        }).add(R.drawable.msg_settings, LocaleController.getString(R.string.Settings), new Runnable() { // from class: com.exteragram.messenger.pillstack.ui.pills.crypto.RatePill$$ExternalSyntheticLambda5
            @Override // java.lang.Runnable
            public final void run() {
