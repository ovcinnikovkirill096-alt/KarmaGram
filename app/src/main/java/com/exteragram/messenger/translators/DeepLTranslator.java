...
public class DeepLTranslator extends BaseTranslator {
    ...
    private static final Set SUPPORTED_LANGUAGES = new HashSet(PreferencesUtils$$ExternalSyntheticBackport1.m(new String[]{"bg", "cs", "da", "de", "el", "en", "en-GB", "en-US", "es", "fi", "fr", "hu", "id", "it", "ja", "lt", "lv", "nl", "pl", "pt", "pt-BR", "pt-PT", "ro", "ru", "sk", "sl", "sv", "tr", "uk", "zh"}));
