...
public class SupporterBottomSheet extends BottomSheet {
    public SupporterBottomSheet(final BaseFragment baseFragment, Theme.ResourcesProvider resourcesProvider) {
        ...
        rLottieImageView.setBackground(Theme.createCircleDrawable(AndroidUtilities.dp(80.0f), ContextCompat.getColor(parentActivity, R.color.ic_background_extera)));
        ...
        linearLayout.addView(new FeatureCell(parentActivity, R.drawable.menu_feature_wallpaper, LocaleController.getString(R.string.SendProof), AndroidUtilities.replaceSingleTag(LocaleController.getString(R.string.SendProofInfo), Theme.key_chat_messageLinkIn, 0, new Runnable() { // from class: com.exteragram.messenger.components.SupporterBottomSheet$$ExternalSyntheticLambda1
    ...
    public /* synthetic */ void lambda$new$1(float f, String str, final BaseFragment baseFragment, FeatureCell featureCell, ExchangeRates.State state) {
        ...
        SpannableStringBuilder spannableStringBuilderReplaceSingleTag = AndroidUtilities.replaceSingleTag(LocaleController.formatString(R.string.MakeDonationInfo, str, str2 + ", " + str3), Theme.key_chat_messageLinkIn, 0, new Runnable() { // from class: com.exteragram.messenger.components.SupporterBottomSheet$$ExternalSyntheticLambda3
            @Override // java.lang.Runnable
            public final void run() {
