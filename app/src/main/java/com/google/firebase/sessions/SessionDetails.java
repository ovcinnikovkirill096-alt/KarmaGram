...
public final class SessionDetails {
    ...
    public int hashCode() {
        return (((((this.sessionId.hashCode() * 31) + this.firstSessionId.hashCode()) * 31) + this.sessionIndex) * 31) + CameraTimestamp$$ExternalSyntheticBackport0.m(this.sessionStartTimestampUs);
    }
