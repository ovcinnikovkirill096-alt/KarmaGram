...
final class zzjw implements zzks {
    ...
    public final zzkr zza(Class cls) {
        ...
        if (zzkbVarZzb.zzb()) {
            return zzit.class.isAssignableFrom(cls) ? zzki.zzc(zzkt.zzn(), zzih.zzb(), zzkbVarZzb.zza()) : zzki.zzc(zzkt.zzm(), zzih.zza(), zzkbVarZzb.zza());
        }
        if (zzit.class.isAssignableFrom(cls)) {
            return zzb(zzkbVarZzb) ? zzkh.zzm(cls, zzkbVarZzb, zzkl.zzb(), zzjs.zze(), zzkt.zzn(), zzih.zzb(), zzka.zzb()) : zzkh.zzm(cls, zzkbVarZzb, zzkl.zzb(), zzjs.zze(), zzkt.zzn(), null, zzka.zzb());
        }
        return zzb(zzkbVarZzb) ? zzkh.zzm(cls, zzkbVarZzb, zzkl.zza(), zzjs.zzd(), zzkt.zzm(), zzih.zza(), zzka.zza()) : zzkh.zzm(cls, zzkbVarZzb, zzkl.zza(), zzjs.zzd(), zzkt.zzm(), null, zzka.zza());
    }
}
