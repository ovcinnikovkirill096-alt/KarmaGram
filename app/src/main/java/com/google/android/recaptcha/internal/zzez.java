...
public final class zzez implements zza {
    ...
    public final Object zza(String str, long j, Continuation continuation) {
        ...
        if (i2 == 0) {
            ...
            try {
                ...
                if (completableDeferred != null) {
                    Boxing.boxBoolean(completableDeferred.completeExceptionally(zzpVarZzp));
                }
                Result.Companion companion = Result.Companion;
                return Result.m2437constructorimpl(ResultKt.createFailure(zzpVarZzp));
            }
        } else {
            if (i2 != 1) {
        ...
        return Result.m2437constructorimpl((zzog) objWithTimeout);
    }
    ...
    /* JADX WARN: Code duplicated, block: B:43:0x00e3 A[LOOP:0: B:41:0x00dd->B:43:0x00e3, LOOP_END] */
    /* JADX WARN: Code duplicated, block: B:7:0x0013  */
    @Override // com.google.android.recaptcha.internal.zza
    public final Object zzb(long j, zzoe zzoeVar, Continuation continuation) {
        ...
        if (i2 == 0) {
            ...
            try {
                ...
                zzezVar = this;
                e.getMessage();
                z = e instanceof TimeoutCancellationException;
                if (z) {
                    listListOf = CollectionsKt.listOf((Object[]) new zzne[]{zzne.INIT_TOTAL, zzne.LOAD_WEBVIEW});
                } else {
                    listListOf = CollectionsKt.listOf(zzne.INIT_TOTAL);
                }
                ...
                Result.Companion companion = Result.Companion;
                return Result.m2437constructorimpl(ResultKt.createFailure(zzpVarZzp.zzc()));
            }
        } else {
            if (i2 != 1) {
                throw new IllegalStateException("call to 'resume' before 'invoke' with coroutine");
            ...
            try {
                ...
                if (z && (lZza2 == null || lZza2.longValue() > j - 2000)) {
                    zzpVarZzp = new zzp(zzn.zze, zzl.zzS, null);
                } else {
                    zzpVarZzp = zzezVar.zzp(e, new zzp(zzn.zzc, zzl.zzah, e.getClass().getSimpleName()));
                }
