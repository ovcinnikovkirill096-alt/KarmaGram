...
public class ChipDrawable extends MaterialShapeDrawable implements Drawable.Callback, TextDrawableHelper.TextDrawableDelegate {
    ...
    private void loadFromAttributes(AttributeSet attributeSet, int i, int i2) {
        ...
        if (Build.VERSION.SDK_INT >= 26) {
            int indexWithValue = MaterialResources.getIndexWithValue(typedArrayObtainStyledAttributes, com.google.android.material.R.styleable.Chip_fontVariationSettings, com.google.android.material.R.styleable.Chip_android_fontVariationSettings);
