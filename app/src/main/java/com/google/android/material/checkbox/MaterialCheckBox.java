...
public class MaterialCheckBox extends AppCompatCheckBox {
    ...
    public void setCheckedState(int i) {
        ...
        if (this.checkedState != i) {
            ...
            if (Build.VERSION.SDK_INT >= 26 && (autofillManagerM = MaterialCheckBox$$ExternalSyntheticApiModelOutline1.m(getContext().getSystemService(MaterialCheckBox$$ExternalSyntheticApiModelOutline0.m()))) != null) {
