...
public class SearchBar extends Toolbar {
    ...
    public SearchBar(Context context, AttributeSet attributeSet, int i) {
        ...
        this.adaptiveMaxWidthEnabled = typedArrayObtainStyledAttributes.getBoolean(R.styleable.SearchBar_adaptiveMaxWidthEnabled, false);
        this.startSiblingViewId = typedArrayObtainStyledAttributes.getResourceId(R.styleable.SearchBar_startSiblingViewId, -1);
        this.endSiblingViewId = typedArrayObtainStyledAttributes.getResourceId(R.styleable.SearchBar_endSiblingViewId, -1);
