...
public class NavigationView extends ScrimInsetsFrameLayout implements MaterialBackHandler {
    ...
    public void updateBackProgress(BackEventCompat backEventCompat) {
        WindowDecorActionBar$$ExternalSyntheticThrowCCEIfNotNull0.m(requireDrawerLayoutParent().second);
        throw null;
    }
    ...
    public void handleBackInvoked() {
        ...
        WindowDecorActionBar$$ExternalSyntheticThrowCCEIfNotNull0.m(pairRequireDrawerLayoutParent.first);
        if (this.sideContainerBackHelper.onHandleBackInvoked() == null || Build.VERSION.SDK_INT < 34) {
            throw null;
        }
        WindowDecorActionBar$$ExternalSyntheticThrowCCEIfNotNull0.m(pairRequireDrawerLayoutParent.second);
        throw null;
    }
