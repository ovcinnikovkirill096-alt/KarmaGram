...
public class FragmentedMp4Extractor implements Extractor {
    ...
    public static final ExtractorsFactory FACTORY = new ExtractorsFactory() { // from class: com.google.android.exoplayer2.extractor.mp4.FragmentedMp4Extractor$$ExternalSyntheticLambda0
        ...
        public final Extractor[] createExtractors() {
            return FragmentedMp4Extractor.m1793$r8$lambda$EbWg24HAiluodvRuBK7KGHbPlM();
        }
    ...
    public static /* synthetic */ Extractor[] m1793$r8$lambda$EbWg24HAiluodvRuBK7KGHbPlM() {
    ...
    private static int parseTrun(TrackBundle trackBundle, int i, int i2, ParsableByteArray parsableByteArray, int i3) throws ParserException {
        ...
        while (i7 < i6) {
            ...
            int i8 = i7;
            long jScaleLargeTimestamp = Util.scaleLargeTimestamp((((long) (z6 ? parsableByteArray.readInt() : 0)) + j4) - j2, 1000000L, j3);
            jArr3[i8] = jScaleLargeTimestamp;
            if (!trackFragment.nextFragmentDecodeTimeIncludesMoov) {
                jArr3[i8] = jScaleLargeTimestamp + trackBundle.moovSampleTable.durationUs;
            }
