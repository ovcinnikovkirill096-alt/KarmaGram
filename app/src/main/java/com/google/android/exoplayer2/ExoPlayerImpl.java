...
final class ExoPlayerImpl extends BasePlayer implements ExoPlayer {
    ...
    public void release() {
        ...
        if (this.isPriorityTaskManagerRegistered) {
            WindowDecorActionBar$$ExternalSyntheticThrowCCEIfNotNull0.m(Assertions.checkNotNull(null));
            throw null;
        }
        this.currentCueGroup = CueGroup.EMPTY_TIME_ZERO;
    ...
    private void setMediaSourcesInternal(List list, int i, long j, boolean z) {
        ...
        if (z) {
            ...
            updatePlaybackInfo(playbackInfoCopyWithPlaybackState, 0, 1, false, z2, 4, getCurrentPositionUsInternal(playbackInfoCopyWithPlaybackState), -1, false);
        }
        i2 = firstWindowIndex;
