...
public final class Mp4Extractor implements Extractor, SeekMap {
    ...
    private void processMoovAtom(Atom.ContainerAtom containerAtom) {
        ...
        int i3 = 0;
        int size = -1;
        for (int size2 = traks.size(); i3 < size2; size2 = size2) {
            TrackSampleTable trackSampleTable = (TrackSampleTable) traks.get(i3);
            if (trackSampleTable.sampleCount == 0) {
                ...
                if (track.type == 2 && j3 > 0 && (i2 = trackSampleTable.sampleCount) > 1) {
                    builderBuildUpon.setFrameRate(i2 / (j3 / 1000000.0f));
                }
