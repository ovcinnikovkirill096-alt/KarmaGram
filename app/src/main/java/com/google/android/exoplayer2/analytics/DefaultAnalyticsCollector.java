...
public class DefaultAnalyticsCollector implements AnalyticsCollector {
    ...
    public final void onAudioEnabled(final DecoderCounters decoderCounters) {
        ...
        sendEvent(eventTimeGenerateReadingMediaPeriodEventTime, 1007, new ListenerSet.Event() { // from class: com.google.android.exoplayer2.analytics.DefaultAnalyticsCollector$$ExternalSyntheticLambda50
            @Override // com.google.android.exoplayer2.util.ListenerSet.Event
            public final void invoke(Object obj) {
                DefaultAnalyticsCollector.m1659$r8$lambda$fOmox8FwKRgJqY_TOsvgUc03Y(eventTimeGenerateReadingMediaPeriodEventTime, decoderCounters, (AnalyticsListener) obj);
            }
        });
    }

    /* JADX INFO: renamed from: $r8$lambda$fOmox8FwKRgJqY_-TOsvgUc03-Y, reason: not valid java name */
    public static /* synthetic */ void m1659$r8$lambda$fOmox8FwKRgJqY_TOsvgUc03Y(AnalyticsListener.EventTime eventTime, DecoderCounters decoderCounters, AnalyticsListener analyticsListener) {
    ...
    public final void onAudioDecoderInitialized(final String str, final long j, final long j2) {
        ...
        sendEvent(eventTimeGenerateReadingMediaPeriodEventTime, 1008, new ListenerSet.Event() { // from class: com.google.android.exoplayer2.analytics.DefaultAnalyticsCollector$$ExternalSyntheticLambda34
            @Override // com.google.android.exoplayer2.util.ListenerSet.Event
            public final void invoke(Object obj) {
                DefaultAnalyticsCollector.m1664$r8$lambda$tYN0EpDyW_MiXhppd9F27rns18(eventTimeGenerateReadingMediaPeriodEventTime, str, j2, j, (AnalyticsListener) obj);
            }
        });
    }

    /* JADX INFO: renamed from: $r8$lambda$tYN0EpDyW_MiXhpp-d9F27rns18, reason: not valid java name */
    public static /* synthetic */ void m1664$r8$lambda$tYN0EpDyW_MiXhppd9F27rns18(AnalyticsListener.EventTime eventTime, String str, long j, long j2, AnalyticsListener analyticsListener) {
    ...
    public final void onAudioDisabled(final DecoderCounters decoderCounters) {
        ...
        sendEvent(eventTimeGeneratePlayingMediaPeriodEventTime, 1013, new ListenerSet.Event() { // from class: com.google.android.exoplayer2.analytics.DefaultAnalyticsCollector$$ExternalSyntheticLambda46
            @Override // com.google.android.exoplayer2.util.ListenerSet.Event
            public final void invoke(Object obj) {
                DefaultAnalyticsCollector.m1646$r8$lambda$0wb6_j9HgIWYTFwzNUwmcn5po(eventTimeGeneratePlayingMediaPeriodEventTime, decoderCounters, (AnalyticsListener) obj);
            }
        });
    }

    /* JADX INFO: renamed from: $r8$lambda$0wb6_-j9HgIWY-TFwzNUwmcn5po, reason: not valid java name */
    public static /* synthetic */ void m1646$r8$lambda$0wb6_j9HgIWYTFwzNUwmcn5po(AnalyticsListener.EventTime eventTime, DecoderCounters decoderCounters, AnalyticsListener analyticsListener) {
    ...
    public final void onVideoInputFormatChanged(final Format format, final DecoderReuseEvaluation decoderReuseEvaluation) {
        ...
        sendEvent(eventTimeGenerateReadingMediaPeriodEventTime, 1017, new ListenerSet.Event() { // from class: com.google.android.exoplayer2.analytics.DefaultAnalyticsCollector$$ExternalSyntheticLambda44
            @Override // com.google.android.exoplayer2.util.ListenerSet.Event
            public final void invoke(Object obj) {
                DefaultAnalyticsCollector.m1661$r8$lambda$lr3o98lL1w0qxzGPLvhF8uS4Y(eventTimeGenerateReadingMediaPeriodEventTime, format, decoderReuseEvaluation, (AnalyticsListener) obj);
            }
        });
    }

    /* JADX INFO: renamed from: $r8$lambda$lr3o98lL1-w0qx-zGPLvhF8uS4Y, reason: not valid java name */
    public static /* synthetic */ void m1661$r8$lambda$lr3o98lL1w0qxzGPLvhF8uS4Y(AnalyticsListener.EventTime eventTime, Format format, DecoderReuseEvaluation decoderReuseEvaluation, AnalyticsListener analyticsListener) {
    ...
    public final void onPositionDiscontinuity(final Player.PositionInfo positionInfo, final Player.PositionInfo positionInfo2, final int i) {
        ...
        sendEvent(eventTimeGenerateCurrentPlayerMediaPeriodEventTime, 11, new ListenerSet.Event() { // from class: com.google.android.exoplayer2.analytics.DefaultAnalyticsCollector$$ExternalSyntheticLambda28
            @Override // com.google.android.exoplayer2.util.ListenerSet.Event
            public final void invoke(Object obj) {
                DefaultAnalyticsCollector.m1663$r8$lambda$qZx1ea0H6d8dPwdMyplWR0wzfI(eventTimeGenerateCurrentPlayerMediaPeriodEventTime, i, positionInfo, positionInfo2, (AnalyticsListener) obj);
            }
        });
    }

    /* JADX INFO: renamed from: $r8$lambda$qZx1ea0H6d8d-PwdMyplWR0wzfI, reason: not valid java name */
    public static /* synthetic */ void m1663$r8$lambda$qZx1ea0H6d8dPwdMyplWR0wzfI(AnalyticsListener.EventTime eventTime, int i, Player.PositionInfo positionInfo, Player.PositionInfo positionInfo2, AnalyticsListener analyticsListener) {
