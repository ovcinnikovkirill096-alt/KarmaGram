...
public final class FrameworkMediaDrm implements ExoMediaDrm {
    public static final ExoMediaDrm.Provider DEFAULT_PROVIDER = new ExoMediaDrm.Provider() { // from class: com.google.android.exoplayer2.drm.FrameworkMediaDrm$$ExternalSyntheticLambda0
        ...
        public final ExoMediaDrm acquireExoMediaDrm(UUID uuid) {
            return FrameworkMediaDrm.m1733$r8$lambda$3GNQEqPU_wUEQYVzGhnf5fwpY(uuid);
        }
    };
    ...
    public static /* synthetic */ ExoMediaDrm m1733$r8$lambda$3GNQEqPU_wUEQYVzGhnf5fwpY(UUID uuid) {
        try {
    ...
    private static String adjustLicenseServerUrl(String str) {
        ...
        return (Util.SDK_INT == 33 && "https://default.url".equals(str)) ? _UrlKt.FRAGMENT_ENCODE_SET : str;
    }
    ...
    private static class Api31 {
        ...
        public static void setLogSessionIdOnMediaDrmSession(MediaDrm mediaDrm, byte[] bArr, PlayerId playerId) {
            ...
            FrameworkMediaDrm$Api31$$ExternalSyntheticApiModelOutline0.m(Assertions.checkNotNull(mediaDrm.getPlaybackComponent(bArr))).setLogSessionId(logSessionId);
        }
    }
}
