...
final class DvbParser {
    ...
    public List decode(byte[] bArr, int i) {
        ...
        SparseArray sparseArray = pageComposition.regions;
        int i3 = 0;
        while (i3 < sparseArray.size()) {
            this.canvas.save();
            PageRegion pageRegion = (PageRegion) sparseArray.valueAt(i3);
            RegionComposition regionComposition = (RegionComposition) this.subtitleService.regions.get(sparseArray.keyAt(i3));
            ...
            while (i6 < sparseArray2.size()) {
                ...
                RegionObject regionObject = (RegionObject) sparseArray2.valueAt(i6);
                ...
                if (objectData != null) {
                    paintPixelDataSubBlocks(objectData, clutDefinition2, regionComposition.depth, regionObject.horizontalPosition + i4, regionObject.verticalPosition + i5, objectData.nonModifyingColorFlag ? null : this.defaultPaint, this.canvas);
                }
                i6++;
        ...
        switch (bits) {
            ...
            case 17:
                ...
                if (bits2 == subtitleService.subtitlePageId && pageComposition3 != null) {
                    ...
                    if (pageComposition3.state == 0 && (regionComposition = (RegionComposition) subtitleService.regions.get(regionComposition2.id)) != null) {
