    ...
    private int requestAudioFocusV26() {
        ...
        if (audioFocusRequest == null || this.rebuildAudioFocusRequest) {
            if (audioFocusRequest == null) {
                AudioFocusManager$$ExternalSyntheticApiModelOutline1.m();
                builderM = NowPlayingCard$$ExternalSyntheticApiModelOutline0.m(this.focusGainToRequest);
            } else {
                AudioFocusManager$$ExternalSyntheticApiModelOutline1.m();
                builderM = AudioFocusManager$$ExternalSyntheticApiModelOutline0.m(this.audioFocusRequest);
            }
