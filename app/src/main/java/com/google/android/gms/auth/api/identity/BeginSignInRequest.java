...
public final class BeginSignInRequest extends AbstractSafeParcelable {
    ...
    public static final class PasskeysRequestOptions extends AbstractSafeParcelable {
        ...
        public boolean equals(Object obj) {
            ...
            return this.zba == passkeysRequestOptions.zba && Arrays.equals(this.zbb, passkeysRequestOptions.zbb) && j$.util.Objects.equals(this.zbc, passkeysRequestOptions.zbc);
        }
        ...
        public int hashCode() {
            return (j$.util.Objects.hash(Boolean.valueOf(this.zba), this.zbc) * 31) + Arrays.hashCode(this.zbb);
        }
