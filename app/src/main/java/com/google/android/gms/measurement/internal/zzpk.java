...
public final class zzpk extends zzos {
    ...
    final zzoh zzf(String str, com.google.android.gms.internal.measurement.zzic zzicVar, com.google.android.gms.internal.measurement.zzhr zzhrVar, String str2) {
        ...
        Set setM = PreferencesUtils$$ExternalSyntheticBackport1.m(zzicVar2.zzc().zzk(str, zzfy.zzau).split(","));
        ...
        zzN(builder, "gmp_app_id", zzicVar.zzac(), setM);
        zzicVar2.zzc().zzi();
        zzN(builder, "gmp_version", String.valueOf(133005L), setM);
        ...
        zzN(builder, "app_instance_id", strZzV, setM);
        zzN(builder, "rdid", zzicVar.zzP(), setM);
        zzN(builder, "bundle_id", zzicVar.zzK(), setM);
        String strZzk2 = zzhrVar.zzk();
        String strZza = zzjm.zza(strZzk2);
        if (true != TextUtils.isEmpty(strZza)) {
            strZzk2 = strZza;
        }
        zzN(builder, "app_event_name", strZzk2, setM);
        zzN(builder, "app_version", String.valueOf(zzicVar.zzai()), setM);
        ...
        zzN(builder, "os_version", strZzD, setM);
        zzN(builder, "timestamp", String.valueOf(zzhrVar.zzn()), setM);
        if (zzicVar.zzS()) {
            zzN(builder, "lat", "1", setM);
        }
        zzN(builder, "privacy_sandbox_version", String.valueOf(zzicVar.zzaG()), setM);
        zzN(builder, "trigger_uri_source", "1", setM);
        zzN(builder, "trigger_uri_timestamp", String.valueOf(jCurrentTimeMillis), setM);
        zzN(builder, "request_uuid", str2, setM);
        ...
        zzQ(builder, zzicVar2.zzc().zzk(str, zzfy.zzat).split("\\|"), bundle, setM);
        ...
        zzQ(builder, zzicVar2.zzc().zzk(str, zzfy.zzas).split("\\|"), bundle2, setM);
        zzN(builder, "dma", true != zzicVar.zzaC() ? MVEL.VERSION_SUB : "1", setM);
        if (!zzicVar.zzaE().isEmpty()) {
            zzN(builder, "dma_cps", zzicVar.zzaE(), setM);
        }
        if (zzicVar.zzaK()) {
            com.google.android.gms.internal.measurement.zzha zzhaVarZzaL = zzicVar.zzaL();
            if (!zzhaVarZzaL.zzb().isEmpty()) {
                zzN(builder, "dl_gclid", zzhaVarZzaL.zzb(), setM);
            }
            if (!zzhaVarZzaL.zzd().isEmpty()) {
                zzN(builder, "dl_gbraid", zzhaVarZzaL.zzd(), setM);
            }
            if (!zzhaVarZzaL.zzf().isEmpty()) {
                zzN(builder, "dl_gs", zzhaVarZzaL.zzf(), setM);
            }
            if (zzhaVarZzaL.zzh() > 0) {
                zzN(builder, "dl_ss_ts", String.valueOf(zzhaVarZzaL.zzh()), setM);
            }
            if (!zzhaVarZzaL.zzj().isEmpty()) {
                zzN(builder, "mr_gclid", zzhaVarZzaL.zzj(), setM);
            }
            if (!zzhaVarZzaL.zzm().isEmpty()) {
                zzN(builder, "mr_gbraid", zzhaVarZzaL.zzm(), setM);
            }
            if (!zzhaVarZzaL.zzo().isEmpty()) {
                zzN(builder, "mr_gs", zzhaVarZzaL.zzo(), setM);
            }
            if (zzhaVarZzaL.zzq() > 0) {
                zzN(builder, "mr_click_ts", String.valueOf(zzhaVarZzaL.zzq()), setM);
            }
        }
